...
. For each listed type dependency, a corresponding regular dependencies must be declared whose "name" matches the "definesPackage" property value of the specified type dependency.
--
