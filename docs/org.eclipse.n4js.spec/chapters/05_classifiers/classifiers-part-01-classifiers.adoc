...
Since we do not support class expressions at the moment and since we want to disallow access from within the module, we currently create a warning if an abstract member is declared private. 
