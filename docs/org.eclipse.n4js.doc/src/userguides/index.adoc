...
=== Write Type Definitions for existing npms

The Type Definitions Guide briefly covers the essentials of how to write or modify or add type definitions
to an existing implementation npm project. Also conventions on how to version a new type definition project
with respect to the version of the related implementation project.

[horizontal]
<<type-definition-projects.adoc#type-definition-projects,Type Definitions Guide>> :: Basic instructions on how to write type definitions.
