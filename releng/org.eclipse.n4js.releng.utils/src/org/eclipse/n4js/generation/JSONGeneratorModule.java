...
/**
 * A Guice {@link Module Module} for injecting customizations for the JSON language into the (new) Xtext language
 * generator.
 */
@SuppressWarnings("restriction")
public class JSONGeneratorModule extends DefaultGeneratorModule {

	/***/
	public void configureXtextGeneratorNaming(Binder binder) {
		binder.bind(XtextGeneratorNaming.class).to(JSONGeneratorNaming.class);
	}
	...
	/***/
	static public class JSONGeneratorNaming extends XtextGeneratorNaming {
		...
		public TypeReference getEclipsePluginActivator() {
			...
			if (pluginName == null) {
				...
				return new TypeReference(pluginName + ".internal", "JsonActivator");
			}
		}
	}
