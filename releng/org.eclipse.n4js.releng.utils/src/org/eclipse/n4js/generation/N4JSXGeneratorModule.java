...
public class N4JSXGeneratorModule extends AbstractPatchedGeneratorModule {
	...
	public void configureXtextGeneratorNaming(Binder binder) {
		binder.bind(XtextGeneratorNaming.class).to(N4JSXGeneratorNaming.class);
	}
	 ...
	 * plug-in's activator.
	 */
	static public class N4JSXGeneratorNaming extends XtextGeneratorNaming {
		...
		public TypeReference getEclipsePluginActivator() {
			...
			if (pluginName == null) {
				...
				return new TypeReference(pluginName + ".internal", "N4JSXActivator");
			}
