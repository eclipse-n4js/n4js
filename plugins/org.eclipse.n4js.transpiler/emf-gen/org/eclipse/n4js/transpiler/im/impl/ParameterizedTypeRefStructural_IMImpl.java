...
public class ParameterizedTypeRefStructural_IMImpl extends ParameterizedTypeRef_IMImpl implements ParameterizedTypeRefStructural_IM {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == TypeArgument.class) {
			switch (baseOperationID) {
				...
				case TypeRefsPackage.TYPE_ARGUMENT___INTERNAL_GET_TYPE_REF_AS_STRING: return ImPackage.PARAMETERIZED_TYPE_REF_STRUCTURAL_IM___INTERNAL_GET_TYPE_REF_AS_STRING;
		...
		if (baseClass == ParameterizedTypeRef.class) {
			switch (baseOperationID) {
				...
				case TypeRefsPackage.PARAMETERIZED_TYPE_REF___INTERNAL_GET_TYPE_REF_AS_STRING: return ImPackage.PARAMETERIZED_TYPE_REF_STRUCTURAL_IM___INTERNAL_GET_TYPE_REF_AS_STRING;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		...
		if (baseClass == ParameterizedTypeRefStructural.class) {
			switch (baseOperationID) {
				...
				case TypeRefsPackage.PARAMETERIZED_TYPE_REF_STRUCTURAL___INTERNAL_GET_TYPE_REF_AS_STRING: return ImPackage.PARAMETERIZED_TYPE_REF_STRUCTURAL_IM___INTERNAL_GET_TYPE_REF_AS_STRING;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ImPackage.PARAMETERIZED_TYPE_REF_STRUCTURAL_IM___INTERNAL_GET_TYPE_REF_AS_STRING:
