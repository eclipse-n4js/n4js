...
/**
 * When enabled, the {@link N4JSFlowAnalyzerTestFeatures} class records data during creating and traversing the flow
 * graphs. This recording is disabled by default for performance reasons.
 */
public class N4JSFlowAnalyzerTestFeatures {
	...
	static public List<Pair<Node, List<ControlFlowEdge>>> getMergedEdges() {
		Collections.sort(mergedEdges, N4JSFlowAnalyzerTestFeatures::compareNodes);
		return mergedEdges;
	}
