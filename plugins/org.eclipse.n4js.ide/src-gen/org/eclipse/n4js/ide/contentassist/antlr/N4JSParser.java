...
public class N4JSParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, N4JSGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAnnotationNoAtSignFragmentAccess().getGroup(), "rule__AnnotationNoAtSignFragment__Group__0");
			builder.put(grammarAccess.getAnnotationNoAtSignFragmentAccess().getGroup_1(), "rule__AnnotationNoAtSignFragment__Group_1__0");
			builder.put(grammarAccess.getAnnotationNoAtSignFragmentAccess().getGroup_1_2(), "rule__AnnotationNoAtSignFragment__Group_1_2__0");
			builder.put(grammarAccess.getAnnotationNoAtSignFragmentAccess().getGroup_1_2_1(), "rule__AnnotationNoAtSignFragment__Group_1_2_1__0");
			...
			builder.put(grammarAccess.getAnnotationNoAtSignFragmentAccess().getNameAssignment_0(), "rule__AnnotationNoAtSignFragment__NameAssignment_0");
			builder.put(grammarAccess.getAnnotationNoAtSignFragmentAccess().getArgsAssignment_1_2_0(), "rule__AnnotationNoAtSignFragment__ArgsAssignment_1_2_0");
			builder.put(grammarAccess.getAnnotationNoAtSignFragmentAccess().getArgsAssignment_1_2_1_1(), "rule__AnnotationNoAtSignFragment__ArgsAssignment_1_2_1_1");
			...
			builder.put(grammarAccess.getAnnotationListAccess().getAnnotationsAssignment_0_0_3(), "rule__AnnotationList__AnnotationsAssignment_0_0_3");
			...
			builder.put(grammarAccess.getTypeReferenceAccess().getAstDeclaredTypeQualifierAssignment_0_0(), "rule__TypeReference__AstDeclaredTypeQualifierAssignment_0_0");
