...
public class N4JSParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, N4JSGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAnnotatedN4MemberDeclarationAccess().getAlternatives_1_2_0_0_3(), "rule__AnnotatedN4MemberDeclaration__Alternatives_1_2_0_0_3");
			...
			builder.put(grammarAccess.getExportableVariableStatementAccess().getGroup(), "rule__ExportableVariableStatement__Group__0");
			builder.put(grammarAccess.getExportableVariableStatementAccess().getGroup_0(), "rule__ExportableVariableStatement__Group_0__0");
			builder.put(grammarAccess.getExportableVariableStatementAccess().getGroup_0_0(), "rule__ExportableVariableStatement__Group_0_0__0");
			builder.put(grammarAccess.getExportableVariableStatementAccess().getGroup_2(), "rule__ExportableVariableStatement__Group_2__0");
			builder.put(grammarAccess.getExportableVariableStatementWithModifierAccess().getGroup(), "rule__ExportableVariableStatementWithModifier__Group__0");
			builder.put(grammarAccess.getExportableVariableStatementWithModifierAccess().getGroup_3(), "rule__ExportableVariableStatementWithModifier__Group_3__0");
			...
			builder.put(grammarAccess.getExportableVariableBindingAccess().getGroup(), "rule__ExportableVariableBinding__Group__0");
			builder.put(grammarAccess.getExportableVariableDeclarationAccess().getGroup(), "rule__ExportableVariableDeclaration__Group__0");
			...
			builder.put(grammarAccess.getParameterizedTypeRefStructuralAccess().getGroup_3(), "rule__ParameterizedTypeRefStructural__Group_3__0");
			...
			builder.put(grammarAccess.getExportableVariableStatementAccess().getVarStmtKeywordAssignment_0_0_1(), "rule__ExportableVariableStatement__VarStmtKeywordAssignment_0_0_1");
			builder.put(grammarAccess.getExportableVariableStatementAccess().getVarDeclsOrBindingsAssignment_1(), "rule__ExportableVariableStatement__VarDeclsOrBindingsAssignment_1");
			builder.put(grammarAccess.getExportableVariableStatementAccess().getVarDeclsOrBindingsAssignment_2_1(), "rule__ExportableVariableStatement__VarDeclsOrBindingsAssignment_2_1");
			builder.put(grammarAccess.getExportableVariableStatementWithModifierAccess().getDeclaredModifiersAssignment_0(), "rule__ExportableVariableStatementWithModifier__DeclaredModifiersAssignment_0");
			builder.put(grammarAccess.getExportableVariableStatementWithModifierAccess().getVarStmtKeywordAssignment_1(), "rule__ExportableVariableStatementWithModifier__VarStmtKeywordAssignment_1");
			builder.put(grammarAccess.getExportableVariableStatementWithModifierAccess().getVarDeclsOrBindingsAssignment_2(), "rule__ExportableVariableStatementWithModifier__VarDeclsOrBindingsAssignment_2");
			builder.put(grammarAccess.getExportableVariableStatementWithModifierAccess().getVarDeclsOrBindingsAssignment_3_1(), "rule__ExportableVariableStatementWithModifier__VarDeclsOrBindingsAssignment_3_1");
			...
			builder.put(grammarAccess.getExportableVariableBindingAccess().getPatternAssignment_0(), "rule__ExportableVariableBinding__PatternAssignment_0");
			builder.put(grammarAccess.getExportableVariableBindingAccess().getExpressionAssignment_2(), "rule__ExportableVariableBinding__ExpressionAssignment_2");
			...
			builder.put(grammarAccess.getColonSepDeclaredReturnTypeRefAccess().getDeclaredReturnTypeRefNodeAssignment_1(), "rule__ColonSepDeclaredReturnTypeRef__DeclaredReturnTypeRefNodeAssignment_1");
			...
			builder.put(grammarAccess.getAnnotatedN4MemberDeclarationAccess().getGeneratorAssignment_1_2_0_0_3_0_0(), "rule__AnnotatedN4MemberDeclaration__GeneratorAssignment_1_2_0_0_3_0_0");
			builder.put(grammarAccess.getAnnotatedN4MemberDeclarationAccess().getDeclaredNameAssignment_1_2_0_0_3_0_1(), "rule__AnnotatedN4MemberDeclaration__DeclaredNameAssignment_1_2_0_0_3_0_1");
			builder.put(grammarAccess.getAnnotatedN4MemberDeclarationAccess().getDeclaredNameAssignment_1_2_0_0_3_1_1(), "rule__AnnotatedN4MemberDeclaration__DeclaredNameAssignment_1_2_0_0_3_1_1");
			...
			builder.put(grammarAccess.getFieldDeclarationImplAccess().getDeclaredNameAssignment_1(), "rule__FieldDeclarationImpl__DeclaredNameAssignment_1");
			builder.put(grammarAccess.getFieldDeclarationImplAccess().getDeclaredOptionalAssignment_2(), "rule__FieldDeclarationImpl__DeclaredOptionalAssignment_2");
			builder.put(grammarAccess.getFieldDeclarationImplAccess().getExpressionAssignment_4_1(), "rule__FieldDeclarationImpl__ExpressionAssignment_4_1");
