...
public class N4JSParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, N4JSGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBindingIdentifierWithDefaultAccess().getAlternatives(), "rule__BindingIdentifierWithDefault__Alternatives");
			...
			builder.put(grammarAccess.getPropertyNameValuePairAccess().getAlternatives_0_0_2(), "rule__PropertyNameValuePair__Alternatives_0_0_2");
			...
			builder.put(grammarAccess.getNamedExportClauseAccess().getGroup(), "rule__NamedExportClause__Group__0");
			builder.put(grammarAccess.getNamedExportClauseAccess().getGroup_1(), "rule__NamedExportClause__Group_1__0");
			builder.put(grammarAccess.getNamedExportClauseAccess().getGroup_1_1(), "rule__NamedExportClause__Group_1_1__0");
			builder.put(grammarAccess.getNamespaceExportSpecifierAccess().getGroup(), "rule__NamespaceExportSpecifier__Group__0");
			builder.put(grammarAccess.getNamespaceExportSpecifierAccess().getGroup_2(), "rule__NamespaceExportSpecifier__Group_2__0");
			builder.put(grammarAccess.getNamedExportSpecifierAccess().getGroup(), "rule__NamedExportSpecifier__Group__0");
			builder.put(grammarAccess.getNamedExportSpecifierAccess().getGroup_1(), "rule__NamedExportSpecifier__Group_1__0");
			...
			builder.put(grammarAccess.getNamespaceExportClauseAccess().getNamespaceExportAssignment(), "rule__NamespaceExportClause__NamespaceExportAssignment");
			builder.put(grammarAccess.getNamedExportClauseAccess().getNamedExportsAssignment_1_0(), "rule__NamedExportClause__NamedExportsAssignment_1_0");
			builder.put(grammarAccess.getNamedExportClauseAccess().getNamedExportsAssignment_1_1_1(), "rule__NamedExportClause__NamedExportsAssignment_1_1_1");
			builder.put(grammarAccess.getNamespaceExportSpecifierAccess().getAliasAssignment_2_1(), "rule__NamespaceExportSpecifier__AliasAssignment_2_1");
			builder.put(grammarAccess.getNamedExportSpecifierAccess().getExportedElementAssignment_0(), "rule__NamedExportSpecifier__ExportedElementAssignment_0");
			builder.put(grammarAccess.getNamedExportSpecifierAccess().getAliasAssignment_1_1(), "rule__NamedExportSpecifier__AliasAssignment_1_1");
			...
			builder.put(grammarAccess.getIdentifierRefWithDefaultAccess().getIdAssignment(), "rule__IdentifierRefWithDefault__IdAssignment");
			...
			builder.put(grammarAccess.getPropertyNameValuePairAccess().getPropertyAssignment_0_0_2_0(), "rule__PropertyNameValuePair__PropertyAssignment_0_0_2_0");
			builder.put(grammarAccess.getPropertyNameValuePairAccess().getDeclaredNameAssignment_0_0_2_1(), "rule__PropertyNameValuePair__DeclaredNameAssignment_0_0_2_1");
