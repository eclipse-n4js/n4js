...
public class N4JSParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, N4JSGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getAlternatives_1(), "rule__AnnotatedNamespaceElement__Alternatives_1");
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getAlternatives_1_1_0(), "rule__AnnotatedNamespaceElement__Alternatives_1_1_0");
			...
			builder.put(grammarAccess.getImportDeclarationImplAccess().getAlternatives_2(), "rule__ImportDeclarationImpl__Alternatives_2");
			...
			builder.put(grammarAccess.getFunctionImplWithoutKeywordAccess().getAlternatives(), "rule__FunctionImplWithoutKeyword__Alternatives");
			...
			builder.put(grammarAccess.getStrictFormalParametersAccess().getAlternatives_1_0(), "rule__StrictFormalParameters__Alternatives_1_0");
			builder.put(grammarAccess.getAnnotatedExpressionAccess().getAlternatives_1(), "rule__AnnotatedExpression__Alternatives_1");
			builder.put(grammarAccess.getN4TypeVariableAccess().getAlternatives_0(), "rule__N4TypeVariable__Alternatives_0");
			...
			builder.put(grammarAccess.getForStatementAccess().getAlternatives_4(), "rule__ForStatement__Alternatives_4");
			builder.put(grammarAccess.getForStatementAccess().getAlternatives_4_1_0(), "rule__ForStatement__Alternatives_4_1_0");
			builder.put(grammarAccess.getForStatementAccess().getAlternatives_4_1_0_0_1(), "rule__ForStatement__Alternatives_4_1_0_0_1");
			builder.put(grammarAccess.getForStatementAccess().getAlternatives_4_1_0_0_1_0_0_1(), "rule__ForStatement__Alternatives_4_1_0_0_1_0_0_1");
			builder.put(grammarAccess.getForStatementAccess().getAlternatives_4_1_0_0_1_1_1(), "rule__ForStatement__Alternatives_4_1_0_0_1_1_1");
			builder.put(grammarAccess.getForStatementAccess().getAlternatives_4_1_0_1_1(), "rule__ForStatement__Alternatives_4_1_0_1_1");
			...
			builder.put(grammarAccess.getPropertyMethodDeclarationAccess().getAlternatives_0_0_4(), "rule__PropertyMethodDeclaration__Alternatives_0_0_4");
			builder.put(grammarAccess.getColonSepDeclaredReturnTypeRefAccess().getAlternatives_1(), "rule__ColonSepDeclaredReturnTypeRef__Alternatives_1");
			builder.put(grammarAccess.getTypePredicateDeclarationAccess().getAlternatives_0_0_0(), "rule__TypePredicateDeclaration__Alternatives_0_0_0");
			...
			builder.put(grammarAccess.getOperatorTypeRefAccess().getAlternatives(), "rule__OperatorTypeRef__Alternatives");
			builder.put(grammarAccess.getArrayTypeExpressionAccess().getAlternatives(), "rule__ArrayTypeExpression__Alternatives");
			builder.put(grammarAccess.getArrayTypeExpressionAccess().getAlternatives_2_1_0(), "rule__ArrayTypeExpression__Alternatives_2_1_0");
			...
			builder.put(grammarAccess.getArrowFunctionTypeExpressionAccess().getAlternatives_1(), "rule__ArrowFunctionTypeExpression__Alternatives_1");
			builder.put(grammarAccess.getTAnonymousFormalParameterListWithDeclaredThisTypeAccess().getAlternatives_0(), "rule__TAnonymousFormalParameterListWithDeclaredThisType__Alternatives_0");
			...
			builder.put(grammarAccess.getColonSepReturnTypeRefAccess().getAlternatives_1(), "rule__ColonSepReturnTypeRef__Alternatives_1");
			builder.put(grammarAccess.getTStructFieldAccess().getAlternatives_0(), "rule__TStructField__Alternatives_0");
			...
			builder.put(grammarAccess.getTypePredicateWithOperatorTypeRefAccess().getAlternatives_0_0_0(), "rule__TypePredicateWithOperatorTypeRef__Alternatives_0_0_0");
			...
			builder.put(grammarAccess.getExpressionInTypeRefAccess().getAlternatives(), "rule__ExpressionInTypeRef__Alternatives");
			...
			builder.put(grammarAccess.getN4ModifierWithoutConstAccess().getAlternatives(), "rule__N4ModifierWithoutConst__Alternatives");
			...
			builder.put(grammarAccess.getGlobalDeclarationAccess().getGroup_0(), "rule__GlobalDeclaration__Group_0__0");
			builder.put(grammarAccess.getGlobalDeclarationAccess().getGroup_0_0(), "rule__GlobalDeclaration__Group_0_0__0");
			...
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getGroup_1_0_1_0(), "rule__AnnotatedNamespaceElement__Group_1_0_1_0__0");
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getGroup_1_1(), "rule__AnnotatedNamespaceElement__Group_1_1__0");
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getGroup_1_1_0_0(), "rule__AnnotatedNamespaceElement__Group_1_1_0_0__0");
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getGroup_1_1_0_1(), "rule__AnnotatedNamespaceElement__Group_1_1_0_1__0");
			...
			builder.put(grammarAccess.getDeclareDeclarationAccess().getGroup_1_0(), "rule__DeclareDeclaration__Group_1_0__0");
			...
			builder.put(grammarAccess.getExportDeclarationImplAccess().getGroup_2_0(), "rule__ExportDeclarationImpl__Group_2_0__0");
			builder.put(grammarAccess.getExportDeclarationImplAccess().getGroup_2_1(), "rule__ExportDeclarationImpl__Group_2_1__0");
			builder.put(grammarAccess.getExportDeclarationImplAccess().getGroup_2_3(), "rule__ExportDeclarationImpl__Group_2_3__0");
			builder.put(grammarAccess.getExportDeclarationImplAccess().getGroup_2_3_1_1(), "rule__ExportDeclarationImpl__Group_2_3_1_1__0");
			builder.put(grammarAccess.getExportDeclarationImplAccess().getGroup_2_4(), "rule__ExportDeclarationImpl__Group_2_4__0");
			builder.put(grammarAccess.getExportDeclarationImplAccess().getGroup_2_4_2(), "rule__ExportDeclarationImpl__Group_2_4_2__0");
			builder.put(grammarAccess.getExportDeclarationImplAccess().getGroup_2_5(), "rule__ExportDeclarationImpl__Group_2_5__0");
			builder.put(grammarAccess.getExportDeclarationImplAccess().getGroup_2_6(), "rule__ExportDeclarationImpl__Group_2_6__0");
			...
			builder.put(grammarAccess.getAnnotatedExportableElementAccess().getGroup_1_4(), "rule__AnnotatedExportableElement__Group_1_4__0");
			...
			builder.put(grammarAccess.getImportDeclarationImplAccess().getGroup_2_0(), "rule__ImportDeclarationImpl__Group_2_0__0");
			builder.put(grammarAccess.getImportDeclarationImplAccess().getGroup_2_0_0(), "rule__ImportDeclarationImpl__Group_2_0_0__0");
			builder.put(grammarAccess.getImportDeclarationImplAccess().getGroup_2_1(), "rule__ImportDeclarationImpl__Group_2_1__0");
			builder.put(grammarAccess.getImportDeclarationImplAccess().getGroup_2_1_0(), "rule__ImportDeclarationImpl__Group_2_1_0__0");
			builder.put(grammarAccess.getImportDeclarationImplAccess().getGroup_2_1_0_0(), "rule__ImportDeclarationImpl__Group_2_1_0_0__0");
			builder.put(grammarAccess.getImportDeclarationImplAccess().getGroup_2_1_2(), "rule__ImportDeclarationImpl__Group_2_1_2__0");
			builder.put(grammarAccess.getImportDeclarationImplAccess().getGroup_2_1_3(), "rule__ImportDeclarationImpl__Group_2_1_3__0");
			...
			builder.put(grammarAccess.getFunctionImplWithoutKeywordAccess().getGroup_0(), "rule__FunctionImplWithoutKeyword__Group_0__0");
			builder.put(grammarAccess.getFunctionImplWithoutKeywordAccess().getGroup_1(), "rule__FunctionImplWithoutKeyword__Group_1__0");
			...
			builder.put(grammarAccess.getStrictFormalParametersAccess().getGroup_1_0_0(), "rule__StrictFormalParameters__Group_1_0_0__0");
			...
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_0(), "rule__ForStatement__Group_4_0__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_0_0(), "rule__ForStatement__Group_4_0_0__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1(), "rule__ForStatement__Group_4_1__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1_0_0(), "rule__ForStatement__Group_4_1_0_0__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1_0_0_1_0(), "rule__ForStatement__Group_4_1_0_0_1_0__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1_0_0_1_0_0(), "rule__ForStatement__Group_4_1_0_0_1_0_0__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1_0_0_1_1(), "rule__ForStatement__Group_4_1_0_0_1_1__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1_0_0_1_1_1_0(), "rule__ForStatement__Group_4_1_0_0_1_1_1_0__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1_0_0_1_1_1_0_0(), "rule__ForStatement__Group_4_1_0_0_1_1_1_0_0__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1_0_0_1_1_1_1(), "rule__ForStatement__Group_4_1_0_0_1_1_1_1__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1_0_0_1_1_1_2(), "rule__ForStatement__Group_4_1_0_0_1_1_1_2__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1_0_1(), "rule__ForStatement__Group_4_1_0_1__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1_0_1_1_0(), "rule__ForStatement__Group_4_1_0_1_1_0__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1_0_1_1_1(), "rule__ForStatement__Group_4_1_0_1_1_1__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1_0_1_1_2(), "rule__ForStatement__Group_4_1_0_1_1_2__0");
			builder.put(grammarAccess.getForStatementAccess().getGroup_4_1_0_2(), "rule__ForStatement__Group_4_1_0_2__0");
			...
			builder.put(grammarAccess.getPropertyMethodDeclarationAccess().getGroup_0_0_4_0(), "rule__PropertyMethodDeclaration__Group_0_0_4_0__0");
			builder.put(grammarAccess.getPropertyMethodDeclarationAccess().getGroup_0_0_4_1(), "rule__PropertyMethodDeclaration__Group_0_0_4_1__0");
			...
			builder.put(grammarAccess.getTypePredicateDeclarationAccess().getGroup(), "rule__TypePredicateDeclaration__Group__0");
			builder.put(grammarAccess.getTypePredicateDeclarationAccess().getGroup_0(), "rule__TypePredicateDeclaration__Group_0__0");
			builder.put(grammarAccess.getTypePredicateDeclarationAccess().getGroup_0_0(), "rule__TypePredicateDeclaration__Group_0_0__0");
			...
			builder.put(grammarAccess.getN4TypeAliasDeclarationAccess().getGroup(), "rule__N4TypeAliasDeclaration__Group__0");
			builder.put(grammarAccess.getN4TypeAliasDeclarationAccess().getGroup_0(), "rule__N4TypeAliasDeclaration__Group_0__0");
			builder.put(grammarAccess.getN4TypeAliasDeclarationAccess().getGroup_0_0(), "rule__N4TypeAliasDeclaration__Group_0_0__0");
			...
			builder.put(grammarAccess.getAnnotatedN4MemberDeclarationAccess().getGroup_1_2_0_0_2_0(), "rule__AnnotatedN4MemberDeclaration__Group_1_2_0_0_2_0__0");
			builder.put(grammarAccess.getAnnotatedN4MemberDeclarationAccess().getGroup_1_2_0_0_2_1(), "rule__AnnotatedN4MemberDeclaration__Group_1_2_0_0_2_1__0");
			...
			builder.put(grammarAccess.getN4MethodDeclarationAccess().getGroup_0_0_3_0(), "rule__N4MethodDeclaration__Group_0_0_3_0__0");
			builder.put(grammarAccess.getN4MethodDeclarationAccess().getGroup_0_0_3_1(), "rule__N4MethodDeclaration__Group_0_0_3_1__0");
			...
			builder.put(grammarAccess.getN4IndexSignatureDeclarationAccess().getGroup(), "rule__N4IndexSignatureDeclaration__Group__0");
			builder.put(grammarAccess.getN4IndexSignatureDeclarationAccess().getGroup_0(), "rule__N4IndexSignatureDeclaration__Group_0__0");
			builder.put(grammarAccess.getN4IndexSignatureDeclarationAccess().getGroup_0_0(), "rule__N4IndexSignatureDeclaration__Group_0_0__0");
			...
			builder.put(grammarAccess.getConditionalTypeRefAccess().getGroup(), "rule__ConditionalTypeRef__Group__0");
			builder.put(grammarAccess.getConditionalTypeRefAccess().getGroup_1(), "rule__ConditionalTypeRef__Group_1__0");
			builder.put(grammarAccess.getConditionalTypeRefAccess().getGroup_1_0(), "rule__ConditionalTypeRef__Group_1_0__0");
			builder.put(grammarAccess.getConditionalTypeRefAccess().getGroup_1_0_0(), "rule__ConditionalTypeRef__Group_1_0_0__0");
			builder.put(grammarAccess.getUnionTypeExpressionAccess().getGroup(), "rule__UnionTypeExpression__Group__0");
			builder.put(grammarAccess.getUnionTypeExpressionAccess().getGroup_2(), "rule__UnionTypeExpression__Group_2__0");
			builder.put(grammarAccess.getUnionTypeExpressionAccess().getGroup_2_1(), "rule__UnionTypeExpression__Group_2_1__0");
			builder.put(grammarAccess.getIntersectionTypeExpressionAccess().getGroup(), "rule__IntersectionTypeExpression__Group__0");
			builder.put(grammarAccess.getIntersectionTypeExpressionAccess().getGroup_2(), "rule__IntersectionTypeExpression__Group_2__0");
			builder.put(grammarAccess.getIntersectionTypeExpressionAccess().getGroup_2_1(), "rule__IntersectionTypeExpression__Group_2_1__0");
			builder.put(grammarAccess.getOperatorTypeRefAccess().getGroup_0(), "rule__OperatorTypeRef__Group_0__0");
			...
			builder.put(grammarAccess.getArrayTypeExpressionAccess().getGroup_2_1_0_0(), "rule__ArrayTypeExpression__Group_2_1_0_0__0");
			builder.put(grammarAccess.getArrayTypeExpressionAccess().getGroup_2_1_0_1(), "rule__ArrayTypeExpression__Group_2_1_0_1__0");
			builder.put(grammarAccess.getPrimaryTypeExpressionAccess().getGroup_6(), "rule__PrimaryTypeExpression__Group_6__0");
			...
			builder.put(grammarAccess.getArrowFunctionTypeExpressionAccess().getGroup_0_0_1(), "rule__ArrowFunctionTypeExpression__Group_0_0_1__0");
			...
			builder.put(grammarAccess.getTAnonymousFormalParameterListWithDeclaredThisTypeAccess().getGroup_0_0(), "rule__TAnonymousFormalParameterListWithDeclaredThisType__Group_0_0__0");
			builder.put(grammarAccess.getTAnonymousFormalParameterListWithDeclaredThisTypeAccess().getGroup_1(), "rule__TAnonymousFormalParameterListWithDeclaredThisType__Group_1__0");
			...
			builder.put(grammarAccess.getParameterizedTypeRefStructuralAccess().getGroup_0(), "rule__ParameterizedTypeRefStructural__Group_0__0");
			...
			builder.put(grammarAccess.getTStructMethodAccess().getGroup_0_0_1(), "rule__TStructMethod__Group_0_0_1__0");
			builder.put(grammarAccess.getTStructMethodAccess().getGroup_0_0_1_2(), "rule__TStructMethod__Group_0_0_1_2__0");
			...
			builder.put(grammarAccess.getTStructFieldAccess().getGroup_0_1(), "rule__TStructField__Group_0_1__0");
			builder.put(grammarAccess.getTStructFieldAccess().getGroup_0_1_0(), "rule__TStructField__Group_0_1_0__0");
			...
			builder.put(grammarAccess.getTStructIndexSignatureAccess().getGroup(), "rule__TStructIndexSignature__Group__0");
			builder.put(grammarAccess.getTStructIndexSignatureAccess().getGroup_0(), "rule__TStructIndexSignature__Group_0__0");
			builder.put(grammarAccess.getTStructIndexSignatureAccess().getGroup_0_0(), "rule__TStructIndexSignature__Group_0_0__0");
			...
			builder.put(grammarAccess.getTypePredicateWithOperatorTypeRefAccess().getGroup(), "rule__TypePredicateWithOperatorTypeRef__Group__0");
			builder.put(grammarAccess.getTypePredicateWithOperatorTypeRefAccess().getGroup_0(), "rule__TypePredicateWithOperatorTypeRef__Group_0__0");
			builder.put(grammarAccess.getTypePredicateWithOperatorTypeRefAccess().getGroup_0_0(), "rule__TypePredicateWithOperatorTypeRef__Group_0_0__0");
			builder.put(grammarAccess.getTLiteralOrComputedPropertyNameAccess().getGroup_3(), "rule__TLiteralOrComputedPropertyName__Group_3__0");
			builder.put(grammarAccess.getPropertyAccessExpressionInTypeRefAccess().getGroup(), "rule__PropertyAccessExpressionInTypeRef__Group__0");
			builder.put(grammarAccess.getPropertyAccessExpressionInTypeRefAccess().getGroup_1(), "rule__PropertyAccessExpressionInTypeRef__Group_1__0");
			...
			builder.put(grammarAccess.getAnnotatedScriptElementAccess().getLiteralsAssignment_1_4_5(), "rule__AnnotatedScriptElement__LiteralsAssignment_1_4_5");
			builder.put(grammarAccess.getAnnotatedScriptElementAccess().getLiteralsAssignment_1_4_6_1(), "rule__AnnotatedScriptElement__LiteralsAssignment_1_4_6_1");
			...
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getNameAssignment_1_1_0_0_4(), "rule__AnnotatedNamespaceElement__NameAssignment_1_1_0_0_4");
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getDeclaredModifiersAssignment_1_1_0_1_1(), "rule__AnnotatedNamespaceElement__DeclaredModifiersAssignment_1_1_0_1_1");
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getTypingStrategyAssignment_1_1_0_1_3(), "rule__AnnotatedNamespaceElement__TypingStrategyAssignment_1_1_0_1_3");
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getNameAssignment_1_1_0_1_4(), "rule__AnnotatedNamespaceElement__NameAssignment_1_1_0_1_4");
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getDeclaredModifiersAssignment_1_2_1(), "rule__AnnotatedNamespaceElement__DeclaredModifiersAssignment_1_2_1");
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getNameAssignment_1_2_3(), "rule__AnnotatedNamespaceElement__NameAssignment_1_2_3");
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getLiteralsAssignment_1_2_5(), "rule__AnnotatedNamespaceElement__LiteralsAssignment_1_2_5");
			builder.put(grammarAccess.getAnnotatedNamespaceElementAccess().getLiteralsAssignment_1_2_6_1(), "rule__AnnotatedNamespaceElement__LiteralsAssignment_1_2_6_1");
			...
			builder.put(grammarAccess.getDeclareDeclarationAccess().getExportedElementAssignment_1_0_1(), "rule__DeclareDeclaration__ExportedElementAssignment_1_0_1");
			builder.put(grammarAccess.getExportDeclarationImplAccess().getWildcardExportAssignment_2_0_0(), "rule__ExportDeclarationImpl__WildcardExportAssignment_2_0_0");
			builder.put(grammarAccess.getExportDeclarationImplAccess().getExportedElementAssignment_2_2(), "rule__ExportDeclarationImpl__ExportedElementAssignment_2_2");
			builder.put(grammarAccess.getExportDeclarationImplAccess().getDefaultExportAssignment_2_3_0(), "rule__ExportDeclarationImpl__DefaultExportAssignment_2_3_0");
			builder.put(grammarAccess.getExportDeclarationImplAccess().getExportedElementAssignment_2_3_1_0(), "rule__ExportDeclarationImpl__ExportedElementAssignment_2_3_1_0");
			builder.put(grammarAccess.getExportDeclarationImplAccess().getDefaultExportedExpressionAssignment_2_3_1_1_0(), "rule__ExportDeclarationImpl__DefaultExportedExpressionAssignment_2_3_1_1_0");
			builder.put(grammarAccess.getExportDeclarationImplAccess().getDefaultExportedExpressionAssignment_2_6_3(), "rule__ExportDeclarationImpl__DefaultExportedExpressionAssignment_2_6_3");
			...
			builder.put(grammarAccess.getAnnotatedExportableElementAccess().getDeclaredModifiersAssignment_1_4_1(), "rule__AnnotatedExportableElement__DeclaredModifiersAssignment_1_4_1");
			builder.put(grammarAccess.getAnnotatedExportableElementAccess().getNameAssignment_1_4_3(), "rule__AnnotatedExportableElement__NameAssignment_1_4_3");
			builder.put(grammarAccess.getAnnotatedExportableElementAccess().getDeclaredTypeRefNodeAssignment_1_4_6(), "rule__AnnotatedExportableElement__DeclaredTypeRefNodeAssignment_1_4_6");
			builder.put(grammarAccess.getImportDeclarationImplAccess().getDtsTypeImportAssignment_1(), "rule__ImportDeclarationImpl__DtsTypeImportAssignment_1");
			builder.put(grammarAccess.getImportDeclarationImplAccess().getImportFromAssignment_2_0_0_1(), "rule__ImportDeclarationImpl__ImportFromAssignment_2_0_0_1");
			builder.put(grammarAccess.getImportDeclarationImplAccess().getModuleAssignment_2_0_1(), "rule__ImportDeclarationImpl__ModuleAssignment_2_0_1");
			...
			builder.put(grammarAccess.getFunctionImplWithoutKeywordAccess().getGeneratorAssignment_0_0(), "rule__FunctionImplWithoutKeyword__GeneratorAssignment_0_0");
			...
			builder.put(grammarAccess.getStrictFormalParametersAccess().getDtsDeclaredThisTypeNodeAssignment_1_0_0_2(), "rule__StrictFormalParameters__DtsDeclaredThisTypeNodeAssignment_1_0_0_2");
			builder.put(grammarAccess.getStrictFormalParametersAccess().getFparsAssignment_1_0_1(), "rule__StrictFormalParameters__FparsAssignment_1_0_1");
			...
			builder.put(grammarAccess.getN4TypeVariableAccess().getDeclaredCovariantAssignment_0_0(), "rule__N4TypeVariable__DeclaredCovariantAssignment_0_0");
			...
			builder.put(grammarAccess.getBindingElementFragmentAccess().getNameAssignment_0_1_2(), "rule__BindingElementFragment__NameAssignment_0_1_2");
			builder.put(grammarAccess.getBindingElementFragmentAccess().getDtsDeclaredOptionalAssignment_0_1_3(), "rule__BindingElementFragment__DtsDeclaredOptionalAssignment_0_1_3");
			...
			builder.put(grammarAccess.getForStatementAccess().getAwaitAssignment_2(), "rule__ForStatement__AwaitAssignment_2");
			builder.put(grammarAccess.getForStatementAccess().getInitExprAssignment_4_0_0_0(), "rule__ForStatement__InitExprAssignment_4_0_0_0");
			builder.put(grammarAccess.getForStatementAccess().getForInAssignment_4_0_0_1(), "rule__ForStatement__ForInAssignment_4_0_0_1");
			builder.put(grammarAccess.getForStatementAccess().getExpressionAssignment_4_0_0_2(), "rule__ForStatement__ExpressionAssignment_4_0_0_2");
			builder.put(grammarAccess.getForStatementAccess().getVarStmtKeywordAssignment_4_1_0_0_0(), "rule__ForStatement__VarStmtKeywordAssignment_4_1_0_0_0");
			builder.put(grammarAccess.getForStatementAccess().getVarDeclsOrBindingsAssignment_4_1_0_0_1_0_0_0(), "rule__ForStatement__VarDeclsOrBindingsAssignment_4_1_0_0_1_0_0_0");
			builder.put(grammarAccess.getForStatementAccess().getForInAssignment_4_1_0_0_1_0_0_1_0(), "rule__ForStatement__ForInAssignment_4_1_0_0_1_0_0_1_0");
			builder.put(grammarAccess.getForStatementAccess().getForOfAssignment_4_1_0_0_1_0_0_1_1(), "rule__ForStatement__ForOfAssignment_4_1_0_0_1_0_0_1_1");
			builder.put(grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_0_1_0_0_2(), "rule__ForStatement__ExpressionAssignment_4_1_0_0_1_0_0_2");
			builder.put(grammarAccess.getForStatementAccess().getVarDeclsOrBindingsAssignment_4_1_0_0_1_1_0(), "rule__ForStatement__VarDeclsOrBindingsAssignment_4_1_0_0_1_1_0");
			builder.put(grammarAccess.getForStatementAccess().getVarDeclsOrBindingsAssignment_4_1_0_0_1_1_1_0_0_1(), "rule__ForStatement__VarDeclsOrBindingsAssignment_4_1_0_0_1_1_1_0_0_1");
			builder.put(grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_0_1_1_1_0_2(), "rule__ForStatement__ExpressionAssignment_4_1_0_0_1_1_1_0_2");
			builder.put(grammarAccess.getForStatementAccess().getUpdateExprAssignment_4_1_0_0_1_1_1_0_4(), "rule__ForStatement__UpdateExprAssignment_4_1_0_0_1_1_1_0_4");
			builder.put(grammarAccess.getForStatementAccess().getForInAssignment_4_1_0_0_1_1_1_1_0(), "rule__ForStatement__ForInAssignment_4_1_0_0_1_1_1_1_0");
			builder.put(grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_0_1_1_1_1_1(), "rule__ForStatement__ExpressionAssignment_4_1_0_0_1_1_1_1_1");
			builder.put(grammarAccess.getForStatementAccess().getForOfAssignment_4_1_0_0_1_1_1_2_0(), "rule__ForStatement__ForOfAssignment_4_1_0_0_1_1_1_2_0");
			builder.put(grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_0_1_1_1_2_1(), "rule__ForStatement__ExpressionAssignment_4_1_0_0_1_1_1_2_1");
			builder.put(grammarAccess.getForStatementAccess().getInitExprAssignment_4_1_0_1_0(), "rule__ForStatement__InitExprAssignment_4_1_0_1_0");
			builder.put(grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_1_1_0_1(), "rule__ForStatement__ExpressionAssignment_4_1_0_1_1_0_1");
			builder.put(grammarAccess.getForStatementAccess().getUpdateExprAssignment_4_1_0_1_1_0_3(), "rule__ForStatement__UpdateExprAssignment_4_1_0_1_1_0_3");
			builder.put(grammarAccess.getForStatementAccess().getForInAssignment_4_1_0_1_1_1_0(), "rule__ForStatement__ForInAssignment_4_1_0_1_1_1_0");
			builder.put(grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_1_1_1_1(), "rule__ForStatement__ExpressionAssignment_4_1_0_1_1_1_1");
			builder.put(grammarAccess.getForStatementAccess().getForOfAssignment_4_1_0_1_1_2_0(), "rule__ForStatement__ForOfAssignment_4_1_0_1_1_2_0");
			builder.put(grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_1_1_2_1(), "rule__ForStatement__ExpressionAssignment_4_1_0_1_1_2_1");
			builder.put(grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_2_1(), "rule__ForStatement__ExpressionAssignment_4_1_0_2_1");
			builder.put(grammarAccess.getForStatementAccess().getUpdateExprAssignment_4_1_0_2_3(), "rule__ForStatement__UpdateExprAssignment_4_1_0_2_3");
			...
			builder.put(grammarAccess.getCatchVariableAccess().getNameAssignment_2(), "rule__CatchVariable__NameAssignment_2");
			...
			builder.put(grammarAccess.getAnnotatedPropertyAssignmentAccess().getDeclaredTypeRefNodeAssignment_1_0_0_0_1(), "rule__AnnotatedPropertyAssignment__DeclaredTypeRefNodeAssignment_1_0_0_0_1");
			...
			builder.put(grammarAccess.getAnnotatedPropertyAssignmentAccess().getDeclaredReturnTypeRefNodeAssignment_1_3_0_0_2(), "rule__AnnotatedPropertyAssignment__DeclaredReturnTypeRefNodeAssignment_1_3_0_0_2");
			...
			builder.put(grammarAccess.getAnnotatedPropertyAssignmentAccess().getDeclaredTypeRefNodeAssignment_1_4_1(), "rule__AnnotatedPropertyAssignment__DeclaredTypeRefNodeAssignment_1_4_1");
			...
			builder.put(grammarAccess.getPropertyMethodDeclarationAccess().getDeclaredReturnTypeRefNodeAssignment_0_0_2(), "rule__PropertyMethodDeclaration__DeclaredReturnTypeRefNodeAssignment_0_0_2");
			...
			builder.put(grammarAccess.getPropertyNameValuePairAccess().getDeclaredTypeRefNodeAssignment_0_0_1(), "rule__PropertyNameValuePair__DeclaredTypeRefNodeAssignment_0_0_1");
			...
			builder.put(grammarAccess.getPropertyNameValuePairSingleNameAccess().getDeclaredTypeRefNodeAssignment_0(), "rule__PropertyNameValuePairSingleName__DeclaredTypeRefNodeAssignment_0");
			...
			builder.put(grammarAccess.getColonSepDeclaredTypeRefAccess().getDeclaredTypeRefNodeAssignment_1(), "rule__ColonSepDeclaredTypeRef__DeclaredTypeRefNodeAssignment_1");
			builder.put(grammarAccess.getColonSepDeclaredReturnTypeRefAccess().getDeclaredReturnTypePredicateAssignment_1_0(), "rule__ColonSepDeclaredReturnTypeRef__DeclaredReturnTypePredicateAssignment_1_0");
			builder.put(grammarAccess.getColonSepDeclaredReturnTypeRefAccess().getDeclaredReturnTypeRefNodeAssignment_1_1(), "rule__ColonSepDeclaredReturnTypeRef__DeclaredReturnTypeRefNodeAssignment_1_1");
			builder.put(grammarAccess.getTypePredicateDeclarationAccess().getReferringToThisAssignment_0_0_0_0(), "rule__TypePredicateDeclaration__ReferringToThisAssignment_0_0_0_0");
			builder.put(grammarAccess.getTypePredicateDeclarationAccess().getFparAssignment_0_0_0_1(), "rule__TypePredicateDeclaration__FparAssignment_0_0_0_1");
			builder.put(grammarAccess.getTypePredicateDeclarationAccess().getTypeRefNodeAssignment_1(), "rule__TypePredicateDeclaration__TypeRefNodeAssignment_1");
			builder.put(grammarAccess.getTypeReferenceNodeAccess().getTypeRefInASTAssignment(), "rule__TypeReferenceNode__TypeRefInASTAssignment");
			builder.put(grammarAccess.getTypeReferenceWithModifiersNodeAccess().getTypeRefInASTAssignment(), "rule__TypeReferenceWithModifiersNode__TypeRefInASTAssignment");
			builder.put(grammarAccess.getParameterizedTypeRefNominalNodeAccess().getTypeRefInASTAssignment(), "rule__ParameterizedTypeRefNominalNode__TypeRefInASTAssignment");
			builder.put(grammarAccess.getArrayTypeExpressionNodeAccess().getTypeRefInASTAssignment(), "rule__ArrayTypeExpressionNode__TypeRefInASTAssignment");
			...
			builder.put(grammarAccess.getCastExpressionAccess().getTargetTypeRefNodeAssignment_1_1(), "rule__CastExpression__TargetTypeRefNodeAssignment_1_1");
			...
			builder.put(grammarAccess.getTypeParametersAccess().getTypeVarsAssignment_1(), "rule__TypeParameters__TypeVarsAssignment_1");
			builder.put(grammarAccess.getTypeParametersAccess().getTypeVarsAssignment_2_1(), "rule__TypeParameters__TypeVarsAssignment_2_1");
			...
			builder.put(grammarAccess.getN4TypeAliasDeclarationAccess().getDeclaredModifiersAssignment_0_0_1(), "rule__N4TypeAliasDeclaration__DeclaredModifiersAssignment_0_0_1");
			builder.put(grammarAccess.getN4TypeAliasDeclarationAccess().getNameAssignment_0_0_3(), "rule__N4TypeAliasDeclaration__NameAssignment_0_0_3");
			builder.put(grammarAccess.getN4TypeAliasDeclarationAccess().getDeclaredTypeRefNodeAssignment_3(), "rule__N4TypeAliasDeclaration__DeclaredTypeRefNodeAssignment_3");
			...
			builder.put(grammarAccess.getAnnotatedN4MemberDeclarationAccess().getGeneratorAssignment_1_2_0_0_2_0_0(), "rule__AnnotatedN4MemberDeclaration__GeneratorAssignment_1_2_0_0_2_0_0");
			builder.put(grammarAccess.getAnnotatedN4MemberDeclarationAccess().getDeclaredNameAssignment_1_2_0_0_2_0_1(), "rule__AnnotatedN4MemberDeclaration__DeclaredNameAssignment_1_2_0_0_2_0_1");
			builder.put(grammarAccess.getAnnotatedN4MemberDeclarationAccess().getDtsDeclaredOptionalAssignment_1_2_0_0_2_0_2(), "rule__AnnotatedN4MemberDeclaration__DtsDeclaredOptionalAssignment_1_2_0_0_2_0_2");
			builder.put(grammarAccess.getAnnotatedN4MemberDeclarationAccess().getDeclaredNameAssignment_1_2_0_0_2_1_1(), "rule__AnnotatedN4MemberDeclaration__DeclaredNameAssignment_1_2_0_0_2_1_1");
			builder.put(grammarAccess.getAnnotatedN4MemberDeclarationAccess().getDtsDeclaredOptionalAssignment_1_2_0_0_2_1_2(), "rule__AnnotatedN4MemberDeclaration__DtsDeclaredOptionalAssignment_1_2_0_0_2_1_2");
			...
			builder.put(grammarAccess.getN4MethodDeclarationAccess().getGeneratorAssignment_0_0_3_0_0(), "rule__N4MethodDeclaration__GeneratorAssignment_0_0_3_0_0");
			builder.put(grammarAccess.getN4MethodDeclarationAccess().getDeclaredNameAssignment_0_0_3_0_1(), "rule__N4MethodDeclaration__DeclaredNameAssignment_0_0_3_0_1");
			builder.put(grammarAccess.getN4MethodDeclarationAccess().getDtsDeclaredOptionalAssignment_0_0_3_0_2(), "rule__N4MethodDeclaration__DtsDeclaredOptionalAssignment_0_0_3_0_2");
			builder.put(grammarAccess.getN4MethodDeclarationAccess().getDeclaredNameAssignment_0_0_3_1_0(), "rule__N4MethodDeclaration__DeclaredNameAssignment_0_0_3_1_0");
			builder.put(grammarAccess.getN4MethodDeclarationAccess().getDtsDeclaredOptionalAssignment_0_0_3_1_1(), "rule__N4MethodDeclaration__DtsDeclaredOptionalAssignment_0_0_3_1_1");
			...
			builder.put(grammarAccess.getGetterHeaderAccess().getDeclaredNameAssignment_1(), "rule__GetterHeader__DeclaredNameAssignment_1");
			builder.put(grammarAccess.getGetterHeaderAccess().getDeclaredOptionalAssignment_2(), "rule__GetterHeader__DeclaredOptionalAssignment_2");
			...
			builder.put(grammarAccess.getConditionalTypeRefAccess().getUpperBoundAssignment_1_1(), "rule__ConditionalTypeRef__UpperBoundAssignment_1_1");
			builder.put(grammarAccess.getConditionalTypeRefAccess().getTrueTypeRefAssignment_1_3(), "rule__ConditionalTypeRef__TrueTypeRefAssignment_1_3");
			builder.put(grammarAccess.getConditionalTypeRefAccess().getFalseTypeRefAssignment_1_5(), "rule__ConditionalTypeRef__FalseTypeRefAssignment_1_5");
			builder.put(grammarAccess.getUnionTypeExpressionAccess().getTypeRefsAssignment_2_1_1(), "rule__UnionTypeExpression__TypeRefsAssignment_2_1_1");
			builder.put(grammarAccess.getIntersectionTypeExpressionAccess().getTypeRefsAssignment_2_1_1(), "rule__IntersectionTypeExpression__TypeRefsAssignment_2_1_1");
			builder.put(grammarAccess.getOperatorTypeRefAccess().getOpAssignment_0_1(), "rule__OperatorTypeRef__OpAssignment_0_1");
			builder.put(grammarAccess.getOperatorTypeRefAccess().getTypeRefAssignment_0_2(), "rule__OperatorTypeRef__TypeRefAssignment_0_2");
			...
			builder.put(grammarAccess.getArrayTypeExpressionAccess().getArrayTypeExpressionAssignment_2_1_0_0_1(), "rule__ArrayTypeExpression__ArrayTypeExpressionAssignment_2_1_0_0_1");
			builder.put(grammarAccess.getArrayTypeExpressionAccess().getIndexTypeRefAssignment_2_1_0_1_2(), "rule__ArrayTypeExpression__IndexTypeRefAssignment_2_1_0_1_2");
			...
			builder.put(grammarAccess.getArrowFunctionTypeExpressionAccess().getDtsAbstractAssignment_0_0_1_0(), "rule__ArrowFunctionTypeExpression__DtsAbstractAssignment_0_0_1_0");
			builder.put(grammarAccess.getArrowFunctionTypeExpressionAccess().getDtsConstructorAssignment_0_0_1_1(), "rule__ArrowFunctionTypeExpression__DtsConstructorAssignment_0_0_1_1");
			...
			builder.put(grammarAccess.getTAnonymousFormalParameterListWithDeclaredThisTypeAccess().getDeclaredThisTypeAssignment_0_0_2(), "rule__TAnonymousFormalParameterListWithDeclaredThisType__DeclaredThisTypeAssignment_0_0_2");
			builder.put(grammarAccess.getTAnonymousFormalParameterListWithDeclaredThisTypeAccess().getFparsAssignment_0_1(), "rule__TAnonymousFormalParameterListWithDeclaredThisType__FparsAssignment_0_1");
			builder.put(grammarAccess.getTAnonymousFormalParameterListWithDeclaredThisTypeAccess().getFparsAssignment_1_1(), "rule__TAnonymousFormalParameterListWithDeclaredThisType__FparsAssignment_1_1");
			...
			builder.put(grammarAccess.getTStructIndexSignatureAccess().getReadonlyAssignment_0_0_1(), "rule__TStructIndexSignature__ReadonlyAssignment_0_0_1");
			...
			builder.put(grammarAccess.getQueryTypeRefAccess().getExprAssignment_1(), "rule__QueryTypeRef__ExprAssignment_1");
			...
			builder.put(grammarAccess.getTypePredicateWithOperatorTypeRefAccess().getReferringToThisAssignment_0_0_0_0(), "rule__TypePredicateWithOperatorTypeRef__ReferringToThisAssignment_0_0_0_0");
			builder.put(grammarAccess.getTypePredicateWithOperatorTypeRefAccess().getFparAssignment_0_0_0_1(), "rule__TypePredicateWithOperatorTypeRef__FparAssignment_0_0_0_1");
			builder.put(grammarAccess.getTypePredicateWithOperatorTypeRefAccess().getTypeRefAssignment_1(), "rule__TypePredicateWithOperatorTypeRef__TypeRefAssignment_1");
			...
			builder.put(grammarAccess.getTLiteralOrComputedPropertyNameAccess().getDtsComputedNameExpressionAssignment_3_1(), "rule__TLiteralOrComputedPropertyName__DtsComputedNameExpressionAssignment_3_1");
			builder.put(grammarAccess.getExpressionInTypeRefAccess().getNameTypeRefAssignment_0(), "rule__ExpressionInTypeRef__NameTypeRefAssignment_0");
			builder.put(grammarAccess.getExpressionInTypeRefAccess().getNameTypeRefAssignment_1(), "rule__ExpressionInTypeRef__NameTypeRefAssignment_1");
			builder.put(grammarAccess.getPropertyAccessExpressionInTypeRefAccess().getIdentifierNamesAssignment_0(), "rule__PropertyAccessExpressionInTypeRef__IdentifierNamesAssignment_0");
			builder.put(grammarAccess.getPropertyAccessExpressionInTypeRefAccess().getIdentifierNamesAssignment_1_1(), "rule__PropertyAccessExpressionInTypeRef__IdentifierNamesAssignment_1_1");
		}
	}
