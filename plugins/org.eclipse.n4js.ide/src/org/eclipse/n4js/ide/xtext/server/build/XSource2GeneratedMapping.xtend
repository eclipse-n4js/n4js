 ...
 */
@FinalFieldsConstructor class XSource2GeneratedMapping implements Externalizable {
	...
	def copy() {
		new XSource2GeneratedMapping(HashMultimap.create(source2generated), HashMultimap.create(generated2source), new HashMap(generated2OutputConfigName))
	}
