...
class XIndexer {
	...
	@Data static class XIndexResult {
		List<Delta> resourceDeltas
		ResourceDescriptionsData newIndex
	}

	def XIndexResult computeAndIndexAffected(XBuildRequest request, extension XBuildContext context) {
	...
	protected def List<Delta> getDeltasForDeletedResources(XBuildRequest request, ResourceDescriptionsData oldIndex,
	...
	protected def List<Delta> getDeltasForChangedResources(Iterable<URI> affectedUris,
		ResourceDescriptionsData oldIndex, extension XBuildContext context) {
		try {
	...
	def protected Delta addToIndex(Resource resource, boolean isPreIndexing, ResourceDescriptionsData oldIndex,
		...
		val IResourceDescription toBeAdded = new XResolvedResourceDescription(newDescription)
	...
	@Log protected static class XResolvedResourceDescription extends AbstractResourceDescription {
