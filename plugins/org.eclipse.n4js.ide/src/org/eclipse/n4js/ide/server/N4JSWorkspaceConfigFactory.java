...
public class N4JSWorkspaceConfigFactory implements XIWorkspaceConfigFactory {
	...
	public XIWorkspaceConfig createWorkspaceConfig(URI workspaceBaseURI) {
		...
		N4JSWorkspaceConfig result = new N4JSWorkspaceConfig(workspaceBaseURI, projectDiscoveryHelper,
				projectDescriptionLoader, configSnapshotFactory, uriExtensions);
