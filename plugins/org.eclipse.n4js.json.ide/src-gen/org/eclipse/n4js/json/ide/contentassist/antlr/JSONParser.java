...
public class JSONParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JSONGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getJSONObjectAccess().getNameValuePairsAssignment_2_0(), "rule__JSONObject__NameValuePairsAssignment_2_0");
			builder.put(grammarAccess.getJSONObjectAccess().getNameValuePairsAssignment_2_1_1(), "rule__JSONObject__NameValuePairsAssignment_2_1_1");
