 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.n4js.ts.types.impl.TStructMethodImpl#getDefinedMember <em>Defined Member</em>}</li>
 *   <li>{@link org.eclipse.n4js.ts.types.impl.TStructMethodImpl#getDtsComputedNameExpression <em>Dts Computed Name Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TStructMethodImpl extends TMethodImpl implements TStructMethod {
	...
	public NotificationChain basicSetDtsComputedNameExpression(ExpressionInTypeRef newDtsComputedNameExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.TSTRUCT_METHOD__DTS_COMPUTED_NAME_EXPRESSION, oldDtsComputedNameExpression, newDtsComputedNameExpression);
	...
	public void setDtsComputedNameExpression(ExpressionInTypeRef newDtsComputedNameExpression) {
		if (newDtsComputedNameExpression != dtsComputedNameExpression) {
			...
			if (dtsComputedNameExpression != null)
				msgs = ((InternalEObject)dtsComputedNameExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.TSTRUCT_METHOD__DTS_COMPUTED_NAME_EXPRESSION, null, msgs);
			if (newDtsComputedNameExpression != null)
				msgs = ((InternalEObject)newDtsComputedNameExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.TSTRUCT_METHOD__DTS_COMPUTED_NAME_EXPRESSION, null, msgs);
			msgs = basicSetDtsComputedNameExpression(newDtsComputedNameExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.TSTRUCT_METHOD__DTS_COMPUTED_NAME_EXPRESSION, newDtsComputedNameExpression, newDtsComputedNameExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TypesPackage.TSTRUCT_METHOD__DTS_COMPUTED_NAME_EXPRESSION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TStructMember.class) {
			switch (derivedFeatureID) {
				...
				case TypesPackage.TSTRUCT_METHOD__DTS_COMPUTED_NAME_EXPRESSION: return TypesPackage.TSTRUCT_MEMBER__DTS_COMPUTED_NAME_EXPRESSION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TStructMember.class) {
			switch (baseFeatureID) {
				...
				case TypesPackage.TSTRUCT_MEMBER__DTS_COMPUTED_NAME_EXPRESSION: return TypesPackage.TSTRUCT_METHOD__DTS_COMPUTED_NAME_EXPRESSION;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == TStructMember.class) {
			switch (baseOperationID) {
				...
				case TypesPackage.TSTRUCT_MEMBER___IS_AST_CALL_SIGNATURE: return TypesPackage.TSTRUCT_METHOD___IS_AST_CALL_SIGNATURE;
				case TypesPackage.TSTRUCT_MEMBER___IS_AST_CONSTRUCT_SIGNATURE: return TypesPackage.TSTRUCT_METHOD___IS_AST_CONSTRUCT_SIGNATURE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case TypesPackage.TSTRUCT_METHOD___IS_AST_CALL_SIGNATURE:
				return isASTCallSignature();
			case TypesPackage.TSTRUCT_METHOD___IS_AST_CONSTRUCT_SIGNATURE:
