...
public interface TClass extends TN4Classifier {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='<%org.eclipse.n4js.ts.typeRefs.ParameterizedTypeRef%> _superClassRef = this.getSuperClassRef();\nboolean _tripleNotEquals = (_superClassRef != null);\nif (_tripleNotEquals)\n{\n\t<%org.eclipse.n4js.ts.typeRefs.ParameterizedTypeRef%> _superClassRef_1 = this.getSuperClassRef();\n\t<%java.util.Set%><<%org.eclipse.n4js.ts.typeRefs.ParameterizedTypeRef%>> _singleton = <%java.util.Collections%>.<<%org.eclipse.n4js.ts.typeRefs.ParameterizedTypeRef%>>singleton(_superClassRef_1);\n\t<%org.eclipse.emf.common.util.EList%><<%org.eclipse.n4js.ts.typeRefs.ParameterizedTypeRef%>> _implementedInterfaceRefs = this.getImplementedInterfaceRefs();\n\treturn <%com.google.common.collect.Iterables%>.<<%org.eclipse.n4js.ts.typeRefs.ParameterizedTypeRef%>>concat(_singleton, _implementedInterfaceRefs);\n}\n<%org.eclipse.emf.common.util.EList%><<%org.eclipse.n4js.ts.typeRefs.ParameterizedTypeRef%>> _implementedInterfaceRefs_1 = this.getImplementedInterfaceRefs();\nreturn <%com.google.common.collect.Iterables%>.<<%org.eclipse.n4js.ts.typeRefs.ParameterizedTypeRef%>>concat(_implementedInterfaceRefs_1);'"
	 * @generated
	 */
