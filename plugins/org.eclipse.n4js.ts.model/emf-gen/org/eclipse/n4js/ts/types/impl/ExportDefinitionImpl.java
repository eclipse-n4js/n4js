 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.n4js.ts.types.impl.ExportDefinitionImpl#getDeclaredExportedName <em>Declared Exported Name</em>}</li>
 *   <li>{@link org.eclipse.n4js.ts.types.impl.ExportDefinitionImpl#getExportedElement <em>Exported Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExportDefinitionImpl extends ProxyResolvingEObjectImpl implements ExportDefinition {
	/**
	...
	public void setDeclaredExportedName(String newDeclaredExportedName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.EXPORT_DEFINITION__DECLARED_EXPORTED_NAME, oldDeclaredExportedName, declaredExportedName));
	}
	...
	public TExportableElement getExportedElement() {
		if (exportedElement != null && exportedElement.eIsProxy()) {
			...
			if (exportedElement != oldExportedElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypesPackage.EXPORT_DEFINITION__EXPORTED_ELEMENT, oldExportedElement, exportedElement));
			}
		}
	...
	public void setExportedElement(TExportableElement newExportedElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.EXPORT_DEFINITION__EXPORTED_ELEMENT, oldExportedElement, exportedElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TypesPackage.EXPORT_DEFINITION__DECLARED_EXPORTED_NAME:
				return getDeclaredExportedName();
			case TypesPackage.EXPORT_DEFINITION__EXPORTED_ELEMENT:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TypesPackage.EXPORT_DEFINITION___GET_EXPORTED_NAME:
