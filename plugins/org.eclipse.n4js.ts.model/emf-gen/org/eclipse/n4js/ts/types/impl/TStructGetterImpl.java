 ...
 *   <li>{@link org.eclipse.n4js.ts.types.impl.TStructGetterImpl#getDtsComputedNameExpression <em>Dts Computed Name Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TStructGetterImpl extends TGetterImpl implements TStructGetter {
	...
	public NotificationChain basicSetDtsComputedNameExpression(ExpressionInTypeRef newDtsComputedNameExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.TSTRUCT_GETTER__DTS_COMPUTED_NAME_EXPRESSION, oldDtsComputedNameExpression, newDtsComputedNameExpression);
	...
	public void setDtsComputedNameExpression(ExpressionInTypeRef newDtsComputedNameExpression) {
		if (newDtsComputedNameExpression != dtsComputedNameExpression) {
			...
			if (dtsComputedNameExpression != null)
				msgs = ((InternalEObject)dtsComputedNameExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.TSTRUCT_GETTER__DTS_COMPUTED_NAME_EXPRESSION, null, msgs);
			if (newDtsComputedNameExpression != null)
				msgs = ((InternalEObject)newDtsComputedNameExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.TSTRUCT_GETTER__DTS_COMPUTED_NAME_EXPRESSION, null, msgs);
			msgs = basicSetDtsComputedNameExpression(newDtsComputedNameExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.TSTRUCT_GETTER__DTS_COMPUTED_NAME_EXPRESSION, newDtsComputedNameExpression, newDtsComputedNameExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TypesPackage.TSTRUCT_GETTER__DTS_COMPUTED_NAME_EXPRESSION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TStructMember.class) {
			switch (derivedFeatureID) {
				...
				case TypesPackage.TSTRUCT_GETTER__DTS_COMPUTED_NAME_EXPRESSION: return TypesPackage.TSTRUCT_MEMBER__DTS_COMPUTED_NAME_EXPRESSION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TStructMember.class) {
			switch (baseFeatureID) {
				...
				case TypesPackage.TSTRUCT_MEMBER__DTS_COMPUTED_NAME_EXPRESSION: return TypesPackage.TSTRUCT_GETTER__DTS_COMPUTED_NAME_EXPRESSION;
				default: return -1;
			}
		}
