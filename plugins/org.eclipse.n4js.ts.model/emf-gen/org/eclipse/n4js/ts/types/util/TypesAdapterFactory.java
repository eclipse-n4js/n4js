...
public class TypesAdapterFactory extends AdapterFactoryImpl {
	...
	protected TypesSwitch<Adapter> modelSwitch =
		new TypesSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTDynamicElement(TDynamicElement object) {
				return createTDynamicElementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.n4js.ts.types.TDynamicElement <em>TDynamic Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTDynamicElementAdapter() {
		return null;
	}
