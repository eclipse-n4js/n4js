	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TypesPackage.TFUNCTION: {
				...
				if (result == null) result = caseGenericType(tFunction);
			...
			case TypesPackage.CONTAINER_TYPE: {
				...
				if (result == null) result = caseGenericType(containerType);
			...
			case TypesPackage.TSTRUCTURAL_TYPE: {
				...
				if (result == null) result = caseGenericType(tStructuralType);
			...
			case TypesPackage.TCLASSIFIER: {
				...
				if (result == null) result = caseGenericType(tClassifier);
			...
			case TypesPackage.TMEMBER: {
				...
				if (result == null) result = caseTExportableElement(tMember);
			...
			case TypesPackage.TMEMBER_WITH_ACCESS_MODIFIER: {
				...
				if (result == null) result = caseTExportableElement(tMemberWithAccessModifier);
			...
			case TypesPackage.TSTRUCT_MEMBER: {
				...
				if (result == null) result = caseTExportableElement(tStructMember);
			...
			case TypesPackage.TMETHOD: {
				...
				if (result == null) result = caseGenericType(tMethod);
			...
			case TypesPackage.TSTRUCT_METHOD: {
				...
				if (result == null) result = caseGenericType(tStructMethod);
			...
			case TypesPackage.TFIELD: {
				...
				if (result == null) result = caseTExportableElement(tField);
			...
			case TypesPackage.TSTRUCT_FIELD: {
				...
				if (result == null) result = caseTExportableElement(tStructField);
			...
			case TypesPackage.FIELD_ACCESSOR: {
				...
				if (result == null) result = caseTExportableElement(fieldAccessor);
			...
			case TypesPackage.TGETTER: {
				...
				if (result == null) result = caseTExportableElement(tGetter);
			...
			case TypesPackage.TSTRUCT_GETTER: {
				...
				if (result == null) result = caseTExportableElement(tStructGetter);
			...
			case TypesPackage.TSETTER: {
				...
				if (result == null) result = caseTExportableElement(tSetter);
			...
			case TypesPackage.TSTRUCT_SETTER: {
				...
				if (result == null) result = caseTExportableElement(tStructSetter);
