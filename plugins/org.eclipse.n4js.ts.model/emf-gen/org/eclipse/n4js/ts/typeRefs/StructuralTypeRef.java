...
public interface StructuralTypeRef extends EObject {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='<%org.eclipse.emf.common.util.EList%><<%org.eclipse.n4js.ts.typeRefs.TypeVariableMapping%>> _postponedSubstitutions = this.getPostponedSubstitutions();\nfinal <%org.eclipse.xtext.xbase.lib.Functions.Function1%><<%org.eclipse.n4js.ts.typeRefs.TypeVariableMapping%>, <%java.lang.Boolean%>> _function = new <%org.eclipse.xtext.xbase.lib.Functions.Function1%><<%org.eclipse.n4js.ts.typeRefs.TypeVariableMapping%>, <%java.lang.Boolean%>>()\n{\n\tpublic <%java.lang.Boolean%> apply(final <%org.eclipse.n4js.ts.typeRefs.TypeVariableMapping%> m)\n\t{\n\t\t<%org.eclipse.n4js.ts.types.TypeVariable%> _typeVar = null;\n\t\tif (m!=null)\n\t\t{\n\t\t\t_typeVar=m.getTypeVar();\n\t\t}\n\t\treturn <%java.lang.Boolean%>.valueOf((_typeVar == typeVar));\n\t}\n};\nreturn <%org.eclipse.xtext.xbase.lib.IterableExtensions%>.<<%org.eclipse.n4js.ts.typeRefs.TypeVariableMapping%>>exists(_postponedSubstitutions, _function);'"
	 * @generated
	 */
