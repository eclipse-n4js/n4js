...
import org.eclipse.n4js.ts.typeRefs.TypeOperator;
...
public class TypeRefsPackageImpl extends EPackageImpl implements TypeRefsPackage {
	 ...
	 * @generated
	 */
	private EClass literalTypeRefEClass = null;
	 ...
	 * @generated
	 */
	private EClass booleanLiteralTypeRefEClass = null;
	 ...
	 * @generated
	 */
	private EClass queryTypeRefEClass = null;
	 ...
	 * @generated
	 */
	private EClass operatorTypeRefEClass = null;
	 ...
	 * @generated
	 */
	private EClass indexAccessTypeRefEClass = null;
	 ...
	 */
	@Override
	public EOperation getTypeArgument__IsTypeRef() {
	 ...
	 */
	@Override
	public EOperation getTypeArgument__InternalGetTypeRefAsString() {
	 ...
	 */
	@Override
	public EReference getTypeRef_OriginalAliasTypeRef() {
	 ...
	 */
	@Override
	public EOperation getTypeRef__IsTypeRef() {
	 ...
	 */
	@Override
	public EOperation getTypeRef__IsAliasUnresolved() {
	 ...
	 */
	@Override
	public EOperation getTypeRef__IsAliasResolved() {
	 ...
	 */
	@Override
	public EOperation getTypeRef__GetDeclaredTypeArgs() {
	 ...
	 */
	@Override
	public EOperation getTypeRef__GetTypeArgsWithDefaults() {
	 ...
	 */
	@Override
	public EOperation getTypeRef__GetTypeRefAsStringWithAliasResolution() {
	 ...
	 */
	@Override
	public EOperation getTypeRef__InternalGetTypeRefAsString() {
	...
	public EOperation getTypeRef__GetStructuralMembers() {
		return typeRefEClass.getEOperations().get(23);
	}
	 ...
	 */
	@Override
	public EOperation getComposedTypeRef__InternalGetTypeRefAsString() {
	 ...
	 */
	@Override
	public EOperation getUnionTypeExpression__InternalGetTypeRefAsString() {
	 ...
	 */
	@Override
	public EOperation getIntersectionTypeExpression__InternalGetTypeRefAsString() {
	 ...
	 */
	@Override
	public EOperation getThisTypeRef__InternalGetTypeRefAsString() {
	 ...
	 */
	@Override
	public EOperation getThisTypeRefStructural__InternalGetTypeRefAsString() {
	 ...
	 */
	@Override
	public EOperation getBoundThisTypeRef__InternalGetTypeRefAsString() {
	 ...
	 */
	@Override
	public EAttribute getParameterizedTypeRef_DeclaredTypeAsText() {
		return (EAttribute)parameterizedTypeRefEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getParameterizedTypeRef_DeclaredTypeArgs() {
	 ...
	 */
	@Override
	public EAttribute getParameterizedTypeRef_ArrayNTypeExpression() {
	 ...
	 */
	@Override
	public EReference getParameterizedTypeRef_AstNamespaceLikeRefs() {
	 ...
	 */
	@Override
	public EOperation getParameterizedTypeRefStructural__InternalGetTypeRefAsString() {
	 ...
	 */
	@Override
	public EOperation getExistentialTypeRef__InternalGetTypeRefAsString() {
	 ...
	 */
	@Override
	public EOperation getUnknownTypeRef__InternalGetTypeRefAsString() {
	 ...
	 */
	@Override
	public EOperation getWildcard__InternalGetTypeRefAsString() {
	 ...
	 */
	@Override
	public EAttribute getFunctionTypeExpression_DtsAbstract() {
	 ...
	 */
	@Override
	public EAttribute getFunctionTypeExpression_DtsConstructor() {
		return (EAttribute)functionTypeExpressionEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getFunctionTypeExpression_Binding() {
		return (EAttribute)functionTypeExpressionEClass.getEStructuralFeatures().get(2);
	}
	...
	public EReference getFunctionTypeExpression_ReturnTypeRef() {
		return (EReference)functionTypeExpressionEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 */
	@Override
	public EReference getFunctionTypeExpression_ReturnTypePredicate() {
		return (EReference)functionTypeExpressionEClass.getEStructuralFeatures().get(11);
	}
	 ...
	 */
	@Override
	public EOperation getDeferredTypeRef__InternalGetTypeRefAsString() {
	 ...
	 */
	@Override
	public EClass getLiteralTypeRef() {
		return literalTypeRefEClass;
	}
	 ...
	 */
	@Override
	public EClass getBooleanLiteralTypeRef() {
		return booleanLiteralTypeRefEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getBooleanLiteralTypeRef_Value() {
		return (EAttribute)booleanLiteralTypeRefEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EOperation getBooleanLiteralTypeRef__InternalGetTypeRefAsString() {
		return booleanLiteralTypeRefEClass.getEOperations().get(0);
	}
	 ...
	 */
	@Override
	public EClass getStringLiteralTypeRef() {
		return stringLiteralTypeRefEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getStringLiteralTypeRef_Value() {
		return (EAttribute)stringLiteralTypeRefEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EOperation getStringLiteralTypeRef__InternalGetTypeRefAsString() {
		return stringLiteralTypeRefEClass.getEOperations().get(0);
	}
	 ...
	 */
	@Override
	public EClass getQueryTypeRef() {
		return queryTypeRefEClass;
	}
	 ...
	 */
	@Override
	public EOperation getQueryTypeRef__InternalGetTypeRefAsString() {
		return queryTypeRefEClass.getEOperations().get(0);
	}
	 ...
	 */
	@Override
	public EClass getOperatorTypeRef() {
		return operatorTypeRefEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getOperatorTypeRef_Op() {
		return (EAttribute)operatorTypeRefEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getOperatorTypeRef_TypeRef() {
		return (EReference)operatorTypeRefEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EOperation getOperatorTypeRef__InternalGetTypeRefAsString() {
		return operatorTypeRefEClass.getEOperations().get(0);
	}
	 ...
	 */
	@Override
	public EClass getIndexAccessTypeRef() {
		return indexAccessTypeRefEClass;
	}
	 ...
	 */
	@Override
	public EReference getIndexAccessTypeRef_TargetTypeRef() {
		return (EReference)indexAccessTypeRefEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getIndexAccessTypeRef_IndexTypeRef() {
		return (EReference)indexAccessTypeRefEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EOperation getIndexAccessTypeRef__InternalGetTypeRefAsString() {
		return indexAccessTypeRefEClass.getEOperations().get(0);
	}
	 ...
	 */
	@Override
	public EClass getConditionalTypeRef() {
		return conditionalTypeRefEClass;
	}
	 ...
	 */
	@Override
	public EReference getConditionalTypeRef_TypeRef() {
		return (EReference)conditionalTypeRefEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getConditionalTypeRef_UpperBound() {
		return (EReference)conditionalTypeRefEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getConditionalTypeRef_TrueTypeRef() {
		return (EReference)conditionalTypeRefEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getConditionalTypeRef_FalseTypeRef() {
		return (EReference)conditionalTypeRefEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EOperation getConditionalTypeRef__InternalGetTypeRefAsString() {
		return conditionalTypeRefEClass.getEOperations().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(typeArgumentEClass, TYPE_ARGUMENT___IS_TYPE_REF);
		...
		createEOperation(typeArgumentEClass, TYPE_ARGUMENT___INTERNAL_GET_TYPE_REF_AS_STRING);

		typeRefEClass = createEClass(TYPE_REF);
		createEAttribute(typeRefEClass, TYPE_REF__FOLLOWED_BY_QUESTION_MARK);
		createEReference(typeRefEClass, TYPE_REF__ORIGINAL_ALIAS_TYPE_REF);
		createEOperation(typeRefEClass, TYPE_REF___GET_MODIFIERS_AS_STRING);
		createEOperation(typeRefEClass, TYPE_REF___IS_TYPE_REF);
		createEOperation(typeRefEClass, TYPE_REF___IS_ALIAS_UNRESOLVED);
		createEOperation(typeRefEClass, TYPE_REF___IS_ALIAS_RESOLVED);
		...
		createEOperation(typeRefEClass, TYPE_REF___GET_DECLARED_TYPE_ARGS);
		createEOperation(typeRefEClass, TYPE_REF___GET_TYPE_ARGS_WITH_DEFAULTS);
		createEOperation(typeRefEClass, TYPE_REF___GET_TYPE_REF_AS_STRING);
		createEOperation(typeRefEClass, TYPE_REF___GET_TYPE_REF_AS_STRING_WITH_ALIAS_RESOLUTION);
		createEOperation(typeRefEClass, TYPE_REF___INTERNAL_GET_TYPE_REF_AS_STRING);
		...
		createEOperation(composedTypeRefEClass, COMPOSED_TYPE_REF___INTERNAL_GET_TYPE_REF_AS_STRING);

		unionTypeExpressionEClass = createEClass(UNION_TYPE_EXPRESSION);
		createEOperation(unionTypeExpressionEClass, UNION_TYPE_EXPRESSION___INTERNAL_GET_TYPE_REF_AS_STRING);

		intersectionTypeExpressionEClass = createEClass(INTERSECTION_TYPE_EXPRESSION);
		createEOperation(intersectionTypeExpressionEClass, INTERSECTION_TYPE_EXPRESSION___INTERNAL_GET_TYPE_REF_AS_STRING);

		thisTypeRefEClass = createEClass(THIS_TYPE_REF);
		createEOperation(thisTypeRefEClass, THIS_TYPE_REF___INTERNAL_GET_TYPE_REF_AS_STRING);
		...
		createEOperation(thisTypeRefStructuralEClass, THIS_TYPE_REF_STRUCTURAL___INTERNAL_GET_TYPE_REF_AS_STRING);
		...
		createEOperation(boundThisTypeRefEClass, BOUND_THIS_TYPE_REF___INTERNAL_GET_TYPE_REF_AS_STRING);
		...
		createEAttribute(parameterizedTypeRefEClass, PARAMETERIZED_TYPE_REF__DECLARED_TYPE_AS_TEXT);
		...
		createEReference(parameterizedTypeRefEClass, PARAMETERIZED_TYPE_REF__AST_NAMESPACE_LIKE_REFS);
		...
		createEOperation(parameterizedTypeRefStructuralEClass, PARAMETERIZED_TYPE_REF_STRUCTURAL___INTERNAL_GET_TYPE_REF_AS_STRING);
		...
		createEOperation(existentialTypeRefEClass, EXISTENTIAL_TYPE_REF___INTERNAL_GET_TYPE_REF_AS_STRING);

		unknownTypeRefEClass = createEClass(UNKNOWN_TYPE_REF);
		createEOperation(unknownTypeRefEClass, UNKNOWN_TYPE_REF___IS_UNKNOWN);
		createEOperation(unknownTypeRefEClass, UNKNOWN_TYPE_REF___INTERNAL_GET_TYPE_REF_AS_STRING);
		...
		createEAttribute(functionTypeExpressionEClass, FUNCTION_TYPE_EXPRESSION__DTS_ABSTRACT);
		createEAttribute(functionTypeExpressionEClass, FUNCTION_TYPE_EXPRESSION__DTS_CONSTRUCTOR);
		...
		createEReference(functionTypeExpressionEClass, FUNCTION_TYPE_EXPRESSION__RETURN_TYPE_PREDICATE);
		...
		createEAttribute(operatorTypeRefEClass, OPERATOR_TYPE_REF__OP);
		createEReference(operatorTypeRefEClass, OPERATOR_TYPE_REF__TYPE_REF);
		createEOperation(operatorTypeRefEClass, OPERATOR_TYPE_REF___INTERNAL_GET_TYPE_REF_AS_STRING);

		indexAccessTypeRefEClass = createEClass(INDEX_ACCESS_TYPE_REF);
		createEReference(indexAccessTypeRefEClass, INDEX_ACCESS_TYPE_REF__TARGET_TYPE_REF);
		createEReference(indexAccessTypeRefEClass, INDEX_ACCESS_TYPE_REF__INDEX_TYPE_REF);
		createEOperation(indexAccessTypeRefEClass, INDEX_ACCESS_TYPE_REF___INTERNAL_GET_TYPE_REF_AS_STRING);

		conditionalTypeRefEClass = createEClass(CONDITIONAL_TYPE_REF);
		createEReference(conditionalTypeRefEClass, CONDITIONAL_TYPE_REF__TYPE_REF);
		createEReference(conditionalTypeRefEClass, CONDITIONAL_TYPE_REF__UPPER_BOUND);
		createEReference(conditionalTypeRefEClass, CONDITIONAL_TYPE_REF__TRUE_TYPE_REF);
	...
	public void initializePackageContents() {
		...
		queryTypeRefEClass.getESuperTypes().add(this.getTypeRef());
		...
		initEOperation(getTypeArgument__IsTypeRef(), theEcorePackage.getEBoolean(), "isTypeRef", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getTypeArgument__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getTypeRef_OriginalAliasTypeRef(), this.getParameterizedTypeRef(), null, "originalAliasTypeRef", null, 0, 1, TypeRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getTypeRef__GetModifiersAsString(), theEcorePackage.getEString(), "getModifiersAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);

		initEOperation(getTypeRef__IsTypeRef(), theEcorePackage.getEBoolean(), "isTypeRef", 0, 1, !IS_UNIQUE, IS_ORDERED);

		initEOperation(getTypeRef__IsAliasUnresolved(), theEcorePackage.getEBoolean(), "isAliasUnresolved", 0, 1, !IS_UNIQUE, IS_ORDERED);

		initEOperation(getTypeRef__IsAliasResolved(), theEcorePackage.getEBoolean(), "isAliasResolved", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getTypeRef__GetDeclaredTypeArgs(), this.getTypeArgument(), "getDeclaredTypeArgs", 0, -1, !IS_UNIQUE, IS_ORDERED);

		initEOperation(getTypeRef__GetTypeArgsWithDefaults(), this.getTypeArgument(), "getTypeArgsWithDefaults", 0, -1, !IS_UNIQUE, IS_ORDERED);

		initEOperation(getTypeRef__GetTypeRefAsString(), theEcorePackage.getEString(), "getTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);

		initEOperation(getTypeRef__GetTypeRefAsStringWithAliasResolution(), theEcorePackage.getEString(), "getTypeRefAsStringWithAliasResolution", 0, 1, !IS_UNIQUE, IS_ORDERED);

		initEOperation(getTypeRef__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getComposedTypeRef__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getUnionTypeExpression__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getIntersectionTypeExpression__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);

		initEClass(thisTypeRefEClass, ThisTypeRef.class, "ThisTypeRef", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEOperation(getThisTypeRef__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getThisTypeRefStructural__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getBoundThisTypeRef__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getParameterizedTypeRef_DeclaredTypeAsText(), theEcorePackage.getEString(), "declaredTypeAsText", null, 0, 1, ParameterizedTypeRef.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getParameterizedTypeRef_AstNamespaceLikeRefs(), this.getNamespaceLikeRef(), null, "astNamespaceLikeRefs", null, 0, -1, ParameterizedTypeRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEOperation(getParameterizedTypeRef__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getParameterizedTypeRefStructural__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getExistentialTypeRef__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getUnknownTypeRef__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getFunctionTypeExpression_DtsAbstract(), theEcorePackage.getEBoolean(), "dtsAbstract", null, 0, 1, FunctionTypeExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFunctionTypeExpression_DtsConstructor(), theEcorePackage.getEBoolean(), "dtsConstructor", null, 0, 1, FunctionTypeExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFunctionTypeExpression_ReturnTypePredicate(), theTypesPackage.getTypePredicate(), null, "returnTypePredicate", null, 0, 1, FunctionTypeExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEOperation(getDeferredTypeRef__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEClass(booleanLiteralTypeRefEClass, BooleanLiteralTypeRef.class, "BooleanLiteralTypeRef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBooleanLiteralTypeRef_Value(), theEcorePackage.getEBooleanObject(), "value", null, 0, 1, BooleanLiteralTypeRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(operatorTypeRefEClass, OperatorTypeRef.class, "OperatorTypeRef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getOperatorTypeRef_Op(), this.getTypeOperator(), "op", null, 0, 1, OperatorTypeRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperatorTypeRef_TypeRef(), this.getTypeRef(), null, "typeRef", null, 0, 1, OperatorTypeRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getOperatorTypeRef__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);

		initEClass(indexAccessTypeRefEClass, IndexAccessTypeRef.class, "IndexAccessTypeRef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getIndexAccessTypeRef_TargetTypeRef(), this.getTypeRef(), null, "targetTypeRef", null, 0, 1, IndexAccessTypeRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIndexAccessTypeRef_IndexTypeRef(), this.getTypeRef(), null, "indexTypeRef", null, 0, 1, IndexAccessTypeRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getIndexAccessTypeRef__InternalGetTypeRefAsString(), theEcorePackage.getEString(), "internalGetTypeRefAsString", 0, 1, !IS_UNIQUE, IS_ORDERED);

		initEClass(conditionalTypeRefEClass, ConditionalTypeRef.class, "ConditionalTypeRef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConditionalTypeRef_TypeRef(), this.getTypeRef(), null, "typeRef", null, 0, 1, ConditionalTypeRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConditionalTypeRef_UpperBound(), this.getTypeRef(), null, "upperBound", null, 0, 1, ConditionalTypeRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConditionalTypeRef_TrueTypeRef(), this.getTypeRef(), null, "trueTypeRef", null, 0, 1, ConditionalTypeRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(typeOperatorEEnum, TypeOperator.KEYOF);
		addEEnumLiteral(typeOperatorEEnum, TypeOperator.UNIQUE);
		addEEnumLiteral(typeOperatorEEnum, TypeOperator.READONLY);
