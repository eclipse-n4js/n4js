...
public interface FunctionTypeExpression extends FunctionTypeExprOrRef {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='if ((typeVar == null))\n{\n\tthrow new <%java.lang.IllegalArgumentException%>(\"given type variable may not be null\");\n}\n<%org.eclipse.emf.common.util.EList%><<%org.eclipse.n4js.ts.types.TypeVariable%>> _unboundTypeVars = this.getUnboundTypeVars();\nfinal int idx = _unboundTypeVars.indexOf(typeVar);\nif (((idx >= 0) && (idx < this.getUnboundTypeVarsUpperBounds().size())))\n{\n\t<%org.eclipse.emf.common.util.EList%><<%org.eclipse.n4js.ts.typeRefs.TypeRef%>> _unboundTypeVarsUpperBounds = this.getUnboundTypeVarsUpperBounds();\n\tfinal <%org.eclipse.n4js.ts.typeRefs.TypeRef%> modifiedUpperBound = _unboundTypeVarsUpperBounds.get(idx);\n\tif ((modifiedUpperBound != null))\n\t{\n\t\treturn modifiedUpperBound;\n\t}\n}\nreturn typeVar.getDeclaredUpperBound();'"
	 * @generated
	 */
