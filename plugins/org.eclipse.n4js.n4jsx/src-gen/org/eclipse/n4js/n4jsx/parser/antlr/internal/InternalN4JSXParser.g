...
@header {
package org.eclipse.n4js.n4jsx.parser.antlr.internal;
			...
			(
				...
				lv_jsxElementName_1_0=ruleJSXElementName
				{
					...
					set(
						...
						"org.eclipse.n4js.n4jsx.N4JSX.JSXElementName");
					afterParserOrEnumRuleCall();
				}
			)
		)
					...
					(
						...
						lv_jsxChildren_4_0=ruleJSXChild
						{
							...
							add(
								...
								"jsxChildren",
								lv_jsxChildren_4_0,
								"org.eclipse.n4js.n4jsx.N4JSX.JSXChild");
							afterParserOrEnumRuleCall();
						}
					)
				)*
		...
		(
			...
			lv_expression_0_0=ruleJSXElementNameExpression
			{
				...
				set(
					...
					"expression",
					lv_expression_0_0,
					"org.eclipse.n4js.n4jsx.N4JSX.JSXElementNameExpression");
				afterParserOrEnumRuleCall();
			}
		)
	)
		...
		(
			...
			lv_jsxAttributes_0_0=ruleJSXAttribute
			{
				...
				add(
					...
					"org.eclipse.n4js.n4jsx.N4JSX.JSXAttribute");
				afterParserOrEnumRuleCall();
			}
		)
	)*
		...
		(
			...
			lv_bogusTypeRef_0_0=ruleBogusTypeRef
			{
				...
				set(
					...
					"bogusTypeRef",
					lv_bogusTypeRef_0_0,
					"org.eclipse.n4js.ts.TypeExpressions.BogusTypeRef");
				afterParserOrEnumRuleCall();
			}
		)
	)
				...
				(
					...
					lv_targetTypeRef_3_0=ruleTypeRefForCast
					{
						...
						set(
							...
							"org.eclipse.n4js.ts.TypeExpressions.TypeRefForCast");
						afterParserOrEnumRuleCall();
					}
				)
			)
