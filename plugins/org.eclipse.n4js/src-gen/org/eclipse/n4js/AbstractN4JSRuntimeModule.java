...
import org.eclipse.n4js.serializer.N4JSSyntacticSequencer;
...
public abstract class AbstractN4JSRuntimeModule extends DefaultRuntimeModule {
	...
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			// Also register n4ts file extension to {@link FileExtensionProvider} to make find references for primitive
			// work correctly
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS))
					.toInstance("n4js,js,n4jsd,n4ts");
	}
