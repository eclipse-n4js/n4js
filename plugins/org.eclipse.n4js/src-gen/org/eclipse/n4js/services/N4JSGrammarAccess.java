...
public class N4JSGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ScriptElementElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cAmbientModuleDeclarationParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		private final RuleCall cN4NamespaceDeclarationParserRuleCall_3 = (RuleCall)cAlternatives.eContents().get(3);
		private final RuleCall cN4ClassDeclarationParserRuleCall_4 = (RuleCall)cAlternatives.eContents().get(4);
		private final RuleCall cN4InterfaceDeclarationParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		private final RuleCall cN4EnumDeclarationParserRuleCall_6 = (RuleCall)cAlternatives.eContents().get(6);
		private final RuleCall cN4TypeAliasDeclarationParserRuleCall_7 = (RuleCall)cAlternatives.eContents().get(7);
		private final RuleCall cImportDeclarationParserRuleCall_8 = (RuleCall)cAlternatives.eContents().get(8);
		private final RuleCall cDeclareDeclarationParserRuleCall_9 = (RuleCall)cAlternatives.eContents().get(9);
		private final RuleCall cExportDeclarationParserRuleCall_10 = (RuleCall)cAlternatives.eContents().get(10);
		private final RuleCall cRootStatementParserRuleCall_11 = (RuleCall)cAlternatives.eContents().get(11);
		...
		//    | GlobalDeclaration
		//    | => AmbientModuleDeclaration // syntactic predicate required, because "module" is also a valid RootStatement > ExpressionStatement > ... > IdentifierRef
		//    | N4NamespaceDeclaration<Yield=false>
		...
		public RuleCall getAmbientModuleDeclarationParserRuleCall_2() { return cAmbientModuleDeclarationParserRuleCall_2; }
		
		//N4NamespaceDeclaration<Yield=false>
		public RuleCall getN4NamespaceDeclarationParserRuleCall_3() { return cN4NamespaceDeclarationParserRuleCall_3; }
		
		//N4ClassDeclaration<Yield=false>
		public RuleCall getN4ClassDeclarationParserRuleCall_4() { return cN4ClassDeclarationParserRuleCall_4; }
		
		//N4InterfaceDeclaration<Yield=false>
		public RuleCall getN4InterfaceDeclarationParserRuleCall_5() { return cN4InterfaceDeclarationParserRuleCall_5; }
		
		//N4EnumDeclaration<Yield=false>
		public RuleCall getN4EnumDeclarationParserRuleCall_6() { return cN4EnumDeclarationParserRuleCall_6; }
		
		//N4TypeAliasDeclaration<Yield=false>
		public RuleCall getN4TypeAliasDeclarationParserRuleCall_7() { return cN4TypeAliasDeclarationParserRuleCall_7; }
		
		//=> ImportDeclaration
		public RuleCall getImportDeclarationParserRuleCall_8() { return cImportDeclarationParserRuleCall_8; }
		
		//DeclareDeclaration
		public RuleCall getDeclareDeclarationParserRuleCall_9() { return cDeclareDeclarationParserRuleCall_9; }
		
		//ExportDeclaration
		public RuleCall getExportDeclarationParserRuleCall_10() { return cExportDeclarationParserRuleCall_10; }
		
		//RootStatement<Yield=false>
		public RuleCall getRootStatementParserRuleCall_11() { return cRootStatementParserRuleCall_11; }
	}
	public class N4NamespaceDeclarationElements extends AbstractParserRuleElementFinder {
		...
		private final Action cN4NamespaceDeclarationAction_0_0_0 = (Action)cGroup_0_0.eContents().get(0);
...
>>>>>>> 3f5af9ec6 (allow '.'-separated names of namespaces)
		...
		//{N4NamespaceDeclaration}
		public Action getN4NamespaceDeclarationAction_0_0_0() { return cN4NamespaceDeclarationAction_0_0_0; }
...
>>>>>>> 3f5af9ec6 (allow '.'-separated names of namespaces)
		...
		//ownedElementsRaw+=NamespaceElement<Yield>*
		public Assignment getOwnedElementsRawAssignment_2() { return cOwnedElementsRawAssignment_2; }
		
		//NamespaceElement<Yield>
		public RuleCall getOwnedElementsRawNamespaceElementParserRuleCall_2_0() { return cOwnedElementsRawNamespaceElementParserRuleCall_2_0; }
		
		//'}'
		public Keyword getRightCurlyBracketKeyword_3() { return cRightCurlyBracketKeyword_3; }
	}
	public class AmbientModuleDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.AmbientModuleDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cGroup.eContents().get(0);
		private final Group cGroup_0_0 = (Group)cGroup_0.eContents().get(0);
	...
	public class GlobalDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.GlobalDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cGroup.eContents().get(0);
		private final Group cGroup_0_0 = (Group)cGroup_0.eContents().get(0);
		private final Action cGlobalDeclarationAction_0_0_0 = (Action)cGroup_0_0.eContents().get(0);
		private final Keyword cGlobalKeyword_0_0_1 = (Keyword)cGroup_0_0.eContents().get(1);
		private final Keyword cLeftCurlyBracketKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cElementsAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cElementsNamespaceElementParserRuleCall_2_0 = (RuleCall)cElementsAssignment_2.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
		...
		//    )
		//    '{'
		//        elements+=NamespaceElement<Yield=false>*
		//    '}'
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//{GlobalDeclaration}
		public Action getGlobalDeclarationAction_0_0_0() { return cGlobalDeclarationAction_0_0_0; }
		
		//'global'
		public Keyword getGlobalKeyword_0_0_1() { return cGlobalKeyword_0_0_1; }
		...
		//NamespaceElement<Yield=false>
		public RuleCall getElementsNamespaceElementParserRuleCall_2_0() { return cElementsNamespaceElementParserRuleCall_2_0; }
		
		//'}'
		public Keyword getRightCurlyBracketKeyword_3() { return cRightCurlyBracketKeyword_3; }
	}
	public class NamespaceElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.NamespaceElement");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cAnnotatedNamespaceElementParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		...
		//AnnotatedNamespaceElement
		public RuleCall getAnnotatedNamespaceElementParserRuleCall_0() { return cAnnotatedNamespaceElementParserRuleCall_0; }
		
		//N4NamespaceDeclaration<Yield>
		public RuleCall getN4NamespaceDeclarationParserRuleCall_1() { return cN4NamespaceDeclarationParserRuleCall_1; }
		
		//N4ClassDeclaration<Yield>
		public RuleCall getN4ClassDeclarationParserRuleCall_2() { return cN4ClassDeclarationParserRuleCall_2; }
		
		//N4InterfaceDeclaration<Yield>
		public RuleCall getN4InterfaceDeclarationParserRuleCall_3() { return cN4InterfaceDeclarationParserRuleCall_3; }
		
		//N4EnumDeclaration<Yield>
		public RuleCall getN4EnumDeclarationParserRuleCall_4() { return cN4EnumDeclarationParserRuleCall_4; }
	...
	public class AnnotatedScriptElementElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cTypeParametersParserRuleCall_1_3_0_0_5 = (RuleCall)cGroup_1_3_0_0.eContents().get(5);
		...
		private final RuleCall cTypeParametersParserRuleCall_1_3_0_1_5 = (RuleCall)cGroup_1_3_0_1.eContents().get(5);
		...
		private final Assignment cDeclaredTypeRefNodeAssignment_1_5_6 = (Assignment)cGroup_1_5.eContents().get(6);
		private final RuleCall cDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_5_6_0 = (RuleCall)cDeclaredTypeRefNodeAssignment_1_5_6.eContents().get(0);
		...
		//TypeParameters?
		public RuleCall getTypeParametersParserRuleCall_1_3_0_0_5() { return cTypeParametersParserRuleCall_1_3_0_0_5; }
		...
		//TypeParameters?
		public RuleCall getTypeParametersParserRuleCall_1_3_0_1_5() { return cTypeParametersParserRuleCall_1_3_0_1_5; }
		...
		//name=BindingIdentifier<Yield=false>
		public Assignment getNameAssignment_1_5_3() { return cNameAssignment_1_5_3; }
		...
		//declaredTypeRefNode=TypeReferenceNode
		public Assignment getDeclaredTypeRefNodeAssignment_1_5_6() { return cDeclaredTypeRefNodeAssignment_1_5_6; }
		
		//TypeReferenceNode
		public RuleCall getDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_5_6_0() { return cDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_5_6_0; }
	}
	public class AnnotatedNamespaceElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.AnnotatedNamespaceElement");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cAnnotationListParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Alternatives cAlternatives_1 = (Alternatives)cGroup.eContents().get(1);
		private final Group cGroup_1_0 = (Group)cAlternatives_1.eContents().get(0);
		...
		private final Assignment cDeclaredModifiersAssignment_1_0_1_0_0 = (Assignment)cGroup_1_0_1_0.eContents().get(0);
		private final RuleCall cDeclaredModifiersN4ModifierEnumRuleCall_1_0_1_0_0_0 = (RuleCall)cDeclaredModifiersAssignment_1_0_1_0_0.eContents().get(0);
		private final RuleCall cAsyncNoTrailingLineBreakParserRuleCall_1_0_1_0_1 = (RuleCall)cGroup_1_0_1_0.eContents().get(1);
		private final RuleCall cFunctionImplParserRuleCall_1_0_1_0_2 = (RuleCall)cGroup_1_0_1_0.eContents().get(2);
		private final Group cGroup_1_1 = (Group)cAlternatives_1.eContents().get(1);
		...
		private final Action cN4ClassDeclarationAnnotationListAction_1_1_0_0_0 = (Action)cGroup_1_1_0_0.eContents().get(0);
		...
		private final Keyword cClassKeyword_1_1_0_0_2 = (Keyword)cGroup_1_1_0_0.eContents().get(2);
		private final Assignment cTypingStrategyAssignment_1_1_0_0_3 = (Assignment)cGroup_1_1_0_0.eContents().get(3);
		private final RuleCall cTypingStrategyTypingStrategyDefSiteOperatorParserRuleCall_1_1_0_0_3_0 = (RuleCall)cTypingStrategyAssignment_1_1_0_0_3.eContents().get(0);
		private final Assignment cNameAssignment_1_1_0_0_4 = (Assignment)cGroup_1_1_0_0.eContents().get(4);
		private final RuleCall cNameBindingIdentifierParserRuleCall_1_1_0_0_4_0 = (RuleCall)cNameAssignment_1_1_0_0_4.eContents().get(0);
		private final RuleCall cTypeParametersParserRuleCall_1_1_0_0_5 = (RuleCall)cGroup_1_1_0_0.eContents().get(5);
		private final RuleCall cClassExtendsImplementsParserRuleCall_1_1_0_0_6 = (RuleCall)cGroup_1_1_0_0.eContents().get(6);
		private final Group cGroup_1_1_0_1 = (Group)cAlternatives_1_1_0.eContents().get(1);
		private final Action cN4InterfaceDeclarationAnnotationListAction_1_1_0_1_0 = (Action)cGroup_1_1_0_1.eContents().get(0);
		private final Assignment cDeclaredModifiersAssignment_1_1_0_1_1 = (Assignment)cGroup_1_1_0_1.eContents().get(1);
		private final RuleCall cDeclaredModifiersN4ModifierEnumRuleCall_1_1_0_1_1_0 = (RuleCall)cDeclaredModifiersAssignment_1_1_0_1_1.eContents().get(0);
		private final Keyword cInterfaceKeyword_1_1_0_1_2 = (Keyword)cGroup_1_1_0_1.eContents().get(2);
		private final Assignment cTypingStrategyAssignment_1_1_0_1_3 = (Assignment)cGroup_1_1_0_1.eContents().get(3);
		private final RuleCall cTypingStrategyTypingStrategyDefSiteOperatorParserRuleCall_1_1_0_1_3_0 = (RuleCall)cTypingStrategyAssignment_1_1_0_1_3.eContents().get(0);
		private final Assignment cNameAssignment_1_1_0_1_4 = (Assignment)cGroup_1_1_0_1.eContents().get(4);
		private final RuleCall cNameBindingIdentifierParserRuleCall_1_1_0_1_4_0 = (RuleCall)cNameAssignment_1_1_0_1_4.eContents().get(0);
		private final RuleCall cTypeParametersParserRuleCall_1_1_0_1_5 = (RuleCall)cGroup_1_1_0_1.eContents().get(5);
		private final RuleCall cInterfaceExtendsListParserRuleCall_1_1_0_1_6 = (RuleCall)cGroup_1_1_0_1.eContents().get(6);
		private final RuleCall cMembersParserRuleCall_1_1_1 = (RuleCall)cGroup_1_1.eContents().get(1);
		private final Group cGroup_1_2 = (Group)cAlternatives_1.eContents().get(2);
		private final Action cN4EnumDeclarationAnnotationListAction_1_2_0 = (Action)cGroup_1_2.eContents().get(0);
		private final Assignment cDeclaredModifiersAssignment_1_2_1 = (Assignment)cGroup_1_2.eContents().get(1);
		private final RuleCall cDeclaredModifiersN4ModifierEnumRuleCall_1_2_1_0 = (RuleCall)cDeclaredModifiersAssignment_1_2_1.eContents().get(0);
		private final Keyword cEnumKeyword_1_2_2 = (Keyword)cGroup_1_2.eContents().get(2);
		private final Assignment cNameAssignment_1_2_3 = (Assignment)cGroup_1_2.eContents().get(3);
		private final RuleCall cNameBindingIdentifierParserRuleCall_1_2_3_0 = (RuleCall)cNameAssignment_1_2_3.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_1_2_4 = (Keyword)cGroup_1_2.eContents().get(4);
		private final Assignment cLiteralsAssignment_1_2_5 = (Assignment)cGroup_1_2.eContents().get(5);
		private final RuleCall cLiteralsN4EnumLiteralParserRuleCall_1_2_5_0 = (RuleCall)cLiteralsAssignment_1_2_5.eContents().get(0);
		...
		private final RuleCall cDeclaredModifiersN4ModifierWithoutConstEnumRuleCall_1_3_1_0 = (RuleCall)cDeclaredModifiersAssignment_1_3_1.eContents().get(0);
		private final Keyword cTypeKeyword_1_3_2 = (Keyword)cGroup_1_3.eContents().get(2);
		...
		private final RuleCall cTypeParametersParserRuleCall_1_3_4 = (RuleCall)cGroup_1_3.eContents().get(4);
		private final Keyword cEqualsSignKeyword_1_3_5 = (Keyword)cGroup_1_3.eContents().get(5);
		private final Assignment cDeclaredTypeRefNodeAssignment_1_3_6 = (Assignment)cGroup_1_3.eContents().get(6);
		private final RuleCall cDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_3_6_0 = (RuleCall)cDeclaredTypeRefNodeAssignment_1_3_6.eContents().get(0);
		...
		// * The GrammarLinter ensures that the inlined content mirrors the content of the real declarations.
		// */
		//AnnotatedNamespaceElement returns NamespaceElement:
		//    AnnotationList (
		//        {FunctionDeclaration.annotationList=current}
		//        =>((declaredModifiers+=N4Modifier)* AsyncNoTrailingLineBreak
		//            ->FunctionImpl<Yield=false,YieldIfGenerator=false,Expression=false>)
		...
		//(declaredModifiers+=N4Modifier)*
		public Assignment getDeclaredModifiersAssignment_1_0_1_0_0() { return cDeclaredModifiersAssignment_1_0_1_0_0; }
		
		//N4Modifier
		public RuleCall getDeclaredModifiersN4ModifierEnumRuleCall_1_0_1_0_0_0() { return cDeclaredModifiersN4ModifierEnumRuleCall_1_0_1_0_0_0; }
		
		//AsyncNoTrailingLineBreak
		public RuleCall getAsyncNoTrailingLineBreakParserRuleCall_1_0_1_0_1() { return cAsyncNoTrailingLineBreakParserRuleCall_1_0_1_0_1; }
		
		//->FunctionImpl<Yield=false,YieldIfGenerator=false,Expression=false>
		public RuleCall getFunctionImplParserRuleCall_1_0_1_0_2() { return cFunctionImplParserRuleCall_1_0_1_0_2; }
		...
		//{N4ClassDeclaration.annotationList=current}
		public Action getN4ClassDeclarationAnnotationListAction_1_1_0_0_0() { return cN4ClassDeclarationAnnotationListAction_1_1_0_0_0; }
		...
		//'class'
		public Keyword getClassKeyword_1_1_0_0_2() { return cClassKeyword_1_1_0_0_2; }
		
		//typingStrategy=TypingStrategyDefSiteOperator?
		public Assignment getTypingStrategyAssignment_1_1_0_0_3() { return cTypingStrategyAssignment_1_1_0_0_3; }
		
		//TypingStrategyDefSiteOperator
		public RuleCall getTypingStrategyTypingStrategyDefSiteOperatorParserRuleCall_1_1_0_0_3_0() { return cTypingStrategyTypingStrategyDefSiteOperatorParserRuleCall_1_1_0_0_3_0; }
		
		//name=BindingIdentifier<Yield=false>
		public Assignment getNameAssignment_1_1_0_0_4() { return cNameAssignment_1_1_0_0_4; }
		
		//BindingIdentifier<Yield=false>
		public RuleCall getNameBindingIdentifierParserRuleCall_1_1_0_0_4_0() { return cNameBindingIdentifierParserRuleCall_1_1_0_0_4_0; }
		
		//TypeParameters?
		public RuleCall getTypeParametersParserRuleCall_1_1_0_0_5() { return cTypeParametersParserRuleCall_1_1_0_0_5; }
		
		//ClassExtendsImplements<Yield=false>?
		public RuleCall getClassExtendsImplementsParserRuleCall_1_1_0_0_6() { return cClassExtendsImplementsParserRuleCall_1_1_0_0_6; }
		...
		//{N4InterfaceDeclaration.annotationList=current}
		public Action getN4InterfaceDeclarationAnnotationListAction_1_1_0_1_0() { return cN4InterfaceDeclarationAnnotationListAction_1_1_0_1_0; }
		
		//(declaredModifiers+=N4Modifier)*
		public Assignment getDeclaredModifiersAssignment_1_1_0_1_1() { return cDeclaredModifiersAssignment_1_1_0_1_1; }
		
		//N4Modifier
		public RuleCall getDeclaredModifiersN4ModifierEnumRuleCall_1_1_0_1_1_0() { return cDeclaredModifiersN4ModifierEnumRuleCall_1_1_0_1_1_0; }
		
		//'interface'
		public Keyword getInterfaceKeyword_1_1_0_1_2() { return cInterfaceKeyword_1_1_0_1_2; }
		
		//typingStrategy=TypingStrategyDefSiteOperator?
		public Assignment getTypingStrategyAssignment_1_1_0_1_3() { return cTypingStrategyAssignment_1_1_0_1_3; }
		
		//TypingStrategyDefSiteOperator
		public RuleCall getTypingStrategyTypingStrategyDefSiteOperatorParserRuleCall_1_1_0_1_3_0() { return cTypingStrategyTypingStrategyDefSiteOperatorParserRuleCall_1_1_0_1_3_0; }
		
		//name=BindingIdentifier<Yield=false>
		public Assignment getNameAssignment_1_1_0_1_4() { return cNameAssignment_1_1_0_1_4; }
		
		//BindingIdentifier<Yield=false>
		public RuleCall getNameBindingIdentifierParserRuleCall_1_1_0_1_4_0() { return cNameBindingIdentifierParserRuleCall_1_1_0_1_4_0; }
		
		//TypeParameters?
		public RuleCall getTypeParametersParserRuleCall_1_1_0_1_5() { return cTypeParametersParserRuleCall_1_1_0_1_5; }
		
		//InterfaceExtendsList?
		public RuleCall getInterfaceExtendsListParserRuleCall_1_1_0_1_6() { return cInterfaceExtendsListParserRuleCall_1_1_0_1_6; }
		
		//Members<Yield=false>
		public RuleCall getMembersParserRuleCall_1_1_1() { return cMembersParserRuleCall_1_1_1; }
		...
		//{N4EnumDeclaration.annotationList=current}
		public Action getN4EnumDeclarationAnnotationListAction_1_2_0() { return cN4EnumDeclarationAnnotationListAction_1_2_0; }
		
		//(declaredModifiers+=N4Modifier)*
		public Assignment getDeclaredModifiersAssignment_1_2_1() { return cDeclaredModifiersAssignment_1_2_1; }
		
		//N4Modifier
		public RuleCall getDeclaredModifiersN4ModifierEnumRuleCall_1_2_1_0() { return cDeclaredModifiersN4ModifierEnumRuleCall_1_2_1_0; }
		
		//'enum'
		public Keyword getEnumKeyword_1_2_2() { return cEnumKeyword_1_2_2; }
		
		//name=BindingIdentifier<Yield=false>
		public Assignment getNameAssignment_1_2_3() { return cNameAssignment_1_2_3; }
		
		//BindingIdentifier<Yield=false>
		public RuleCall getNameBindingIdentifierParserRuleCall_1_2_3_0() { return cNameBindingIdentifierParserRuleCall_1_2_3_0; }
		
		//'{'
		public Keyword getLeftCurlyBracketKeyword_1_2_4() { return cLeftCurlyBracketKeyword_1_2_4; }
		
		//literals+=N4EnumLiteral
		public Assignment getLiteralsAssignment_1_2_5() { return cLiteralsAssignment_1_2_5; }
		
		//N4EnumLiteral
		public RuleCall getLiteralsN4EnumLiteralParserRuleCall_1_2_5_0() { return cLiteralsN4EnumLiteralParserRuleCall_1_2_5_0; }
		
		//(',' literals+= N4EnumLiteral)*
		public Group getGroup_1_2_6() { return cGroup_1_2_6; }
		
		//','
		public Keyword getCommaKeyword_1_2_6_0() { return cCommaKeyword_1_2_6_0; }
		
		//literals+= N4EnumLiteral
		public Assignment getLiteralsAssignment_1_2_6_1() { return cLiteralsAssignment_1_2_6_1; }
		...
		//{N4TypeAliasDeclaration.annotationList=current}
		public Action getN4TypeAliasDeclarationAnnotationListAction_1_3_0() { return cN4TypeAliasDeclarationAnnotationListAction_1_3_0; }
		
		//(declaredModifiers+=N4ModifierWithoutConst)*
		public Assignment getDeclaredModifiersAssignment_1_3_1() { return cDeclaredModifiersAssignment_1_3_1; }
		
		//N4ModifierWithoutConst
		public RuleCall getDeclaredModifiersN4ModifierWithoutConstEnumRuleCall_1_3_1_0() { return cDeclaredModifiersN4ModifierWithoutConstEnumRuleCall_1_3_1_0; }
		
		//'type'
		public Keyword getTypeKeyword_1_3_2() { return cTypeKeyword_1_3_2; }
		...
		//TypeParameters?
		public RuleCall getTypeParametersParserRuleCall_1_3_4() { return cTypeParametersParserRuleCall_1_3_4; }
		
		//'='
		public Keyword getEqualsSignKeyword_1_3_5() { return cEqualsSignKeyword_1_3_5; }
		
		//declaredTypeRefNode=TypeReferenceNode
		public Assignment getDeclaredTypeRefNodeAssignment_1_3_6() { return cDeclaredTypeRefNodeAssignment_1_3_6; }
		
		//TypeReferenceNode
		public RuleCall getDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_3_6_0() { return cDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_3_6_0; }
	}
	public class DeclareDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.DeclareDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cDeclareKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Alternatives cAlternatives_1 = (Alternatives)cGroup.eContents().get(1);
		private final Group cGroup_1_0 = (Group)cAlternatives_1.eContents().get(0);
		private final Action cExportDeclarationAction_1_0_0 = (Action)cGroup_1_0.eContents().get(0);
		...
		//{ExportDeclaration}
		public Action getExportDeclarationAction_1_0_0() { return cExportDeclarationAction_1_0_0; }
		
		//exportedElement=ExportableElement
		public Assignment getExportedElementAssignment_1_0_1() { return cExportedElementAssignment_1_0_1; }
		
		//ExportableElement
		public RuleCall getExportedElementExportableElementParserRuleCall_1_0_1_0() { return cExportedElementExportableElementParserRuleCall_1_0_1_0; }
	...
	public class ExportDeclarationImplElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cDeclareKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Alternatives cAlternatives_2 = (Alternatives)cGroup.eContents().get(2);
		private final Group cGroup_2_0 = (Group)cAlternatives_2.eContents().get(0);
		private final Assignment cWildcardExportAssignment_2_0_0 = (Assignment)cGroup_2_0.eContents().get(0);
		private final Keyword cWildcardExportAsteriskKeyword_2_0_0_0 = (Keyword)cWildcardExportAssignment_2_0_0.eContents().get(0);
		private final RuleCall cExportFromClauseParserRuleCall_2_0_1 = (RuleCall)cGroup_2_0.eContents().get(1);
		private final RuleCall cSemiParserRuleCall_2_0_2 = (RuleCall)cGroup_2_0.eContents().get(2);
		private final Group cGroup_2_1 = (Group)cAlternatives_2.eContents().get(1);
		private final RuleCall cExportClauseParserRuleCall_2_1_0 = (RuleCall)cGroup_2_1.eContents().get(0);
		private final RuleCall cExportFromClauseParserRuleCall_2_1_1 = (RuleCall)cGroup_2_1.eContents().get(1);
		private final RuleCall cSemiParserRuleCall_2_1_2 = (RuleCall)cGroup_2_1.eContents().get(2);
		private final Assignment cExportedElementAssignment_2_2 = (Assignment)cAlternatives_2.eContents().get(2);
		private final RuleCall cExportedElementExportableElementParserRuleCall_2_2_0 = (RuleCall)cExportedElementAssignment_2_2.eContents().get(0);
		private final Group cGroup_2_3 = (Group)cAlternatives_2.eContents().get(3);
		private final Assignment cDefaultExportAssignment_2_3_0 = (Assignment)cGroup_2_3.eContents().get(0);
		private final Keyword cDefaultExportDefaultKeyword_2_3_0_0 = (Keyword)cDefaultExportAssignment_2_3_0.eContents().get(0);
		private final Alternatives cAlternatives_2_3_1 = (Alternatives)cGroup_2_3.eContents().get(1);
		private final Assignment cExportedElementAssignment_2_3_1_0 = (Assignment)cAlternatives_2_3_1.eContents().get(0);
		private final RuleCall cExportedElementExportableElementParserRuleCall_2_3_1_0_0 = (RuleCall)cExportedElementAssignment_2_3_1_0.eContents().get(0);
		private final Group cGroup_2_3_1_1 = (Group)cAlternatives_2_3_1.eContents().get(1);
		private final Assignment cDefaultExportedExpressionAssignment_2_3_1_1_0 = (Assignment)cGroup_2_3_1_1.eContents().get(0);
		private final RuleCall cDefaultExportedExpressionAssignmentExpressionParserRuleCall_2_3_1_1_0_0 = (RuleCall)cDefaultExportedExpressionAssignment_2_3_1_1_0.eContents().get(0);
		private final RuleCall cSemiParserRuleCall_2_3_1_1_1 = (RuleCall)cGroup_2_3_1_1.eContents().get(1);
		private final Group cGroup_2_4 = (Group)cAlternatives_2.eContents().get(4);
		private final Keyword cEqualsSignKeyword_2_4_0 = (Keyword)cGroup_2_4.eContents().get(0);
		private final RuleCall cIdentifierNameParserRuleCall_2_4_1 = (RuleCall)cGroup_2_4.eContents().get(1);
		private final Group cGroup_2_4_2 = (Group)cGroup_2_4.eContents().get(2);
		private final Keyword cFullStopKeyword_2_4_2_0 = (Keyword)cGroup_2_4_2.eContents().get(0);
		private final RuleCall cIdentifierNameParserRuleCall_2_4_2_1 = (RuleCall)cGroup_2_4_2.eContents().get(1);
		private final RuleCall cSemiParserRuleCall_2_4_3 = (RuleCall)cGroup_2_4.eContents().get(3);
		private final Group cGroup_2_5 = (Group)cAlternatives_2.eContents().get(5);
		private final Keyword cAsKeyword_2_5_0 = (Keyword)cGroup_2_5.eContents().get(0);
		private final Keyword cNamespaceKeyword_2_5_1 = (Keyword)cGroup_2_5.eContents().get(1);
		private final RuleCall cIdentifierNameParserRuleCall_2_5_2 = (RuleCall)cGroup_2_5.eContents().get(2);
		private final RuleCall cSemiParserRuleCall_2_5_3 = (RuleCall)cGroup_2_5.eContents().get(3);
		private final Group cGroup_2_6 = (Group)cAlternatives_2.eContents().get(6);
		private final Keyword cImportKeyword_2_6_0 = (Keyword)cGroup_2_6.eContents().get(0);
		private final RuleCall cIdentifierNameParserRuleCall_2_6_1 = (RuleCall)cGroup_2_6.eContents().get(1);
		private final Keyword cEqualsSignKeyword_2_6_2 = (Keyword)cGroup_2_6.eContents().get(2);
		private final Assignment cDefaultExportedExpressionAssignment_2_6_3 = (Assignment)cGroup_2_6.eContents().get(3);
		private final RuleCall cDefaultExportedExpressionAssignmentExpressionParserRuleCall_2_6_3_0 = (RuleCall)cDefaultExportedExpressionAssignment_2_6_3.eContents().get(0);
		private final RuleCall cSemiParserRuleCall_2_6_4 = (RuleCall)cGroup_2_6.eContents().get(4);
		
		//fragment ExportDeclarationImpl *:
		//    'export'
		//    'declare'? // only allowed in DTS
		//    (
		...
		//'declare'?
		public Keyword getDeclareKeyword_1() { return cDeclareKeyword_1; }
		...
		//wildcardExport?='*'
		public Assignment getWildcardExportAssignment_2_0_0() { return cWildcardExportAssignment_2_0_0; }
		
		//'*'
		public Keyword getWildcardExportAsteriskKeyword_2_0_0_0() { return cWildcardExportAsteriskKeyword_2_0_0_0; }
		
		//ExportFromClause
		public RuleCall getExportFromClauseParserRuleCall_2_0_1() { return cExportFromClauseParserRuleCall_2_0_1; }
		...
		//ExportClause
		public RuleCall getExportClauseParserRuleCall_2_1_0() { return cExportClauseParserRuleCall_2_1_0; }
		
		//->ExportFromClause?
		public RuleCall getExportFromClauseParserRuleCall_2_1_1() { return cExportFromClauseParserRuleCall_2_1_1; }
		
		//Semi
		public RuleCall getSemiParserRuleCall_2_1_2() { return cSemiParserRuleCall_2_1_2; }
		
		//exportedElement=ExportableElement
		public Assignment getExportedElementAssignment_2_2() { return cExportedElementAssignment_2_2; }
		
		//ExportableElement
		public RuleCall getExportedElementExportableElementParserRuleCall_2_2_0() { return cExportedElementExportableElementParserRuleCall_2_2_0; }
		
		//defaultExport?='default' (->exportedElement=ExportableElement | defaultExportedExpression=AssignmentExpression<In=true,Yield=false> Semi)
		public Group getGroup_2_3() { return cGroup_2_3; }
		
		//defaultExport?='default'
		public Assignment getDefaultExportAssignment_2_3_0() { return cDefaultExportAssignment_2_3_0; }
		
		//'default'
		public Keyword getDefaultExportDefaultKeyword_2_3_0_0() { return cDefaultExportDefaultKeyword_2_3_0_0; }
		...
		//->exportedElement=ExportableElement
		public Assignment getExportedElementAssignment_2_3_1_0() { return cExportedElementAssignment_2_3_1_0; }
		
		//ExportableElement
		public RuleCall getExportedElementExportableElementParserRuleCall_2_3_1_0_0() { return cExportedElementExportableElementParserRuleCall_2_3_1_0_0; }
		...
		public Assignment getDefaultExportedExpressionAssignment_2_3_1_1_0() { return cDefaultExportedExpressionAssignment_2_3_1_1_0; }
		
		//AssignmentExpression<In=true,Yield=false>
		public RuleCall getDefaultExportedExpressionAssignmentExpressionParserRuleCall_2_3_1_1_0_0() { return cDefaultExportedExpressionAssignmentExpressionParserRuleCall_2_3_1_1_0_0; }
		
		//Semi
		public RuleCall getSemiParserRuleCall_2_3_1_1_1() { return cSemiParserRuleCall_2_3_1_1_1; }
		
		//'=' IdentifierName ('.' IdentifierName)* Semi
		public Group getGroup_2_4() { return cGroup_2_4; }
		
		//'='
		public Keyword getEqualsSignKeyword_2_4_0() { return cEqualsSignKeyword_2_4_0; }
		
		//IdentifierName
		public RuleCall getIdentifierNameParserRuleCall_2_4_1() { return cIdentifierNameParserRuleCall_2_4_1; }
		
		//('.' IdentifierName)*
		public Group getGroup_2_4_2() { return cGroup_2_4_2; }
		
		//'.'
		public Keyword getFullStopKeyword_2_4_2_0() { return cFullStopKeyword_2_4_2_0; }
		
		//IdentifierName
		public RuleCall getIdentifierNameParserRuleCall_2_4_2_1() { return cIdentifierNameParserRuleCall_2_4_2_1; }
		
		//Semi
		public RuleCall getSemiParserRuleCall_2_4_3() { return cSemiParserRuleCall_2_4_3; }
		
		//'as' 'namespace' IdentifierName Semi
		public Group getGroup_2_5() { return cGroup_2_5; }
		
		//'as'
		public Keyword getAsKeyword_2_5_0() { return cAsKeyword_2_5_0; }
		
		//'namespace'
		public Keyword getNamespaceKeyword_2_5_1() { return cNamespaceKeyword_2_5_1; }
		
		//IdentifierName
		public RuleCall getIdentifierNameParserRuleCall_2_5_2() { return cIdentifierNameParserRuleCall_2_5_2; }
		
		//Semi
		public RuleCall getSemiParserRuleCall_2_5_3() { return cSemiParserRuleCall_2_5_3; }
		
		//'import' IdentifierName '=' defaultExportedExpression=AssignmentExpression<In=true,Yield=false> Semi
		public Group getGroup_2_6() { return cGroup_2_6; }
		
		//'import'
		public Keyword getImportKeyword_2_6_0() { return cImportKeyword_2_6_0; }
		
		//IdentifierName
		public RuleCall getIdentifierNameParserRuleCall_2_6_1() { return cIdentifierNameParserRuleCall_2_6_1; }
		
		//'='
		public Keyword getEqualsSignKeyword_2_6_2() { return cEqualsSignKeyword_2_6_2; }
		
		//defaultExportedExpression=AssignmentExpression<In=true,Yield=false>
		public Assignment getDefaultExportedExpressionAssignment_2_6_3() { return cDefaultExportedExpressionAssignment_2_6_3; }
		
		//AssignmentExpression<In=true,Yield=false>
		public RuleCall getDefaultExportedExpressionAssignmentExpressionParserRuleCall_2_6_3_0() { return cDefaultExportedExpressionAssignmentExpressionParserRuleCall_2_6_3_0; }
		
		//Semi
		public RuleCall getSemiParserRuleCall_2_6_4() { return cSemiParserRuleCall_2_6_4; }
	}
	...
	public class AnnotatedExportableElementElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cDeclaredTypeRefNodeAssignment_1_4_6 = (Assignment)cGroup_1_4.eContents().get(6);
		private final RuleCall cDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_4_6_0 = (RuleCall)cDeclaredTypeRefNodeAssignment_1_4_6.eContents().get(0);
		...
		//declaredTypeRefNode=TypeReferenceNode
		public Assignment getDeclaredTypeRefNodeAssignment_1_4_6() { return cDeclaredTypeRefNodeAssignment_1_4_6; }
		
		//TypeReferenceNode
		public RuleCall getDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_4_6_0() { return cDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_4_6_0; }
	}
	...
	public class NamedImportSpecifierElements extends AbstractParserRuleElementFinder {
		...
		//    |    importedElement=[types::TExportableElement|IdentifierName] 'as' alias=BindingIdentifier<Yield=false> (declaredDynamic?='+')?
		//;
		@Override public ParserRule getRule() { return rule; }
	...
	public class FunctionImplElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cFunctionImplWithoutKeywordParserRuleCall_1 = (RuleCall)cGroup.eContents().get(1);
		...
		//FunctionImplWithoutKeyword<Yield, YieldIfGenerator, Expression>
		public RuleCall getFunctionImplWithoutKeywordParserRuleCall_1() { return cFunctionImplWithoutKeywordParserRuleCall_1; }
	}
	public class FunctionImplWithoutKeywordElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.FunctionImplWithoutKeyword");
	...
	public class FunctionHeaderElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cNameBindingIdentifierParserRuleCall_0_0 = (RuleCall)cNameAssignment_0.eContents().get(0);
		...
		private final RuleCall cColonSepDeclaredReturnTypeRefParserRuleCall_3 = (RuleCall)cGroup.eContents().get(3);
		
		//fragment FunctionHeader<Yield, Generator>*:
		//    name=BindingIdentifier<Yield>?
		//    TypeParameters?
		//    StrictFormalParameters<Yield=Generator>
		//    (-> ColonSepDeclaredReturnTypeRef<Yield=Generator>)?
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//BindingIdentifier<Yield>
		public RuleCall getNameBindingIdentifierParserRuleCall_0_0() { return cNameBindingIdentifierParserRuleCall_0_0; }
		...
		//(-> ColonSepDeclaredReturnTypeRef<Yield=Generator>)?
		public RuleCall getColonSepDeclaredReturnTypeRefParserRuleCall_3() { return cColonSepDeclaredReturnTypeRefParserRuleCall_3; }
	}
	...
	public class ArrowExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cColonSepDeclaredReturnTypeRefParserRuleCall_0_0_0_0_1 = (RuleCall)cGroup_0_0_0_0.eContents().get(1);
		...
		//                    StrictFormalParameters<Yield> ColonSepDeclaredReturnTypeRef<Yield>?
		//                |    =>(declaredAsync?='async' NoLineTerminator ->StrictFormalParameters<Yield>) ColonSepDeclaredReturnTypeRef<Yield>?
		...
		//ColonSepDeclaredReturnTypeRef<Yield>?
		public RuleCall getColonSepDeclaredReturnTypeRefParserRuleCall_0_0_0_0_1() { return cColonSepDeclaredReturnTypeRefParserRuleCall_0_0_0_0_1; }
		...
		//ColonSepDeclaredReturnTypeRef<Yield>?
		public RuleCall getColonSepDeclaredReturnTypeRefParserRuleCall_0_0_0_1_1() { return cColonSepDeclaredReturnTypeRefParserRuleCall_0_0_0_1_1; }
	...
	public class N4TypeVariableElements extends AbstractParserRuleElementFinder {
		...
		//('extends' declaredUpperBoundNode=TypeReferenceNode)?
		...
		public Assignment getDeclaredUpperBoundNodeAssignment_2_1() { return cDeclaredUpperBoundNodeAssignment_2_1; }
	...
	public class BindingElementFragmentElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cVariadicAssignment_0_1_1 = (Assignment)cGroup_0_1.eContents().get(1);
		...
		//variadic?='...'?
		public Assignment getVariadicAssignment_0_1_1() { return cVariadicAssignment_0_1_1; }
		
		//'...'
		public Keyword getVariadicFullStopFullStopFullStopKeyword_0_1_1_0() { return cVariadicFullStopFullStopFullStopKeyword_0_1_1_0; }
	...
	public class ForStatementElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cAwaitAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final Keyword cAwaitAwaitKeyword_2_0 = (Keyword)cAwaitAssignment_2.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Alternatives cAlternatives_4 = (Alternatives)cGroup.eContents().get(4);
		private final Group cGroup_4_0 = (Group)cAlternatives_4.eContents().get(0);
		private final Group cGroup_4_0_0 = (Group)cGroup_4_0.eContents().get(0);
		private final Assignment cInitExprAssignment_4_0_0_0 = (Assignment)cGroup_4_0_0.eContents().get(0);
		private final RuleCall cInitExprLetIdentifierRefParserRuleCall_4_0_0_0_0 = (RuleCall)cInitExprAssignment_4_0_0_0.eContents().get(0);
		private final Assignment cForInAssignment_4_0_0_1 = (Assignment)cGroup_4_0_0.eContents().get(1);
		private final Keyword cForInInKeyword_4_0_0_1_0 = (Keyword)cForInAssignment_4_0_0_1.eContents().get(0);
		...
		private final Keyword cRightParenthesisKeyword_4_0_0_3 = (Keyword)cGroup_4_0_0.eContents().get(3);
		...
		private final Assignment cVarStmtKeywordAssignment_4_1_0_0_0 = (Assignment)cGroup_4_1_0_0.eContents().get(0);
		private final RuleCall cVarStmtKeywordVariableStatementKeywordEnumRuleCall_4_1_0_0_0_0 = (RuleCall)cVarStmtKeywordAssignment_4_1_0_0_0.eContents().get(0);
		private final Alternatives cAlternatives_4_1_0_0_1 = (Alternatives)cGroup_4_1_0_0.eContents().get(1);
		private final Group cGroup_4_1_0_0_1_0 = (Group)cAlternatives_4_1_0_0_1.eContents().get(0);
		private final Group cGroup_4_1_0_0_1_0_0 = (Group)cGroup_4_1_0_0_1_0.eContents().get(0);
		private final Assignment cVarDeclsOrBindingsAssignment_4_1_0_0_1_0_0_0 = (Assignment)cGroup_4_1_0_0_1_0_0.eContents().get(0);
		private final RuleCall cVarDeclsOrBindingsBindingIdentifierAsVariableDeclarationParserRuleCall_4_1_0_0_1_0_0_0_0 = (RuleCall)cVarDeclsOrBindingsAssignment_4_1_0_0_1_0_0_0.eContents().get(0);
		private final Alternatives cAlternatives_4_1_0_0_1_0_0_1 = (Alternatives)cGroup_4_1_0_0_1_0_0.eContents().get(1);
		private final Assignment cForInAssignment_4_1_0_0_1_0_0_1_0 = (Assignment)cAlternatives_4_1_0_0_1_0_0_1.eContents().get(0);
		private final Keyword cForInInKeyword_4_1_0_0_1_0_0_1_0_0 = (Keyword)cForInAssignment_4_1_0_0_1_0_0_1_0.eContents().get(0);
		private final Assignment cForOfAssignment_4_1_0_0_1_0_0_1_1 = (Assignment)cAlternatives_4_1_0_0_1_0_0_1.eContents().get(1);
		private final Keyword cForOfOfKeyword_4_1_0_0_1_0_0_1_1_0 = (Keyword)cForOfAssignment_4_1_0_0_1_0_0_1_1.eContents().get(0);
		private final Assignment cExpressionAssignment_4_1_0_0_1_0_0_2 = (Assignment)cGroup_4_1_0_0_1_0_0.eContents().get(2);
		private final RuleCall cExpressionAssignmentExpressionParserRuleCall_4_1_0_0_1_0_0_2_0 = (RuleCall)cExpressionAssignment_4_1_0_0_1_0_0_2.eContents().get(0);
		private final Group cGroup_4_1_0_0_1_1 = (Group)cAlternatives_4_1_0_0_1.eContents().get(1);
		private final Assignment cVarDeclsOrBindingsAssignment_4_1_0_0_1_1_0 = (Assignment)cGroup_4_1_0_0_1_1.eContents().get(0);
		private final RuleCall cVarDeclsOrBindingsVariableDeclarationOrBindingParserRuleCall_4_1_0_0_1_1_0_0 = (RuleCall)cVarDeclsOrBindingsAssignment_4_1_0_0_1_1_0.eContents().get(0);
		private final Alternatives cAlternatives_4_1_0_0_1_1_1 = (Alternatives)cGroup_4_1_0_0_1_1.eContents().get(1);
		private final Group cGroup_4_1_0_0_1_1_1_0 = (Group)cAlternatives_4_1_0_0_1_1_1.eContents().get(0);
		private final Group cGroup_4_1_0_0_1_1_1_0_0 = (Group)cGroup_4_1_0_0_1_1_1_0.eContents().get(0);
		private final Keyword cCommaKeyword_4_1_0_0_1_1_1_0_0_0 = (Keyword)cGroup_4_1_0_0_1_1_1_0_0.eContents().get(0);
		private final Assignment cVarDeclsOrBindingsAssignment_4_1_0_0_1_1_1_0_0_1 = (Assignment)cGroup_4_1_0_0_1_1_1_0_0.eContents().get(1);
		private final RuleCall cVarDeclsOrBindingsVariableDeclarationOrBindingParserRuleCall_4_1_0_0_1_1_1_0_0_1_0 = (RuleCall)cVarDeclsOrBindingsAssignment_4_1_0_0_1_1_1_0_0_1.eContents().get(0);
		private final Keyword cSemicolonKeyword_4_1_0_0_1_1_1_0_1 = (Keyword)cGroup_4_1_0_0_1_1_1_0.eContents().get(1);
		private final Assignment cExpressionAssignment_4_1_0_0_1_1_1_0_2 = (Assignment)cGroup_4_1_0_0_1_1_1_0.eContents().get(2);
		private final RuleCall cExpressionExpressionParserRuleCall_4_1_0_0_1_1_1_0_2_0 = (RuleCall)cExpressionAssignment_4_1_0_0_1_1_1_0_2.eContents().get(0);
		private final Keyword cSemicolonKeyword_4_1_0_0_1_1_1_0_3 = (Keyword)cGroup_4_1_0_0_1_1_1_0.eContents().get(3);
		private final Assignment cUpdateExprAssignment_4_1_0_0_1_1_1_0_4 = (Assignment)cGroup_4_1_0_0_1_1_1_0.eContents().get(4);
		private final RuleCall cUpdateExprExpressionParserRuleCall_4_1_0_0_1_1_1_0_4_0 = (RuleCall)cUpdateExprAssignment_4_1_0_0_1_1_1_0_4.eContents().get(0);
		private final Group cGroup_4_1_0_0_1_1_1_1 = (Group)cAlternatives_4_1_0_0_1_1_1.eContents().get(1);
		private final Assignment cForInAssignment_4_1_0_0_1_1_1_1_0 = (Assignment)cGroup_4_1_0_0_1_1_1_1.eContents().get(0);
		private final Keyword cForInInKeyword_4_1_0_0_1_1_1_1_0_0 = (Keyword)cForInAssignment_4_1_0_0_1_1_1_1_0.eContents().get(0);
		private final Assignment cExpressionAssignment_4_1_0_0_1_1_1_1_1 = (Assignment)cGroup_4_1_0_0_1_1_1_1.eContents().get(1);
		private final RuleCall cExpressionExpressionParserRuleCall_4_1_0_0_1_1_1_1_1_0 = (RuleCall)cExpressionAssignment_4_1_0_0_1_1_1_1_1.eContents().get(0);
		private final Group cGroup_4_1_0_0_1_1_1_2 = (Group)cAlternatives_4_1_0_0_1_1_1.eContents().get(2);
		private final Assignment cForOfAssignment_4_1_0_0_1_1_1_2_0 = (Assignment)cGroup_4_1_0_0_1_1_1_2.eContents().get(0);
		private final Keyword cForOfOfKeyword_4_1_0_0_1_1_1_2_0_0 = (Keyword)cForOfAssignment_4_1_0_0_1_1_1_2_0.eContents().get(0);
		private final Assignment cExpressionAssignment_4_1_0_0_1_1_1_2_1 = (Assignment)cGroup_4_1_0_0_1_1_1_2.eContents().get(1);
		private final RuleCall cExpressionAssignmentExpressionParserRuleCall_4_1_0_0_1_1_1_2_1_0 = (RuleCall)cExpressionAssignment_4_1_0_0_1_1_1_2_1.eContents().get(0);
		private final Group cGroup_4_1_0_1 = (Group)cAlternatives_4_1_0.eContents().get(1);
		private final Assignment cInitExprAssignment_4_1_0_1_0 = (Assignment)cGroup_4_1_0_1.eContents().get(0);
		private final RuleCall cInitExprExpressionParserRuleCall_4_1_0_1_0_0 = (RuleCall)cInitExprAssignment_4_1_0_1_0.eContents().get(0);
		private final Alternatives cAlternatives_4_1_0_1_1 = (Alternatives)cGroup_4_1_0_1.eContents().get(1);
		private final Group cGroup_4_1_0_1_1_0 = (Group)cAlternatives_4_1_0_1_1.eContents().get(0);
		private final Keyword cSemicolonKeyword_4_1_0_1_1_0_0 = (Keyword)cGroup_4_1_0_1_1_0.eContents().get(0);
		private final Assignment cExpressionAssignment_4_1_0_1_1_0_1 = (Assignment)cGroup_4_1_0_1_1_0.eContents().get(1);
		private final RuleCall cExpressionExpressionParserRuleCall_4_1_0_1_1_0_1_0 = (RuleCall)cExpressionAssignment_4_1_0_1_1_0_1.eContents().get(0);
		private final Keyword cSemicolonKeyword_4_1_0_1_1_0_2 = (Keyword)cGroup_4_1_0_1_1_0.eContents().get(2);
		private final Assignment cUpdateExprAssignment_4_1_0_1_1_0_3 = (Assignment)cGroup_4_1_0_1_1_0.eContents().get(3);
		private final RuleCall cUpdateExprExpressionParserRuleCall_4_1_0_1_1_0_3_0 = (RuleCall)cUpdateExprAssignment_4_1_0_1_1_0_3.eContents().get(0);
		private final Group cGroup_4_1_0_1_1_1 = (Group)cAlternatives_4_1_0_1_1.eContents().get(1);
		private final Assignment cForInAssignment_4_1_0_1_1_1_0 = (Assignment)cGroup_4_1_0_1_1_1.eContents().get(0);
		private final Keyword cForInInKeyword_4_1_0_1_1_1_0_0 = (Keyword)cForInAssignment_4_1_0_1_1_1_0.eContents().get(0);
		private final Assignment cExpressionAssignment_4_1_0_1_1_1_1 = (Assignment)cGroup_4_1_0_1_1_1.eContents().get(1);
		private final RuleCall cExpressionExpressionParserRuleCall_4_1_0_1_1_1_1_0 = (RuleCall)cExpressionAssignment_4_1_0_1_1_1_1.eContents().get(0);
		private final Group cGroup_4_1_0_1_1_2 = (Group)cAlternatives_4_1_0_1_1.eContents().get(2);
		private final Assignment cForOfAssignment_4_1_0_1_1_2_0 = (Assignment)cGroup_4_1_0_1_1_2.eContents().get(0);
		private final Keyword cForOfOfKeyword_4_1_0_1_1_2_0_0 = (Keyword)cForOfAssignment_4_1_0_1_1_2_0.eContents().get(0);
		private final Assignment cExpressionAssignment_4_1_0_1_1_2_1 = (Assignment)cGroup_4_1_0_1_1_2.eContents().get(1);
		private final RuleCall cExpressionAssignmentExpressionParserRuleCall_4_1_0_1_1_2_1_0 = (RuleCall)cExpressionAssignment_4_1_0_1_1_2_1.eContents().get(0);
		private final Group cGroup_4_1_0_2 = (Group)cAlternatives_4_1_0.eContents().get(2);
		private final Keyword cSemicolonKeyword_4_1_0_2_0 = (Keyword)cGroup_4_1_0_2.eContents().get(0);
		private final Assignment cExpressionAssignment_4_1_0_2_1 = (Assignment)cGroup_4_1_0_2.eContents().get(1);
		private final RuleCall cExpressionExpressionParserRuleCall_4_1_0_2_1_0 = (RuleCall)cExpressionAssignment_4_1_0_2_1.eContents().get(0);
		private final Keyword cSemicolonKeyword_4_1_0_2_2 = (Keyword)cGroup_4_1_0_2.eContents().get(2);
		private final Assignment cUpdateExprAssignment_4_1_0_2_3 = (Assignment)cGroup_4_1_0_2.eContents().get(3);
		private final RuleCall cUpdateExprExpressionParserRuleCall_4_1_0_2_3_0 = (RuleCall)cUpdateExprAssignment_4_1_0_2_3.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_4_1_1 = (Keyword)cGroup_4_1.eContents().get(1);
		...
		//(await?='await')?
		public Assignment getAwaitAssignment_2() { return cAwaitAssignment_2; }
		
		//'await'
		public Keyword getAwaitAwaitKeyword_2_0() { return cAwaitAwaitKeyword_2_0; }
		...
		public Assignment getInitExprAssignment_4_0_0_0() { return cInitExprAssignment_4_0_0_0; }
		
		//LetIdentifierRef
		public RuleCall getInitExprLetIdentifierRefParserRuleCall_4_0_0_0_0() { return cInitExprLetIdentifierRefParserRuleCall_4_0_0_0_0; }
		
		//forIn?='in'
		public Assignment getForInAssignment_4_0_0_1() { return cForInAssignment_4_0_0_1; }
		
		//'in'
		public Keyword getForInInKeyword_4_0_0_1_0() { return cForInInKeyword_4_0_0_1_0; }
		...
		//')'
		public Keyword getRightParenthesisKeyword_4_0_0_3() { return cRightParenthesisKeyword_4_0_0_3; }
		...
		//->varStmtKeyword=VariableStatementKeyword
		public Assignment getVarStmtKeywordAssignment_4_1_0_0_0() { return cVarStmtKeywordAssignment_4_1_0_0_0; }
		
		//VariableStatementKeyword
		public RuleCall getVarStmtKeywordVariableStatementKeywordEnumRuleCall_4_1_0_0_0_0() { return cVarStmtKeywordVariableStatementKeywordEnumRuleCall_4_1_0_0_0_0; }
		...
		//        )
		//)
		public Alternatives getAlternatives_4_1_0_0_1() { return cAlternatives_4_1_0_0_1; }
		
		//=>(varDeclsOrBindings+=BindingIdentifierAsVariableDeclaration<In=false,Yield> (forIn?='in' | forOf?='of') ->expression=AssignmentExpression<In=true,Yield>?)
		public Group getGroup_4_1_0_0_1_0() { return cGroup_4_1_0_0_1_0; }
		
		//varDeclsOrBindings+=BindingIdentifierAsVariableDeclaration<In=false,Yield> (forIn?='in' | forOf?='of') ->expression=AssignmentExpression<In=true,Yield>?
		public Group getGroup_4_1_0_0_1_0_0() { return cGroup_4_1_0_0_1_0_0; }
		
		//varDeclsOrBindings+=BindingIdentifierAsVariableDeclaration<In=false,Yield>
		public Assignment getVarDeclsOrBindingsAssignment_4_1_0_0_1_0_0_0() { return cVarDeclsOrBindingsAssignment_4_1_0_0_1_0_0_0; }
		
		//BindingIdentifierAsVariableDeclaration<In=false,Yield>
		public RuleCall getVarDeclsOrBindingsBindingIdentifierAsVariableDeclarationParserRuleCall_4_1_0_0_1_0_0_0_0() { return cVarDeclsOrBindingsBindingIdentifierAsVariableDeclarationParserRuleCall_4_1_0_0_1_0_0_0_0; }
		
		//(forIn?='in' | forOf?='of')
		public Alternatives getAlternatives_4_1_0_0_1_0_0_1() { return cAlternatives_4_1_0_0_1_0_0_1; }
		
		//forIn?='in'
		public Assignment getForInAssignment_4_1_0_0_1_0_0_1_0() { return cForInAssignment_4_1_0_0_1_0_0_1_0; }
		
		//'in'
		public Keyword getForInInKeyword_4_1_0_0_1_0_0_1_0_0() { return cForInInKeyword_4_1_0_0_1_0_0_1_0_0; }
		
		//forOf?='of'
		public Assignment getForOfAssignment_4_1_0_0_1_0_0_1_1() { return cForOfAssignment_4_1_0_0_1_0_0_1_1; }
		
		//'of'
		public Keyword getForOfOfKeyword_4_1_0_0_1_0_0_1_1_0() { return cForOfOfKeyword_4_1_0_0_1_0_0_1_1_0; }
		
		//->expression=AssignmentExpression<In=true,Yield>?
		public Assignment getExpressionAssignment_4_1_0_0_1_0_0_2() { return cExpressionAssignment_4_1_0_0_1_0_0_2; }
		
		//AssignmentExpression<In=true,Yield>
		public RuleCall getExpressionAssignmentExpressionParserRuleCall_4_1_0_0_1_0_0_2_0() { return cExpressionAssignmentExpressionParserRuleCall_4_1_0_0_1_0_0_2_0; }
		...
		//                        |     forOf?='of' expression=AssignmentExpression<In=true,Yield>?
		//                    )
		public Group getGroup_4_1_0_0_1_1() { return cGroup_4_1_0_0_1_1; }
		
		//varDeclsOrBindings+=VariableDeclarationOrBinding<In=false,Yield,OptionalInit=true>
		public Assignment getVarDeclsOrBindingsAssignment_4_1_0_0_1_1_0() { return cVarDeclsOrBindingsAssignment_4_1_0_0_1_1_0; }
		
		//VariableDeclarationOrBinding<In=false,Yield,OptionalInit=true>
		public RuleCall getVarDeclsOrBindingsVariableDeclarationOrBindingParserRuleCall_4_1_0_0_1_1_0_0() { return cVarDeclsOrBindingsVariableDeclarationOrBindingParserRuleCall_4_1_0_0_1_1_0_0; }
		...
		//    |     forOf?='of' expression=AssignmentExpression<In=true,Yield>?
		//)
		public Alternatives getAlternatives_4_1_0_0_1_1_1() { return cAlternatives_4_1_0_0_1_1_1; }
		
		//(',' varDeclsOrBindings+=VariableDeclarationOrBinding<In=false,Yield,false>)* ';' expression=Expression<In=true,Yield>? ';' updateExpr=Expression<In=true,Yield>?
		public Group getGroup_4_1_0_0_1_1_1_0() { return cGroup_4_1_0_0_1_1_1_0; }
		
		//(',' varDeclsOrBindings+=VariableDeclarationOrBinding<In=false,Yield,false>)*
		public Group getGroup_4_1_0_0_1_1_1_0_0() { return cGroup_4_1_0_0_1_1_1_0_0; }
		
		//','
		public Keyword getCommaKeyword_4_1_0_0_1_1_1_0_0_0() { return cCommaKeyword_4_1_0_0_1_1_1_0_0_0; }
		
		//varDeclsOrBindings+=VariableDeclarationOrBinding<In=false,Yield,false>
		public Assignment getVarDeclsOrBindingsAssignment_4_1_0_0_1_1_1_0_0_1() { return cVarDeclsOrBindingsAssignment_4_1_0_0_1_1_1_0_0_1; }
		
		//VariableDeclarationOrBinding<In=false,Yield,false>
		public RuleCall getVarDeclsOrBindingsVariableDeclarationOrBindingParserRuleCall_4_1_0_0_1_1_1_0_0_1_0() { return cVarDeclsOrBindingsVariableDeclarationOrBindingParserRuleCall_4_1_0_0_1_1_1_0_0_1_0; }
		
		//';'
		public Keyword getSemicolonKeyword_4_1_0_0_1_1_1_0_1() { return cSemicolonKeyword_4_1_0_0_1_1_1_0_1; }
		
		//expression=Expression<In=true,Yield>?
		public Assignment getExpressionAssignment_4_1_0_0_1_1_1_0_2() { return cExpressionAssignment_4_1_0_0_1_1_1_0_2; }
		
		//Expression<In=true,Yield>
		public RuleCall getExpressionExpressionParserRuleCall_4_1_0_0_1_1_1_0_2_0() { return cExpressionExpressionParserRuleCall_4_1_0_0_1_1_1_0_2_0; }
		
		//';'
		public Keyword getSemicolonKeyword_4_1_0_0_1_1_1_0_3() { return cSemicolonKeyword_4_1_0_0_1_1_1_0_3; }
		
		//updateExpr=Expression<In=true,Yield>?
		public Assignment getUpdateExprAssignment_4_1_0_0_1_1_1_0_4() { return cUpdateExprAssignment_4_1_0_0_1_1_1_0_4; }
		
		//Expression<In=true,Yield>
		public RuleCall getUpdateExprExpressionParserRuleCall_4_1_0_0_1_1_1_0_4_0() { return cUpdateExprExpressionParserRuleCall_4_1_0_0_1_1_1_0_4_0; }
		
		//forIn?='in' expression=Expression<In=true,Yield>?
		public Group getGroup_4_1_0_0_1_1_1_1() { return cGroup_4_1_0_0_1_1_1_1; }
		
		//forIn?='in'
		public Assignment getForInAssignment_4_1_0_0_1_1_1_1_0() { return cForInAssignment_4_1_0_0_1_1_1_1_0; }
		
		//'in'
		public Keyword getForInInKeyword_4_1_0_0_1_1_1_1_0_0() { return cForInInKeyword_4_1_0_0_1_1_1_1_0_0; }
		
		//expression=Expression<In=true,Yield>?
		public Assignment getExpressionAssignment_4_1_0_0_1_1_1_1_1() { return cExpressionAssignment_4_1_0_0_1_1_1_1_1; }
		
		//Expression<In=true,Yield>
		public RuleCall getExpressionExpressionParserRuleCall_4_1_0_0_1_1_1_1_1_0() { return cExpressionExpressionParserRuleCall_4_1_0_0_1_1_1_1_1_0; }
		
		//forOf?='of' expression=AssignmentExpression<In=true,Yield>?
		public Group getGroup_4_1_0_0_1_1_1_2() { return cGroup_4_1_0_0_1_1_1_2; }
		
		//forOf?='of'
		public Assignment getForOfAssignment_4_1_0_0_1_1_1_2_0() { return cForOfAssignment_4_1_0_0_1_1_1_2_0; }
		
		//'of'
		public Keyword getForOfOfKeyword_4_1_0_0_1_1_1_2_0_0() { return cForOfOfKeyword_4_1_0_0_1_1_1_2_0_0; }
		
		//expression=AssignmentExpression<In=true,Yield>?
		public Assignment getExpressionAssignment_4_1_0_0_1_1_1_2_1() { return cExpressionAssignment_4_1_0_0_1_1_1_2_1; }
		
		//AssignmentExpression<In=true,Yield>
		public RuleCall getExpressionAssignmentExpressionParserRuleCall_4_1_0_0_1_1_1_2_1_0() { return cExpressionAssignmentExpressionParserRuleCall_4_1_0_0_1_1_1_2_1_0; }
		...
		//initExpr=Expression<In=false,Yield>
		public Assignment getInitExprAssignment_4_1_0_1_0() { return cInitExprAssignment_4_1_0_1_0; }
		
		//Expression<In=false,Yield>
		public RuleCall getInitExprExpressionParserRuleCall_4_1_0_1_0_0() { return cInitExprExpressionParserRuleCall_4_1_0_1_0_0; }
		...
		//    |     forOf?='of' expression=AssignmentExpression<In=true,Yield>?
		//)
		public Alternatives getAlternatives_4_1_0_1_1() { return cAlternatives_4_1_0_1_1; }
		
		//';' expression=Expression<In=true,Yield>? ';' updateExpr=Expression<In=true,Yield>?
		public Group getGroup_4_1_0_1_1_0() { return cGroup_4_1_0_1_1_0; }
		
		//';'
		public Keyword getSemicolonKeyword_4_1_0_1_1_0_0() { return cSemicolonKeyword_4_1_0_1_1_0_0; }
		
		//expression=Expression<In=true,Yield>?
		public Assignment getExpressionAssignment_4_1_0_1_1_0_1() { return cExpressionAssignment_4_1_0_1_1_0_1; }
		
		//Expression<In=true,Yield>
		public RuleCall getExpressionExpressionParserRuleCall_4_1_0_1_1_0_1_0() { return cExpressionExpressionParserRuleCall_4_1_0_1_1_0_1_0; }
		
		//';'
		public Keyword getSemicolonKeyword_4_1_0_1_1_0_2() { return cSemicolonKeyword_4_1_0_1_1_0_2; }
		
		//updateExpr=Expression<In=true,Yield>?
		public Assignment getUpdateExprAssignment_4_1_0_1_1_0_3() { return cUpdateExprAssignment_4_1_0_1_1_0_3; }
		
		//Expression<In=true,Yield>
		public RuleCall getUpdateExprExpressionParserRuleCall_4_1_0_1_1_0_3_0() { return cUpdateExprExpressionParserRuleCall_4_1_0_1_1_0_3_0; }
		
		//forIn?='in' expression=Expression<In=true,Yield>?
		public Group getGroup_4_1_0_1_1_1() { return cGroup_4_1_0_1_1_1; }
		
		//forIn?='in'
		public Assignment getForInAssignment_4_1_0_1_1_1_0() { return cForInAssignment_4_1_0_1_1_1_0; }
		
		//'in'
		public Keyword getForInInKeyword_4_1_0_1_1_1_0_0() { return cForInInKeyword_4_1_0_1_1_1_0_0; }
		
		//expression=Expression<In=true,Yield>?
		public Assignment getExpressionAssignment_4_1_0_1_1_1_1() { return cExpressionAssignment_4_1_0_1_1_1_1; }
		
		//Expression<In=true,Yield>
		public RuleCall getExpressionExpressionParserRuleCall_4_1_0_1_1_1_1_0() { return cExpressionExpressionParserRuleCall_4_1_0_1_1_1_1_0; }
		
		//forOf?='of' expression=AssignmentExpression<In=true,Yield>?
		public Group getGroup_4_1_0_1_1_2() { return cGroup_4_1_0_1_1_2; }
		
		//forOf?='of'
		public Assignment getForOfAssignment_4_1_0_1_1_2_0() { return cForOfAssignment_4_1_0_1_1_2_0; }
		
		//'of'
		public Keyword getForOfOfKeyword_4_1_0_1_1_2_0_0() { return cForOfOfKeyword_4_1_0_1_1_2_0_0; }
		
		//expression=AssignmentExpression<In=true,Yield>?
		public Assignment getExpressionAssignment_4_1_0_1_1_2_1() { return cExpressionAssignment_4_1_0_1_1_2_1; }
		
		//AssignmentExpression<In=true,Yield>
		public RuleCall getExpressionAssignmentExpressionParserRuleCall_4_1_0_1_1_2_1_0() { return cExpressionAssignmentExpressionParserRuleCall_4_1_0_1_1_2_1_0; }
		
		//';' expression=Expression<In=true,Yield>? ';' updateExpr=Expression<In=true,Yield>?
		public Group getGroup_4_1_0_2() { return cGroup_4_1_0_2; }
		
		//';'
		public Keyword getSemicolonKeyword_4_1_0_2_0() { return cSemicolonKeyword_4_1_0_2_0; }
		
		//expression=Expression<In=true,Yield>?
		public Assignment getExpressionAssignment_4_1_0_2_1() { return cExpressionAssignment_4_1_0_2_1; }
		
		//Expression<In=true,Yield>
		public RuleCall getExpressionExpressionParserRuleCall_4_1_0_2_1_0() { return cExpressionExpressionParserRuleCall_4_1_0_2_1_0; }
		
		//';'
		public Keyword getSemicolonKeyword_4_1_0_2_2() { return cSemicolonKeyword_4_1_0_2_2; }
		
		//updateExpr=Expression<In=true,Yield>?
		public Assignment getUpdateExprAssignment_4_1_0_2_3() { return cUpdateExprAssignment_4_1_0_2_3; }
		
		//Expression<In=true,Yield>
		public RuleCall getUpdateExprExpressionParserRuleCall_4_1_0_2_3_0() { return cUpdateExprExpressionParserRuleCall_4_1_0_2_3_0; }
		
		//')'
		public Keyword getRightParenthesisKeyword_4_1_1() { return cRightParenthesisKeyword_4_1_1; }
	...
	public class AnnotatedPropertyAssignmentElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cDeclaredTypeRefNodeAssignment_1_0_0_0_1 = (Assignment)cGroup_1_0_0_0.eContents().get(1);
		private final RuleCall cDeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_0_0_0_1_0 = (RuleCall)cDeclaredTypeRefNodeAssignment_1_0_0_0_1.eContents().get(0);
		...
		private final Assignment cDeclaredReturnTypeRefNodeAssignment_1_3_0_0_2 = (Assignment)cGroup_1_3_0_0.eContents().get(2);
		private final RuleCall cDeclaredReturnTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_3_0_0_2_0 = (RuleCall)cDeclaredReturnTypeRefNodeAssignment_1_3_0_0_2.eContents().get(0);
		...
		private final Assignment cDeclaredTypeRefNodeAssignment_1_4_1 = (Assignment)cGroup_1_4.eContents().get(1);
		private final RuleCall cDeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_4_1_0 = (RuleCall)cDeclaredTypeRefNodeAssignment_1_4_1.eContents().get(0);
		...
		private final Assignment cExpressionAssignment_1_5_2 = (Assignment)cGroup_1_5.eContents().get(2);
		private final RuleCall cExpressionAssignmentExpressionParserRuleCall_1_5_2_0 = (RuleCall)cExpressionAssignment_1_5_2.eContents().get(0);
		...
		//    =>(    {PropertyNameValuePair.annotationList=current} declaredTypeRefNode=TypeReferenceWithModifiersNode?
		...
		//            TypeParameters? declaredReturnTypeRefNode=TypeReferenceWithModifiersNode?
		...
		//            )
		//        ) ';'?
		//    | {PropertyNameValuePairSingleName.annotationList=current} declaredTypeRefNode=TypeReferenceWithModifiersNode? expression=PropertyNameValuePairSingleNamePart<Yield>
		...
		public Assignment getDeclaredTypeRefNodeAssignment_1_0_0_0_1() { return cDeclaredTypeRefNodeAssignment_1_0_0_0_1; }
		
		//TypeReferenceWithModifiersNode
		public RuleCall getDeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_0_0_0_1_0() { return cDeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_0_0_0_1_0; }
		...
		public Assignment getDeclaredReturnTypeRefNodeAssignment_1_3_0_0_2() { return cDeclaredReturnTypeRefNodeAssignment_1_3_0_0_2; }
		
		//TypeReferenceWithModifiersNode
		public RuleCall getDeclaredReturnTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_3_0_0_2_0() { return cDeclaredReturnTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_3_0_0_2_0; }
		...
		//declaredTypeRefNode=TypeReferenceWithModifiersNode?
		public Assignment getDeclaredTypeRefNodeAssignment_1_4_1() { return cDeclaredTypeRefNodeAssignment_1_4_1; }
		
		//TypeReferenceWithModifiersNode
		public RuleCall getDeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_4_1_0() { return cDeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_4_1_0; }
		...
		//{PropertySpread.annotationList=current}
		public Action getPropertySpreadAnnotationListAction_1_5_0() { return cPropertySpreadAnnotationListAction_1_5_0; }
		
		//'...'
		public Keyword getFullStopFullStopFullStopKeyword_1_5_1() { return cFullStopFullStopFullStopKeyword_1_5_1; }
		
		//expression=AssignmentExpression<In=true,Yield>
		public Assignment getExpressionAssignment_1_5_2() { return cExpressionAssignment_1_5_2; }
		
		//AssignmentExpression<In=true,Yield>
		public RuleCall getExpressionAssignmentExpressionParserRuleCall_1_5_2_0() { return cExpressionAssignmentExpressionParserRuleCall_1_5_2_0; }
	}
	public class PropertyMethodDeclarationElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cDeclaredReturnTypeRefNodeAssignment_0_0_2 = (Assignment)cGroup_0_0.eContents().get(2);
		private final RuleCall cDeclaredReturnTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_0_0_2_0 = (RuleCall)cDeclaredReturnTypeRefNodeAssignment_0_0_2.eContents().get(0);
		...
		private final RuleCall cMethodParamsAndBodyParserRuleCall_0_0_4_0_2 = (RuleCall)cGroup_0_0_4_0.eContents().get(2);
		private final Group cGroup_0_0_4_1 = (Group)cAlternatives_0_0_4.eContents().get(1);
		private final Assignment cDeclaredNameAssignment_0_0_4_1_0 = (Assignment)cGroup_0_0_4_1.eContents().get(0);
		private final RuleCall cDeclaredNameLiteralOrComputedPropertyNameParserRuleCall_0_0_4_1_0_0 = (RuleCall)cDeclaredNameAssignment_0_0_4_1_0.eContents().get(0);
		private final RuleCall cMethodParamsAndBodyParserRuleCall_0_0_4_1_1 = (RuleCall)cGroup_0_0_4_1.eContents().get(1);
		private final Keyword cSemicolonKeyword_1 = (Keyword)cGroup.eContents().get(1);
		...
		//declaredReturnTypeRefNode=TypeReferenceWithModifiersNode?
		public Assignment getDeclaredReturnTypeRefNodeAssignment_0_0_2() { return cDeclaredReturnTypeRefNodeAssignment_0_0_2; }
		
		//TypeReferenceWithModifiersNode
		public RuleCall getDeclaredReturnTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_0_0_2_0() { return cDeclaredReturnTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_0_0_2_0; }
		...
		//->MethodParamsAndBody<Generator=true>
		public RuleCall getMethodParamsAndBodyParserRuleCall_0_0_4_0_2() { return cMethodParamsAndBodyParserRuleCall_0_0_4_0_2; }
		
		//declaredName=LiteralOrComputedPropertyName<Yield> ->MethodParamsAndBody <Generator=false>
		public Group getGroup_0_0_4_1() { return cGroup_0_0_4_1; }
		
		//declaredName=LiteralOrComputedPropertyName<Yield>
		public Assignment getDeclaredNameAssignment_0_0_4_1_0() { return cDeclaredNameAssignment_0_0_4_1_0; }
		
		//LiteralOrComputedPropertyName<Yield>
		public RuleCall getDeclaredNameLiteralOrComputedPropertyNameParserRuleCall_0_0_4_1_0_0() { return cDeclaredNameLiteralOrComputedPropertyNameParserRuleCall_0_0_4_1_0_0; }
		
		//->MethodParamsAndBody <Generator=false>
		public RuleCall getMethodParamsAndBodyParserRuleCall_0_0_4_1_1() { return cMethodParamsAndBodyParserRuleCall_0_0_4_1_1; }
	...
	public class PropertyNameValuePairElements extends AbstractParserRuleElementFinder {
		...
		//declaredTypeRefNode=TypeReferenceWithModifiersNode?
		public Assignment getDeclaredTypeRefNodeAssignment_0_0_1() { return cDeclaredTypeRefNodeAssignment_0_0_1; }
	...
	public class PropertyNameValuePairSingleNameElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cDeclaredTypeRefNodeAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_0_0 = (RuleCall)cDeclaredTypeRefNodeAssignment_0.eContents().get(0);
		private final Assignment cExpressionAssignment_1 = (Assignment)cGroup.eContents().get(1);
		...
		//declaredTypeRefNode=TypeReferenceNode?
		public Assignment getDeclaredTypeRefNodeAssignment_0() { return cDeclaredTypeRefNodeAssignment_0; }
		
		//TypeReferenceNode
		public RuleCall getDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_0_0() { return cDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_0_0; }
	...
	public class ConcreteTypeArgumentsElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cTypeArgsTypeReferenceNodeParserRuleCall_1_0 = (RuleCall)cTypeArgsAssignment_1.eContents().get(0);
		private final Group cGroup_2 = (Group)cGroup.eContents().get(2);
		private final Keyword cCommaKeyword_2_0 = (Keyword)cGroup_2.eContents().get(0);
		private final Assignment cTypeArgsAssignment_2_1 = (Assignment)cGroup_2.eContents().get(1);
		private final RuleCall cTypeArgsTypeReferenceNodeParserRuleCall_2_1_0 = (RuleCall)cTypeArgsAssignment_2_1.eContents().get(0);
		...
		//TypeReferenceNode
		public RuleCall getTypeArgsTypeReferenceNodeParserRuleCall_1_0() { return cTypeArgsTypeReferenceNodeParserRuleCall_1_0; }
		...
		//TypeReferenceNode
		public RuleCall getTypeArgsTypeReferenceNodeParserRuleCall_2_1_0() { return cTypeArgsTypeReferenceNodeParserRuleCall_2_1_0; }
		
		//'>'
		public Keyword getGreaterThanSignKeyword_3() { return cGreaterThanSignKeyword_3; }
	}
	public class ColonSepDeclaredTypeRefElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.ColonSepDeclaredTypeRef");
		private final Group cGroup = (Group)rule.eContents().get(0);
		private final Keyword cColonKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cDeclaredTypeRefNodeAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_0 = (RuleCall)cDeclaredTypeRefNodeAssignment_1.eContents().get(0);
		...
		//declaredTypeRefNode=TypeReferenceNode
		public Assignment getDeclaredTypeRefNodeAssignment_1() { return cDeclaredTypeRefNodeAssignment_1; }
		
		//TypeReferenceNode
		public RuleCall getDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_0() { return cDeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_0; }
	}
	public class ColonSepDeclaredReturnTypeRefElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.ColonSepDeclaredReturnTypeRef");
		private final Group cGroup = (Group)rule.eContents().get(0);
		private final Keyword cColonKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Alternatives cAlternatives_1 = (Alternatives)cGroup.eContents().get(1);
		private final Assignment cDeclaredReturnTypePredicateAssignment_1_0 = (Assignment)cAlternatives_1.eContents().get(0);
		private final RuleCall cDeclaredReturnTypePredicateTypePredicateDeclarationParserRuleCall_1_0_0 = (RuleCall)cDeclaredReturnTypePredicateAssignment_1_0.eContents().get(0);
		private final Assignment cDeclaredReturnTypeRefNodeAssignment_1_1 = (Assignment)cAlternatives_1.eContents().get(1);
		private final RuleCall cDeclaredReturnTypeRefNodeTypeReferenceNodeParserRuleCall_1_1_0 = (RuleCall)cDeclaredReturnTypeRefNodeAssignment_1_1.eContents().get(0);
		
		//fragment ColonSepDeclaredReturnTypeRef<Yield>*:
		//    ':' (declaredReturnTypePredicate=TypePredicateDeclaration<Yield> | declaredReturnTypeRefNode=TypeReferenceNode)
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//declaredReturnTypePredicate=TypePredicateDeclaration<Yield>
		public Assignment getDeclaredReturnTypePredicateAssignment_1_0() { return cDeclaredReturnTypePredicateAssignment_1_0; }
		
		//TypePredicateDeclaration<Yield>
		public RuleCall getDeclaredReturnTypePredicateTypePredicateDeclarationParserRuleCall_1_0_0() { return cDeclaredReturnTypePredicateTypePredicateDeclarationParserRuleCall_1_0_0; }
		
		//declaredReturnTypeRefNode=TypeReferenceNode
		public Assignment getDeclaredReturnTypeRefNodeAssignment_1_1() { return cDeclaredReturnTypeRefNodeAssignment_1_1; }
		
		//TypeReferenceNode
		public RuleCall getDeclaredReturnTypeRefNodeTypeReferenceNodeParserRuleCall_1_1_0() { return cDeclaredReturnTypeRefNodeTypeReferenceNodeParserRuleCall_1_1_0; }
	}
	public class TypePredicateDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.TypePredicateDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cGroup.eContents().get(0);
		private final Group cGroup_0_0 = (Group)cGroup_0.eContents().get(0);
		private final Alternatives cAlternatives_0_0_0 = (Alternatives)cGroup_0_0.eContents().get(0);
		...
		private final Assignment cTypeRefNodeAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cTypeRefNodeTypeReferenceNodeParserRuleCall_1_0 = (RuleCall)cTypeRefNodeAssignment_1.eContents().get(0);
		
		//TypePredicateDeclaration<Yield>:
		//    =>((referringToThis?='this' | fpar=[types::IdentifiableElement|BindingIdentifier<Yield>]) 'is') typeRefNode=TypeReferenceNode
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//=>((referringToThis?='this' | fpar=[types::IdentifiableElement|BindingIdentifier<Yield>]) 'is')
		public Group getGroup_0() { return cGroup_0; }
		
		//(referringToThis?='this' | fpar=[types::IdentifiableElement|BindingIdentifier<Yield>]) 'is'
		public Group getGroup_0_0() { return cGroup_0_0; }
		
		//(referringToThis?='this' | fpar=[types::IdentifiableElement|BindingIdentifier<Yield>])
		public Alternatives getAlternatives_0_0_0() { return cAlternatives_0_0_0; }
		...
		//fpar=[types::IdentifiableElement|BindingIdentifier<Yield>]
		...
		public Assignment getTypeRefNodeAssignment_1() { return cTypeRefNodeAssignment_1; }
		
		//TypeReferenceNode
		public RuleCall getTypeRefNodeTypeReferenceNodeParserRuleCall_1_0() { return cTypeRefNodeTypeReferenceNodeParserRuleCall_1_0; }
	}
	public class TypeReferenceNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.TypeReferenceNode");
	...
	public class TypeReferenceWithModifiersNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.TypeReferenceWithModifiersNode");
		private final Assignment cTypeRefInASTAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cTypeRefInASTTypeRefWithModifiersParserRuleCall_0 = (RuleCall)cTypeRefInASTAssignment.eContents().get(0);
		...
		public RuleCall getTypeRefInASTTypeRefWithModifiersParserRuleCall_0() { return cTypeRefInASTTypeRefWithModifiersParserRuleCall_0; }
	}
	public class ParameterizedTypeRefNominalNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.ParameterizedTypeRefNominalNode");
		private final Assignment cTypeRefInASTAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ArrayTypeExpressionNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.ArrayTypeExpressionNode");
		private final Assignment cTypeRefInASTAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cTypeRefInASTArrayTypeExpressionParserRuleCall_0 = (RuleCall)cTypeRefInASTAssignment.eContents().get(0);
		...
		//ArrayTypeExpression
		public RuleCall getTypeRefInASTArrayTypeExpressionParserRuleCall_0() { return cTypeRefInASTArrayTypeExpressionParserRuleCall_0; }
	}
	...
	public class CastExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cTargetTypeRefNodeAssignment_1_1 = (Assignment)cGroup_1.eContents().get(1);
		private final RuleCall cTargetTypeRefNodeArrayTypeExpressionNodeParserRuleCall_1_1_0 = (RuleCall)cTargetTypeRefNodeAssignment_1_1.eContents().get(0);
		
		///* Cast expression (N4JS 6.2.3) */
		//CastExpression <Yield> returns Expression: PostfixExpression<Yield>
		//    (=>({CastExpression.expression=current} 'as') targetTypeRefNode=ArrayTypeExpressionNode)?;
		@Override public ParserRule getRule() { return rule; }
		...
		//targetTypeRefNode=ArrayTypeExpressionNode
		public Assignment getTargetTypeRefNodeAssignment_1_1() { return cTargetTypeRefNodeAssignment_1_1; }
		
		//ArrayTypeExpressionNode
		public RuleCall getTargetTypeRefNodeArrayTypeExpressionNodeParserRuleCall_1_1_0() { return cTargetTypeRefNodeArrayTypeExpressionNodeParserRuleCall_1_1_0; }
	}
	...
	public class NumericLiteralElements extends AbstractParserRuleElementFinder {
		...
		//DoubleLiteral | IntLiteral | BinaryIntLiteral | OctalIntLiteral | LegacyOctalIntLiteral | HexIntLiteral | ScientificIntLiteral
		public Alternatives getAlternatives() { return cAlternatives; }
	...
	public class IdentifierOrThisElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cPromisifyKeyword_1 = (Keyword)cAlternatives.eContents().get(1);
		...
		//'Promisify'
		public Keyword getPromisifyKeyword_1() { return cPromisifyKeyword_1; }
	...
	public class AnnotationNoAtSignElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cArgsAnnotationArgumentParserRuleCall_1_2_0_0 = (RuleCall)cArgsAssignment_1_2_0.eContents().get(0);
		private final Group cGroup_1_2_1 = (Group)cGroup_1_2.eContents().get(1);
		...
		//AnnotationArgument
		public RuleCall getArgsAnnotationArgumentParserRuleCall_1_2_0_0() { return cArgsAnnotationArgumentParserRuleCall_1_2_0_0; }
		...
		//AnnotationArgument
		public RuleCall getArgsAnnotationArgumentParserRuleCall_1_2_1_1_0() { return cArgsAnnotationArgumentParserRuleCall_1_2_1_1_0; }
	...
	public class TypeRefAnnotationArgumentElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cTypeRefNodeAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cTypeRefNodeTypeReferenceNodeParserRuleCall_0 = (RuleCall)cTypeRefNodeAssignment.eContents().get(0);
		...
		//typeRefNode=TypeReferenceNode
		public Assignment getTypeRefNodeAssignment() { return cTypeRefNodeAssignment; }
		
		//TypeReferenceNode
		public RuleCall getTypeRefNodeTypeReferenceNodeParserRuleCall_0() { return cTypeRefNodeTypeReferenceNodeParserRuleCall_0; }
	}
	...
	public class ClassExtendsClauseElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cSuperClassRefParameterizedTypeRefNominalNodeParserRuleCall_1_0_0 = (RuleCall)cSuperClassRefAssignment_1_0.eContents().get(0);
		...
		//    'extends' (
		//          =>superClassRef=ParameterizedTypeRefNominalNode
		...
		//ParameterizedTypeRefNominalNode
		public RuleCall getSuperClassRefParameterizedTypeRefNominalNodeParserRuleCall_1_0_0() { return cSuperClassRefParameterizedTypeRefNominalNodeParserRuleCall_1_0_0; }
	...
	public class ClassImplementsListElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cImplementedInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_1_0 = (RuleCall)cImplementedInterfaceRefsAssignment_1.eContents().get(0);
		private final Group cGroup_2 = (Group)cGroup.eContents().get(2);
		private final Keyword cCommaKeyword_2_0 = (Keyword)cGroup_2.eContents().get(0);
		private final Assignment cImplementedInterfaceRefsAssignment_2_1 = (Assignment)cGroup_2.eContents().get(1);
		private final RuleCall cImplementedInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_2_1_0 = (RuleCall)cImplementedInterfaceRefsAssignment_2_1.eContents().get(0);
		
		//fragment ClassImplementsList*:
		//    'implements' implementedInterfaceRefs+=ParameterizedTypeRefNominalNode
		...
		//ParameterizedTypeRefNominalNode
		public RuleCall getImplementedInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_1_0() { return cImplementedInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_1_0; }
		...
		//ParameterizedTypeRefNominalNode
		public RuleCall getImplementedInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_2_1_0() { return cImplementedInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_2_1_0; }
	}
	...
	public class InterfaceExtendsListElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cSuperInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_1_0 = (RuleCall)cSuperInterfaceRefsAssignment_1.eContents().get(0);
		private final Group cGroup_2 = (Group)cGroup.eContents().get(2);
		private final Keyword cCommaKeyword_2_0 = (Keyword)cGroup_2.eContents().get(0);
		private final Assignment cSuperInterfaceRefsAssignment_2_1 = (Assignment)cGroup_2.eContents().get(1);
		private final RuleCall cSuperInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_2_1_0 = (RuleCall)cSuperInterfaceRefsAssignment_2_1.eContents().get(0);
		
		//// we allow both 'extends' and 'implements' here, a validation will ensure 'extends' is used
		//fragment InterfaceExtendsList*:
		//    ('extends' | 'implements') superInterfaceRefs+=ParameterizedTypeRefNominalNode
		//    (',' superInterfaceRefs+=ParameterizedTypeRefNominalNode)*
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//ParameterizedTypeRefNominalNode
		public RuleCall getSuperInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_1_0() { return cSuperInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_1_0; }
		...
		//ParameterizedTypeRefNominalNode
		public RuleCall getSuperInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_2_1_0() { return cSuperInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_2_1_0; }
	}
	...
	public class N4TypeAliasDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.N4TypeAliasDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cGroup.eContents().get(0);
		private final Group cGroup_0_0 = (Group)cGroup_0.eContents().get(0);
		...
		//declaredTypeRefNode=TypeReferenceNode
		public Assignment getDeclaredTypeRefNodeAssignment_3() { return cDeclaredTypeRefNodeAssignment_3; }
	...
	public class N4MemberDeclarationElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cN4IndexSignatureDeclarationParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		private final RuleCall cN4GetterDeclarationParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		private final RuleCall cN4SetterDeclarationParserRuleCall_3 = (RuleCall)cAlternatives.eContents().get(3);
		private final RuleCall cN4MethodDeclarationParserRuleCall_4 = (RuleCall)cAlternatives.eContents().get(4);
		private final RuleCall cN4CallSignatureDeclarationParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		private final RuleCall cN4FieldDeclarationParserRuleCall_6 = (RuleCall)cAlternatives.eContents().get(6);
		...
		//N4IndexSignatureDeclaration<Yield>
		public RuleCall getN4IndexSignatureDeclarationParserRuleCall_1() { return cN4IndexSignatureDeclarationParserRuleCall_1; }
		
		//N4GetterDeclaration<Yield>
		public RuleCall getN4GetterDeclarationParserRuleCall_2() { return cN4GetterDeclarationParserRuleCall_2; }
		
		//N4SetterDeclaration<Yield>
		public RuleCall getN4SetterDeclarationParserRuleCall_3() { return cN4SetterDeclarationParserRuleCall_3; }
		
		//N4MethodDeclaration<Yield>
		public RuleCall getN4MethodDeclarationParserRuleCall_4() { return cN4MethodDeclarationParserRuleCall_4; }
		
		//N4CallSignatureDeclaration<Yield>
		public RuleCall getN4CallSignatureDeclarationParserRuleCall_5() { return cN4CallSignatureDeclarationParserRuleCall_5; }
		
		//N4FieldDeclaration<Yield>
		public RuleCall getN4FieldDeclarationParserRuleCall_6() { return cN4FieldDeclarationParserRuleCall_6; }
	}
	public class AnnotatedN4MemberDeclarationElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cSemicolonKeyword_1_0_2_0 = (Keyword)cAlternatives_1_0_2.eContents().get(0);
		private final Keyword cCommaKeyword_1_0_2_1 = (Keyword)cAlternatives_1_0_2.eContents().get(1);
		private final Group cGroup_1_1 = (Group)cAlternatives_1.eContents().get(1);
		private final Group cGroup_1_1_0 = (Group)cGroup_1_1.eContents().get(0);
		private final Group cGroup_1_1_0_0 = (Group)cGroup_1_1_0.eContents().get(0);
		...
		private final Keyword cSemicolonKeyword_1_1_6_0 = (Keyword)cAlternatives_1_1_6.eContents().get(0);
		private final Keyword cCommaKeyword_1_1_6_1 = (Keyword)cAlternatives_1_1_6.eContents().get(1);
		private final Group cGroup_1_2 = (Group)cAlternatives_1.eContents().get(2);
		private final Group cGroup_1_2_0 = (Group)cGroup_1_2.eContents().get(0);
		private final Group cGroup_1_2_0_0 = (Group)cGroup_1_2_0.eContents().get(0);
		...
		private final Assignment cDeclaredModifiersAssignment_1_2_0_0_1 = (Assignment)cGroup_1_2_0_0.eContents().get(1);
		private final RuleCall cDeclaredModifiersN4ModifierEnumRuleCall_1_2_0_0_1_0 = (RuleCall)cDeclaredModifiersAssignment_1_2_0_0_1.eContents().get(0);
		private final Alternatives cAlternatives_1_2_0_0_2 = (Alternatives)cGroup_1_2_0_0.eContents().get(2);
		private final Group cGroup_1_2_0_0_2_0 = (Group)cAlternatives_1_2_0_0_2.eContents().get(0);
		private final Assignment cGeneratorAssignment_1_2_0_0_2_0_0 = (Assignment)cGroup_1_2_0_0_2_0.eContents().get(0);
		...
		private final Keyword cSemicolonKeyword_1_2_1_0 = (Keyword)cAlternatives_1_2_1.eContents().get(0);
		private final Keyword cCommaKeyword_1_2_1_1 = (Keyword)cAlternatives_1_2_1.eContents().get(1);
		private final Group cGroup_1_3 = (Group)cAlternatives_1.eContents().get(3);
		private final Group cGroup_1_3_0 = (Group)cGroup_1_3.eContents().get(0);
		private final Group cGroup_1_3_0_0 = (Group)cGroup_1_3_0.eContents().get(0);
		...
		private final Keyword cSemicolonKeyword_1_3_1_0 = (Keyword)cAlternatives_1_3_1.eContents().get(0);
		private final Keyword cCommaKeyword_1_3_1_1 = (Keyword)cAlternatives_1_3_1.eContents().get(1);
		private final Group cGroup_1_4 = (Group)cAlternatives_1.eContents().get(4);
		private final Action cN4FieldDeclarationAnnotationListAction_1_4_0 = (Action)cGroup_1_4.eContents().get(0);
		private final RuleCall cFieldDeclarationImplParserRuleCall_1_4_1 = (RuleCall)cGroup_1_4.eContents().get(1);
		...
		//','
		public Keyword getCommaKeyword_1_0_2_1() { return cCommaKeyword_1_0_2_1; }
		...
		//';'
		public Keyword getSemicolonKeyword_1_1_6_0() { return cSemicolonKeyword_1_1_6_0; }
		
		//','
		public Keyword getCommaKeyword_1_1_6_1() { return cCommaKeyword_1_1_6_1; }
		...
		//generator?='*'
		public Assignment getGeneratorAssignment_1_2_0_0_2_0_0() { return cGeneratorAssignment_1_2_0_0_2_0_0; }
		
		//'*'
		public Keyword getGeneratorAsteriskKeyword_1_2_0_0_2_0_0_0() { return cGeneratorAsteriskKeyword_1_2_0_0_2_0_0_0; }
		
		//declaredName=LiteralOrComputedPropertyName<Yield>
		public Assignment getDeclaredNameAssignment_1_2_0_0_2_0_1() { return cDeclaredNameAssignment_1_2_0_0_2_0_1; }
		...
		//AsyncNoTrailingLineBreak
		public RuleCall getAsyncNoTrailingLineBreakParserRuleCall_1_2_0_0_2_1_0() { return cAsyncNoTrailingLineBreakParserRuleCall_1_2_0_0_2_1_0; }
		
		//declaredName=LiteralOrComputedPropertyName<Yield>
		public Assignment getDeclaredNameAssignment_1_2_0_0_2_1_1() { return cDeclaredNameAssignment_1_2_0_0_2_1_1; }
		...
		//','
		public Keyword getCommaKeyword_1_2_1_1() { return cCommaKeyword_1_2_1_1; }
		...
		public Action getN4FieldDeclarationAnnotationListAction_1_4_0() { return cN4FieldDeclarationAnnotationListAction_1_4_0; }
		
		//FieldDeclarationImpl<Yield>
		public RuleCall getFieldDeclarationImplParserRuleCall_1_4_1() { return cFieldDeclarationImplParserRuleCall_1_4_1; }
	}
	public class FieldDeclarationImplElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cSemiParserRuleCall_7 = (RuleCall)cGroup.eContents().get(7);
		...
		//Semi
		public RuleCall getSemiParserRuleCall_7() { return cSemiParserRuleCall_7; }
	}
	...
	public class N4CallSignatureDeclarationElements extends AbstractParserRuleElementFinder {
		...
		// * by the parser (i.e. they do not have dedicated grammar rules), call signatures need
	...
	public class MethodParamsReturnAndBodyElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(0);
		private final RuleCall cStrictFormalParametersParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final RuleCall cColonSepDeclaredReturnTypeRefParserRuleCall_1 = (RuleCall)cGroup.eContents().get(1);
		...
		//ColonSepDeclaredReturnTypeRef<Yield=Generator>?
		public RuleCall getColonSepDeclaredReturnTypeRefParserRuleCall_1() { return cColonSepDeclaredReturnTypeRefParserRuleCall_1; }
	...
	public class GetterHeaderElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cDeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_0 = (RuleCall)cDeclaredNameAssignment_1.eContents().get(0);
		private final Assignment cDeclaredOptionalAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final Keyword cDeclaredOptionalQuestionMarkKeyword_2_0 = (Keyword)cDeclaredOptionalAssignment_2.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Keyword cRightParenthesisKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final RuleCall cColonSepDeclaredTypeRefParserRuleCall_5 = (RuleCall)cGroup.eContents().get(5);
		...
		//LiteralOrComputedPropertyName<Yield>
		public RuleCall getDeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_0() { return cDeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_0; }
		
		//(declaredOptional?='?')?
		public Assignment getDeclaredOptionalAssignment_2() { return cDeclaredOptionalAssignment_2; }
		
		//'?'
		public Keyword getDeclaredOptionalQuestionMarkKeyword_2_0() { return cDeclaredOptionalQuestionMarkKeyword_2_0; }
		...
		//ColonSepDeclaredTypeRef?
		public RuleCall getColonSepDeclaredTypeRefParserRuleCall_5() { return cColonSepDeclaredTypeRefParserRuleCall_5; }
	}
	public class N4SetterDeclarationElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cCommaKeyword_6_1 = (Keyword)cAlternatives_6.eContents().get(1);
	...
	public class N4IndexSignatureDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.N4IndexSignatureDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cGroup.eContents().get(0);
		private final Group cGroup_0_0 = (Group)cGroup_0.eContents().get(0);
		...
		private final Assignment cDeclaredValueTypeRefNodeAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cDeclaredValueTypeRefNodeTypeReferenceNodeParserRuleCall_4_0 = (RuleCall)cDeclaredValueTypeRefNodeAssignment_4.eContents().get(0);
		...
		//TypeReferenceNode
		public RuleCall getDeclaredKeyTypeRefNodeTypeReferenceNodeParserRuleCall_1_0() { return cDeclaredKeyTypeRefNodeTypeReferenceNodeParserRuleCall_1_0; }
		...
		//declaredValueTypeRefNode=TypeReferenceNode
		public Assignment getDeclaredValueTypeRefNodeAssignment_4() { return cDeclaredValueTypeRefNodeAssignment_4; }
		
		//TypeReferenceNode
		public RuleCall getDeclaredValueTypeRefNodeTypeReferenceNodeParserRuleCall_4_0() { return cDeclaredValueTypeRefNodeTypeReferenceNodeParserRuleCall_4_0; }
	...
	public class JSXElementElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cJsxAttributesAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cJsxAttributesJSXAttributeParserRuleCall_2_0 = (RuleCall)cJsxAttributesAssignment_2.eContents().get(0);
		...
		public Assignment getJsxAttributesAssignment_2() { return cJsxAttributesAssignment_2; }
		
		//JSXAttribute
		public RuleCall getJsxAttributesJSXAttributeParserRuleCall_2_0() { return cJsxAttributesJSXAttributeParserRuleCall_2_0; }
	...
	public class JSXIdentifierElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.N4JS.JSXIdentifier");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Keyword cHyphenMinusHyphenMinusKeyword_1_0_1 = (Keyword)cAlternatives_1_0.eContents().get(1);
		private final Group cGroup_1_1 = (Group)cGroup_1.eContents().get(1);
		private final Alternatives cAlternatives_1_1_0 = (Alternatives)cGroup_1_1.eContents().get(0);
		private final RuleCall cINTTerminalRuleCall_1_1_0_0 = (RuleCall)cAlternatives_1_1_0.eContents().get(0);
		private final RuleCall cHEX_INTTerminalRuleCall_1_1_0_1 = (RuleCall)cAlternatives_1_1_0.eContents().get(1);
		private final RuleCall cBINARY_INTTerminalRuleCall_1_1_0_2 = (RuleCall)cAlternatives_1_1_0.eContents().get(2);
		private final RuleCall cOCTAL_INTTerminalRuleCall_1_1_0_3 = (RuleCall)cAlternatives_1_1_0.eContents().get(3);
		private final RuleCall cSCIENTIFIC_INTTerminalRuleCall_1_1_0_4 = (RuleCall)cAlternatives_1_1_0.eContents().get(4);
		private final RuleCall cLEGACY_OCTAL_INTTerminalRuleCall_1_1_0_5 = (RuleCall)cAlternatives_1_1_0.eContents().get(5);
		private final RuleCall cIdentifierNameParserRuleCall_1_1_0_6 = (RuleCall)cAlternatives_1_1_0.eContents().get(6);
		...
		//(('-'|'--') ->(INT | HEX_INT | BINARY_INT | OCTAL_INT | SCIENTIFIC_INT | LEGACY_OCTAL_INT | IdentifierName)?)*
		public Group getGroup_1() { return cGroup_1; }
		...
		//INT
		public RuleCall getINTTerminalRuleCall_1_1_0_0() { return cINTTerminalRuleCall_1_1_0_0; }
		
		//HEX_INT
		public RuleCall getHEX_INTTerminalRuleCall_1_1_0_1() { return cHEX_INTTerminalRuleCall_1_1_0_1; }
		
		//BINARY_INT
		public RuleCall getBINARY_INTTerminalRuleCall_1_1_0_2() { return cBINARY_INTTerminalRuleCall_1_1_0_2; }
		
		//OCTAL_INT
		public RuleCall getOCTAL_INTTerminalRuleCall_1_1_0_3() { return cOCTAL_INTTerminalRuleCall_1_1_0_3; }
		
		//SCIENTIFIC_INT
		public RuleCall getSCIENTIFIC_INTTerminalRuleCall_1_1_0_4() { return cSCIENTIFIC_INTTerminalRuleCall_1_1_0_4; }
		
		//LEGACY_OCTAL_INT
		public RuleCall getLEGACY_OCTAL_INTTerminalRuleCall_1_1_0_5() { return cLEGACY_OCTAL_INTTerminalRuleCall_1_1_0_5; }
		
		//IdentifierName
		public RuleCall getIdentifierNameParserRuleCall_1_1_0_6() { return cIdentifierNameParserRuleCall_1_1_0_6; }
	}
	public class JSXPropertyAttributeElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cPropertyIdentifiableElementJSXIdentifierParserRuleCall_0_0_1 = (RuleCall)cPropertyIdentifiableElementCrossReference_0_0.eContents().get(1);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		...
		private final Assignment cJsxAttributeValueAssignment_1_1_1 = (Assignment)cAlternatives_1_1.eContents().get(1);
		private final RuleCall cJsxAttributeValueJSXElementParserRuleCall_1_1_1_0 = (RuleCall)cJsxAttributeValueAssignment_1_1_1.eContents().get(0);
		private final Assignment cJsxAttributeValueAssignment_1_1_2 = (Assignment)cAlternatives_1_1.eContents().get(2);
		private final RuleCall cJsxAttributeValueJSXFragmentParserRuleCall_1_1_2_0 = (RuleCall)cJsxAttributeValueAssignment_1_1_2.eContents().get(0);
		private final Group cGroup_1_1_3 = (Group)cAlternatives_1_1.eContents().get(3);
		private final Keyword cLeftCurlyBracketKeyword_1_1_3_0 = (Keyword)cGroup_1_1_3.eContents().get(0);
		private final Assignment cJsxAttributeValueAssignment_1_1_3_1 = (Assignment)cGroup_1_1_3.eContents().get(1);
		private final RuleCall cJsxAttributeValueAssignmentExpressionParserRuleCall_1_1_3_1_0 = (RuleCall)cJsxAttributeValueAssignment_1_1_3_1.eContents().get(0);
		...
		//[types::IdentifiableElement|JSXIdentifier]
		...
		//JSXIdentifier
		public RuleCall getPropertyIdentifiableElementJSXIdentifierParserRuleCall_0_0_1() { return cPropertyIdentifiableElementJSXIdentifierParserRuleCall_0_0_1; }
		...
		//jsxAttributeValue=JSXElement
		public Assignment getJsxAttributeValueAssignment_1_1_1() { return cJsxAttributeValueAssignment_1_1_1; }
		
		//JSXElement
		public RuleCall getJsxAttributeValueJSXElementParserRuleCall_1_1_1_0() { return cJsxAttributeValueJSXElementParserRuleCall_1_1_1_0; }
		
		//jsxAttributeValue=JSXFragment
		public Assignment getJsxAttributeValueAssignment_1_1_2() { return cJsxAttributeValueAssignment_1_1_2; }
		
		//JSXFragment
		public RuleCall getJsxAttributeValueJSXFragmentParserRuleCall_1_1_2_0() { return cJsxAttributeValueJSXFragmentParserRuleCall_1_1_2_0; }
		
		//('{' jsxAttributeValue=AssignmentExpression<In=false, Yield=false> '}')
		public Group getGroup_1_1_3() { return cGroup_1_1_3; }
		
		//'{'
		public Keyword getLeftCurlyBracketKeyword_1_1_3_0() { return cLeftCurlyBracketKeyword_1_1_3_0; }
		
		//jsxAttributeValue=AssignmentExpression<In=false, Yield=false>
		public Assignment getJsxAttributeValueAssignment_1_1_3_1() { return cJsxAttributeValueAssignment_1_1_3_1; }
		
		//AssignmentExpression<In=false, Yield=false>
		public RuleCall getJsxAttributeValueAssignmentExpressionParserRuleCall_1_1_3_1_0() { return cJsxAttributeValueAssignmentExpressionParserRuleCall_1_1_3_1_0; }
	...
	public class N4ModifierWithoutConstElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
	...
	private final AmbientModuleDeclarationElements pAmbientModuleDeclaration;
	...
	private final FunctionImplWithoutKeywordElements pFunctionImplWithoutKeyword;
	...
	private final TypePredicateDeclarationElements pTypePredicateDeclaration;
	private final TypeReferenceNodeElements pTypeReferenceNode;
	private final TypeReferenceWithModifiersNodeElements pTypeReferenceWithModifiersNode;
	private final ParameterizedTypeRefNominalNodeElements pParameterizedTypeRefNominalNode;
	private final ArrayTypeExpressionNodeElements pArrayTypeExpressionNode;
	...
	private final N4IndexSignatureDeclarationElements pN4IndexSignatureDeclaration;
	...
	public N4JSGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pAmbientModuleDeclaration = new AmbientModuleDeclarationElements();
		...
		this.pFunctionImplWithoutKeyword = new FunctionImplWithoutKeywordElements();
		...
		this.pTypePredicateDeclaration = new TypePredicateDeclarationElements();
		this.pTypeReferenceNode = new TypeReferenceNodeElements();
		this.pTypeReferenceWithModifiersNode = new TypeReferenceWithModifiersNodeElements();
		this.pParameterizedTypeRefNominalNode = new ParameterizedTypeRefNominalNodeElements();
		this.pArrayTypeExpressionNode = new ArrayTypeExpressionNodeElements();
		...
		this.pN4IndexSignatureDeclaration = new N4IndexSignatureDeclarationElements();
...
>>>>>>> 3f5af9ec6 (allow '.'-separated names of namespaces)
	...
	//    '}'
	//;
	public N4NamespaceDeclarationElements getN4NamespaceDeclarationAccess() {
		return pN4NamespaceDeclaration;
	}
	
	public ParserRule getN4NamespaceDeclarationRule() {
	...
	//    '}'
	//;
	public AmbientModuleDeclarationElements getAmbientModuleDeclarationAccess() {
		return pAmbientModuleDeclaration;
	}
	
	public ParserRule getAmbientModuleDeclarationRule() {
		return getAmbientModuleDeclarationAccess().getRule();
	}
	...
	//    )
	//;
	public AnnotatedNamespaceElementElements getAnnotatedNamespaceElementAccess() {
		return pAnnotatedNamespaceElement;
	}
	...
	//|     FunctionHeader<Yield,Generator=false> FunctionBody<Yield=false,Expression>
	//;
	public FunctionImplWithoutKeywordElements getFunctionImplWithoutKeywordAccess() {
		return pFunctionImplWithoutKeyword;
	}
	
	public ParserRule getFunctionImplWithoutKeywordRule() {
		return getFunctionImplWithoutKeywordAccess().getRule();
	}
	...
	//    =>((referringToThis?='this' | fpar=[types::IdentifiableElement|BindingIdentifier<Yield>]) 'is') typeRefNode=TypeReferenceNode
	//;
	public TypePredicateDeclarationElements getTypePredicateDeclarationAccess() {
		return pTypePredicateDeclaration;
	}
	
	public ParserRule getTypePredicateDeclarationRule() {
		return getTypePredicateDeclarationAccess().getRule();
	}
	
	//TypeReferenceNode returns TypeReferenceNode:
	//    typeRefInAST=TypeRef
	//;
	public TypeReferenceNodeElements getTypeReferenceNodeAccess() {
		return pTypeReferenceNode;
	}
	
	public ParserRule getTypeReferenceNodeRule() {
		return getTypeReferenceNodeAccess().getRule();
	}
	
	//TypeReferenceWithModifiersNode returns TypeReferenceNode:
	//    typeRefInAST=TypeRefWithModifiers
	//;
	public TypeReferenceWithModifiersNodeElements getTypeReferenceWithModifiersNodeAccess() {
		return pTypeReferenceWithModifiersNode;
	}
	
	public ParserRule getTypeReferenceWithModifiersNodeRule() {
		return getTypeReferenceWithModifiersNodeAccess().getRule();
	}
	
	//ParameterizedTypeRefNominalNode returns TypeReferenceNode:
	//    typeRefInAST=ParameterizedTypeRefNominal
	//;
	public ParameterizedTypeRefNominalNodeElements getParameterizedTypeRefNominalNodeAccess() {
		return pParameterizedTypeRefNominalNode;
	}
	
	public ParserRule getParameterizedTypeRefNominalNodeRule() {
		return getParameterizedTypeRefNominalNodeAccess().getRule();
	}
	
	//ArrayTypeExpressionNode returns TypeReferenceNode:
	//    typeRefInAST=ArrayTypeExpression
	//;
	public ArrayTypeExpressionNodeElements getArrayTypeExpressionNodeAccess() {
		return pArrayTypeExpressionNode;
	}
	
	public ParserRule getArrayTypeExpressionNodeRule() {
		return getArrayTypeExpressionNodeAccess().getRule();
	}
	...
	public ParserRule getN4TypeAliasDeclarationRule() {
		return getN4TypeAliasDeclarationAccess().getRule();
	}
	...
	public ParserRule getN4IndexSignatureDeclarationRule() {
		return getN4IndexSignatureDeclarationAccess().getRule();
	}
	...
	public TypeExpressionsGrammarAccess.ConditionalTypeRefElements getConditionalTypeRefAccess() {
		return gaTypeExpressions.getConditionalTypeRefAccess();
	}
	...
	//    | ArrayTypeExpression;
	public TypeExpressionsGrammarAccess.OperatorTypeRefElements getOperatorTypeRefAccess() {
		return gaTypeExpressions.getOperatorTypeRefAccess();
	}
	...
	public TypeExpressionsGrammarAccess.TypeOperatorElements getTypeOperatorAccess() {
		return gaTypeExpressions.getTypeOperatorAccess();
	}
	...
	//;
	public TypeExpressionsGrammarAccess.TStructIndexSignatureElements getTStructIndexSignatureAccess() {
		return gaTypeExpressions.getTStructIndexSignatureAccess();
	}
	...
	//;
	public TypeExpressionsGrammarAccess.QueryTypeRefElements getQueryTypeRefAccess() {
		return gaTypeExpressions.getQueryTypeRefAccess();
	}
	...
	//;
	public TypeExpressionsGrammarAccess.TypePredicateElements getTypePredicateAccess() {
		return gaTypeExpressions.getTypePredicateAccess();
	}
	...
	//;
	public TypeExpressionsGrammarAccess.PropertyAccessExpressionInTypeRefElements getPropertyAccessExpressionInTypeRefAccess() {
		return gaTypeExpressions.getPropertyAccessExpressionInTypeRefAccess();
	}
