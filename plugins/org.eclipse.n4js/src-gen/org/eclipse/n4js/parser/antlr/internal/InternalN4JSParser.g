...
@after {
	...
	(
		...
		(
			...
			{
				newCompositeNode(grammarAccess.getScriptElementAccess().getN4TypeAliasDeclarationParserRuleCall_4());
			}
			this_N4TypeAliasDeclaration_4=ruleN4TypeAliasDeclaration
			{
				$current = $this_N4TypeAliasDeclaration_4.current;
				afterParserOrEnumRuleCall();
			}
		)
		    |
		(
			...
			{
				newCompositeNode(grammarAccess.getScriptElementAccess().getImportDeclarationParserRuleCall_5());
			}
			this_ImportDeclaration_5=ruleImportDeclaration
			{
				$current = $this_ImportDeclaration_5.current;
				afterParserOrEnumRuleCall();
			}
		)
		    |
		{
			newCompositeNode(grammarAccess.getScriptElementAccess().getExportDeclarationParserRuleCall_6());
		}
		this_ExportDeclaration_6=ruleExportDeclaration
		{
		    ...
		    |
		{
			newCompositeNode(grammarAccess.getScriptElementAccess().getRootStatementParserRuleCall_7());
		}
		this_RootStatement_7=ruleRootStatement
		{
			$current = $this_RootStatement_7.current;
			afterParserOrEnumRuleCall();
		}
	)
;
		...
		(
				...
				(
					(
						...
						(
							...
							{
								$current = $this_TypeParameters_14.current;
								afterParserOrEnumRuleCall();
							}
						)?
						(
					...
					(
						...
						(
							...
							{
								$current = $this_TypeParameters_21.current;
								afterParserOrEnumRuleCall();
							}
						)?
						(
			...
			(
				...
				(
					...
					{
						$current = $this_TypeParameters_37.current;
						afterParserOrEnumRuleCall();
					}
				)?
	...
	(
		...
		(
			...
			(
				...
				(
					(
						(CommercialAt | Private | Project | Protected | Public | External | Abstract | Static | Const | Class | Interface | Enum | Type | Async | Function | Var | Let)=>
						(
							{
...
@after {
	...
	(
		...
		(
			...
			{
				newCompositeNode(grammarAccess.getExportableElementAccess().getN4TypeAliasDeclarationParserRuleCall_4());
			}
			this_N4TypeAliasDeclaration_4=ruleN4TypeAliasDeclaration
			{
				$current = $this_N4TypeAliasDeclaration_4.current;
		...
		(
			...
			{
				newCompositeNode(grammarAccess.getExportableElementAccess().getFunctionDeclarationParserRuleCall_5());
			}
		    ...
		    |
		{
			newCompositeNode(grammarAccess.getExportableElementAccess().getExportedVariableStatementParserRuleCall_6());
		}
		this_ExportedVariableStatement_6=ruleExportedVariableStatement
		{
			$current = $this_ExportedVariableStatement_6.current;
			afterParserOrEnumRuleCall();
		}
	)
;
		...
		(
				...
				(
					...
					(
						...
						(
							...
							{
								$current = $this_TypeParameters_24.current;
								afterParserOrEnumRuleCall();
							}
						)?
						(
			...
			(
				...
				(
					...
					{
						$current = $this_TypeParameters_40.current;
						afterParserOrEnumRuleCall();
					}
				)?
				otherlv_41=EqualsSign
				{
...
@after {
	...
	(
		(
			...
			{
				$current = $this_FunctionHeader_1.current;
				afterParserOrEnumRuleCall();
			}
			{
				if ($current==null) {
...
entryRuleN4TypeVariable returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getN4TypeVariableRule()); }
	iv_ruleN4TypeVariable=ruleN4TypeVariable
	{ $current=$iv_ruleN4TypeVariable.current; }
	EOF;

// Rule N4TypeVariable
ruleN4TypeVariable returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			...
			(
				...
				(
					(
						lv_variadic_2_0=FullStopFullStopFullStop
						{
		...
		(
			(
				(
					lv_hasInitializerAssignment_5_0=EqualsSign
					{
...
@after {
	...
	(
		...
		{
			$current = $this_ImportCallExpression_5.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ParameterizedCallExpression_6.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_Literal_7.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ArrayLiteral_8.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ObjectLiteral_9.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ParenExpression_10.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_AnnotatedExpression_11.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		(
			...
			{
				$current = $this_AsyncFunctionExpression_13.current;
				afterParserOrEnumRuleCall();
			}
		)
		    |
		...
		{
			$current = $this_N4ClassExpression_14.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_TemplateLiteral_15.current;
			afterParserOrEnumRuleCall();
		}
	)
;
	...
	(
		...
		(
				...
				(
					...
					(
						...
						(
							...
							{
								$current = $this_TypeParameters_18.current;
								afterParserOrEnumRuleCall();
							}
						)?
						(
			...
			(
				...
				otherlv_30=FullStopFullStopFullStop
				{
				...
				(
					(
						...
						(
							...
							{
								$current = $this_MethodParamsAndBody_6.current;
								afterParserOrEnumRuleCall();
							}
						)
					)
					...
					(
						...
						(
							...
							{
								$current = $this_MethodParamsAndBody_8.current;
								afterParserOrEnumRuleCall();
							}
						)
					)
...
entryRulePropertyNameValuePairSingleNamePart returns [EObject current=null]:
	...
	{ $current=$iv_rulePropertyNameValuePairSingleNamePart.current; }
	EOF;

// Rule PropertyNameValuePairSingleNamePart
rulePropertyNameValuePairSingleNamePart returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Rule PropertyNameValuePairSingleNamePart
norm1_PropertyNameValuePairSingleNamePart returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_ArgumentsWithParentheses_3.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleTypeReferenceNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTypeReferenceNodeRule()); }
	iv_ruleTypeReferenceNode=ruleTypeReferenceNode
	{ $current=$iv_ruleTypeReferenceNode.current; }
	EOF;

// Rule TypeReferenceNode
ruleTypeReferenceNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleTypeReferenceWithModifiersNode returns [EObject current=null]:
	...
	{ $current=$iv_ruleTypeReferenceWithModifiersNode.current; }
	EOF;

// Rule TypeReferenceWithModifiersNode
ruleTypeReferenceWithModifiersNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleParameterizedTypeRefNominalNode returns [EObject current=null]:
	...
	{ $current=$iv_ruleParameterizedTypeRefNominalNode.current; }
	EOF;

// Rule ParameterizedTypeRefNominalNode
ruleParameterizedTypeRefNominalNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleArrayTypeExpressionNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getArrayTypeExpressionNodeRule()); }
	iv_ruleArrayTypeExpressionNode=ruleArrayTypeExpressionNode
	{ $current=$iv_ruleArrayTypeExpressionNode.current; }
	EOF;

// Rule ArrayTypeExpressionNode
ruleArrayTypeExpressionNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleImportCallExpression returns [EObject current=null]:
	...
	{ $current=$iv_ruleImportCallExpression.current; }
	EOF;

// Rule ImportCallExpression
ruleImportCallExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Rule ImportCallExpression
norm1_ImportCallExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
		...
		(
			...
			(
				(
					...
					(
						(
							lv_optionalChaining_5_0=QuestionMarkFullStop
							{
					...
					{
						$current = $this_ArgumentsWithParentheses_6.current;
						afterParserOrEnumRuleCall();
					}
				)
				    |
				(
					...
					{
						$current = $this_IndexedAccessExpressionTail_8.current;
						afterParserOrEnumRuleCall();
					}
				)
				    |
				(
					...
					{
						$current = $this_ParameterizedPropertyAccessExpressionTail_10.current;
						afterParserOrEnumRuleCall();
					}
				)
				    |
				(
					(QuestionMarkFullStop | RULE_NO_SUBSTITUTION_TEMPLATE_LITERAL | RULE_TEMPLATE_HEAD)=>
					(
						(
							{
								$current = forceCreateModelElementAndSet(
						...
						(
							(
								lv_optionalChaining_12_0=QuestionMarkFullStop
								{
...
@after {
	...
	(
			...
			(
				...
				(
					...
					(
						...
						(
							(
								lv_optionalChaining_16_0=QuestionMarkFullStop
								{
		...
		(
			...
			{
				$current = $this_PrimaryExpression_18.current;
				afterParserOrEnumRuleCall();
			}
			(
				(
					...
					{
						$current = $this_IndexedAccessExpressionTail_20.current;
						afterParserOrEnumRuleCall();
					}
				)
				    |
				(
					...
					{
						$current = $this_ParameterizedPropertyAccessExpressionTail_22.current;
						afterParserOrEnumRuleCall();
					}
				)
				    |
				(
					...
					(
						(
							lv_optionalChaining_24_0=QuestionMarkFullStop
							{
...
@after {
	...
	(
		(
			(
				lv_optionalChaining_0_0=QuestionMarkFullStop
				{
...
@after {
	...
	(
		(
			...
			(
				(
					lv_optionalChaining_1_0=QuestionMarkFullStop
					{
		...
		(
			...
			{
				$current = $this_ConcreteTypeArguments_2.current;
				afterParserOrEnumRuleCall();
			}
		)?
		(
...
entryRuleCoalesceExpression returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getCoalesceExpressionRule()); }
	iv_ruleCoalesceExpression=ruleCoalesceExpression
	{ $current=$iv_ruleCoalesceExpression.current; }
	EOF;

// Rule CoalesceExpression
ruleCoalesceExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
		...
		(
			(
				...
				(
					...
					otherlv_2=QuestionMarkQuestionMark
					{
...
// Rule CoalesceExpression
norm1_CoalesceExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Rule CoalesceExpression
norm2_CoalesceExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Rule CoalesceExpression
norm3_CoalesceExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_CoalesceExpression_0.current;
			afterParserOrEnumRuleCall();
		}
		(
			(
...
entryRuleAssignmentOperatorOnlyAssign returns [String current=null]:
	...
	{ $current=$iv_ruleAssignmentOperatorOnlyAssign.current.getText(); }
	EOF;

// Rule AssignmentOperatorOnlyAssign
ruleAssignmentOperatorOnlyAssign returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		(
			...
			{
				$current = $this_TypeParameters_4.current;
				afterParserOrEnumRuleCall();
			}
		)?
		(
			...
			{
				$current = $this_ClassExtendsImplements_5.current;
				afterParserOrEnumRuleCall();
			}
		)?
		{
		...
		{
			$current = $this_Members_6.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
// Rule TypeParameters
ruleTypeParameters[EObject in_current]  returns [EObject current=in_current]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		(
			...
			{
				$current = $this_InterfaceExtendsList_5.current;
				afterParserOrEnumRuleCall();
			}
		)?
		{
...
entryRuleN4TypeAliasDeclaration returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getN4TypeAliasDeclarationRule()); }
	iv_ruleN4TypeAliasDeclaration=ruleN4TypeAliasDeclaration
	{ $current=$iv_ruleN4TypeAliasDeclaration.current; }
	EOF;

// Rule N4TypeAliasDeclaration
ruleN4TypeAliasDeclaration returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_N4CallSignatureDeclaration_4.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_N4FieldDeclaration_5.current;
			afterParserOrEnumRuleCall();
		}
	)
;
		...
		(
			...
			(
					...
					(
						...
						(
							(LeftParenthesis)=>
							{
								...
								newCompositeNode(grammarAccess.getAnnotatedN4MemberDeclarationAccess().getMethodParamsReturnAndBodyParserRuleCall_1_3_0_0_1());
							}
							this_MethodParamsReturnAndBody_27=ruleMethodParamsReturnAndBody[$current]
							{
								$current = $this_MethodParamsReturnAndBody_27.current;
								afterParserOrEnumRuleCall();
							}
						)
					)
				...
				(
					...
					{
						newLeafNode(otherlv_28, grammarAccess.getAnnotatedN4MemberDeclarationAccess().getSemicolonKeyword_1_3_1());
					}
				)?
			)
			    |
			(
				...
				this_FieldDeclarationImpl_30=ruleFieldDeclarationImpl[$current]
				{
					$current = $this_FieldDeclarationImpl_30.current;
					afterParserOrEnumRuleCall();
				}
			)
		)
	...
	(
		...
		(
			...
			(
				...
				this_FieldDeclarationImpl_30=norm1_FieldDeclarationImpl[$current]
				{
					$current = $this_FieldDeclarationImpl_30.current;
					afterParserOrEnumRuleCall();
				}
...
@after {
	...
	(
		...
		(
			(
				lv_declaredOptional_2_0=QuestionMark
				{
		...
		(
			...
			{
				$current = $this_ColonSepDeclaredTypeRef_3.current;
				afterParserOrEnumRuleCall();
			}
		)?
		(
		...
		(
			...
			(
				...
				(
					...
					{
						$current = $this_TypeParameters_2.current;
						afterParserOrEnumRuleCall();
					}
				)?
				{
...
@after {
	...
	(
		...
		(
			...
			{
				$current = $this_TStructMemberList_4.current;
				afterParserOrEnumRuleCall();
			}
		)?
	)
...
entryRuleArrayNTypeExpression returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getArrayNTypeExpressionRule()); }
	iv_ruleArrayNTypeExpression=ruleArrayNTypeExpression
	{ $current=$iv_ruleArrayNTypeExpression.current; }
	EOF;

// Rule ArrayNTypeExpression
ruleArrayNTypeExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		(
			...
			{
				$current = $this_ColonSepReturnTypeRef_10.current;
				afterParserOrEnumRuleCall();
			}
		)?
	)
