...
public class ProjectImportEnablingScope implements IScope {
	...
	public Iterable<IEObjectDescription> getElements(QualifiedName name) {
		...
		case PROJECT_IMPORT:
			...
			return getElementsWithDesiredProjectName(mainModule, name.getFirstSegment());
		case COMPLETE_IMPORT:
			return getElementsWithDesiredProjectName(name.skipFirst(1), name.getFirstSegment());
		case SIMPLE_IMPORT:
