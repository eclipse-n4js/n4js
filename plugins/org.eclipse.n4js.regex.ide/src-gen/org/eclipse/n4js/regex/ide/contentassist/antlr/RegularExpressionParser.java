...
public class RegularExpressionParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RegularExpressionGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getLookAheadAccess().getAlternatives_4(), "rule__LookAhead__Alternatives_4");
			...
			builder.put(grammarAccess.getGroupAccess().getAlternatives_2(), "rule__Group__Alternatives_2");
			...
			builder.put(grammarAccess.getGroupAccess().getGroup_2_0(), "rule__Group__Group_2_0__0");
			builder.put(grammarAccess.getGroupAccess().getGroup_2_1(), "rule__Group__Group_2_1__0");
			...
			builder.put(grammarAccess.getLookAheadAccess().getBackwardsAssignment_3(), "rule__LookAhead__BackwardsAssignment_3");
			builder.put(grammarAccess.getLookAheadAccess().getNotAssignment_4_1(), "rule__LookAhead__NotAssignment_4_1");
			builder.put(grammarAccess.getLookAheadAccess().getPatternAssignment_5(), "rule__LookAhead__PatternAssignment_5");
			...
			builder.put(grammarAccess.getGroupAccess().getNamedAssignment_2_0_0(), "rule__Group__NamedAssignment_2_0_0");
			builder.put(grammarAccess.getGroupAccess().getNameAssignment_2_0_2(), "rule__Group__NameAssignment_2_0_2");
			builder.put(grammarAccess.getGroupAccess().getNonCapturingAssignment_2_1_0(), "rule__Group__NonCapturingAssignment_2_1_0");
