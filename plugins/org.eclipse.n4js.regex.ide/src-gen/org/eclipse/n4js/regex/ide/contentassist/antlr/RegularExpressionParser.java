...
public class RegularExpressionParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RegularExpressionGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAbstractLookAheadAccess().getAlternatives_0(), "rule__AbstractLookAhead__Alternatives_0");
			builder.put(grammarAccess.getAbstractLookAheadAccess().getAlternatives_0_0_1(), "rule__AbstractLookAhead__Alternatives_0_0_1");
			builder.put(grammarAccess.getAbstractLookAheadAccess().getAlternatives_0_1_1(), "rule__AbstractLookAhead__Alternatives_0_1_1");
			...
			builder.put(grammarAccess.getCharacterClassAtomAccess().getCharactersAlternatives_1_0(), "rule__CharacterClassAtom__CharactersAlternatives_1_0");
			...
			builder.put(grammarAccess.getGroupAccess().getAlternatives_1(), "rule__Group__Alternatives_1");
			builder.put(grammarAccess.getRegExpIdentifierStartAccess().getAlternatives(), "rule__RegExpIdentifierStart__Alternatives");
			builder.put(grammarAccess.getRegExpIdentifierPartAccess().getAlternatives(), "rule__RegExpIdentifierPart__Alternatives");
			...
			builder.put(grammarAccess.getAbstractLookAheadAccess().getGroup(), "rule__AbstractLookAhead__Group__0");
			builder.put(grammarAccess.getAbstractLookAheadAccess().getGroup_0_0(), "rule__AbstractLookAhead__Group_0_0__0");
			builder.put(grammarAccess.getAbstractLookAheadAccess().getGroup_0_1(), "rule__AbstractLookAhead__Group_0_1__0");
			...
			builder.put(grammarAccess.getRegExpIdentifierNameAccess().getGroup(), "rule__RegExpIdentifierName__Group__0");
			...
			builder.put(grammarAccess.getAbstractLookAheadAccess().getNotAssignment_0_0_1_1(), "rule__AbstractLookAhead__NotAssignment_0_0_1_1");
			builder.put(grammarAccess.getAbstractLookAheadAccess().getNotAssignment_0_1_1_1(), "rule__AbstractLookAhead__NotAssignment_0_1_1_1");
			builder.put(grammarAccess.getAbstractLookAheadAccess().getPatternAssignment_1(), "rule__AbstractLookAhead__PatternAssignment_1");
			...
			builder.put(grammarAccess.getCharacterClassAtomAccess().getCharactersAssignment_1(), "rule__CharacterClassAtom__CharactersAssignment_1");
			builder.put(grammarAccess.getGroupAccess().getNonCapturingAssignment_1_1(), "rule__Group__NonCapturingAssignment_1_1");
			builder.put(grammarAccess.getGroupAccess().getNamedAssignment_1_2_0(), "rule__Group__NamedAssignment_1_2_0");
			builder.put(grammarAccess.getGroupAccess().getNameAssignment_1_2_1(), "rule__Group__NameAssignment_1_2_1");
			builder.put(grammarAccess.getGroupAccess().getPatternAssignment_2(), "rule__Group__PatternAssignment_2");
