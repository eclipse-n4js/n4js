...
fragment RULE_EXPONENT_PART : (('e'|'E') RULE_SIGNED_INT_IN_EXPONENT|RULE_IDENTIFIER);

fragment RULE_SIGNED_INT_IN_EXPONENT : ('+'|'-') RULE_DECIMAL_DIGIT_FRAGMENT+ RULE_IDENTIFIER?;

RULE_SIGNED_INT : ('+'|'-') RULE_INT;

RULE_SIGNED_DOUBLE : ('+'|'-') RULE_DOUBLE;

RULE_SIGNED_BINARY_INT : ('+'|'-') RULE_BINARY_INT;

RULE_SIGNED_OCTAL_INT : ('+'|'-') RULE_OCTAL_INT;

RULE_SIGNED_LEGACY_OCTAL_INT : ('+'|'-') RULE_LEGACY_OCTAL_INT;

RULE_SIGNED_HEX_INT : ('+'|'-') RULE_HEX_INT;

RULE_SIGNED_SCIENTIFIC_INT : ('+'|'-') RULE_SCIENTIFIC_INT;
