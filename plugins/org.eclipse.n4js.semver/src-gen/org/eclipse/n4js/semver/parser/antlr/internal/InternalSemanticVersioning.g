 ...
 */
grammar InternalSemanticVersioning;
...
@after {
	...
	(
		...
		{
			$current = $this_HyphenVersionRange_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_EnumeratedVersionRange_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
// Entry rule entryRuleEnumeratedVersionRange
entryRuleEnumeratedVersionRange returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEnumeratedVersionRangeRule()); }
	iv_ruleEnumeratedVersionRange=ruleEnumeratedVersionRange
	{ $current=$iv_ruleEnumeratedVersionRange.current; }
	EOF;

// Rule EnumeratedVersionRange
ruleEnumeratedVersionRange returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleXr
entryRuleXr returns [String current=null]:
	{ newCompositeNode(grammarAccess.getXrRule()); }
	iv_ruleXr=ruleXr
	{ $current=$iv_ruleXr.current.getText(); }
	EOF;

// Rule Xr
ruleXr returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleParts
entryRuleParts returns [String current=null]:
	{ newCompositeNode(grammarAccess.getPartsRule()); }
	iv_ruleParts=ruleParts
	{ $current=$iv_ruleParts.current.getText(); }
	EOF;

// Rule Parts
ruleParts returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
RULE_PART : ('0'|('1'..'9'|'A'..'Z'|'a'..'z') ('-'|'0'..'9'|'A'..'Z'|'a'..'z')*);
