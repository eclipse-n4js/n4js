 ...
 */
package com.enfore.n4idl.validation;
...
public abstract class AbstractN4IDLValidator extends AbstractDeclarativeValidator {
	
	@Override
	protected List<EPackage> getEPackages() {
		List<EPackage> result = new ArrayList<EPackage>();
		result.add(EPackage.Registry.INSTANCE.getEPackage("http://www.eclipse.org/n4js/n4js/N4JS"));
		result.add(EPackage.Registry.INSTANCE.getEPackage("http://www.numberfour.eu/ide/n4idl/N4IDL"));
