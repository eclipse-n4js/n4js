 ...
 */
package com.enfore.n4idl.services;
...
@Singleton
public class N4IDLGrammarAccess extends AbstractGrammarElementFinder {
	
	public class IDLScriptElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.enfore.n4idl.N4IDL.IDLScript");
	...
	public class VersionDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.enfore.n4idl.N4IDL.VersionDeclaration");
	...
	public class VersionRequestElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.enfore.n4idl.N4IDL.VersionRequest");
		private final Group cGroup = (Group)rule.eContents().get(0);
		private final Keyword cNumberSignKeyword_0 = (Keyword)cGroup.eContents().get(0);
	...
	public class ScriptElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.enfore.n4idl.N4IDL.ScriptElement");
		...
		private final RuleCall cMigrationDeclarationParserRuleCall_6 = (RuleCall)cAlternatives.eContents().get(6);
		
		//@ Override ScriptElement n4js::ScriptElement:
		...
		//N4EnumDeclaration<Yield=false> | ImportDeclaration | ExportDeclaration | MigrationDeclaration
		...
		//MigrationDeclaration
		public RuleCall getMigrationDeclarationParserRuleCall_6() { return cMigrationDeclarationParserRuleCall_6; }
	}
	public class N4ClassDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.enfore.n4idl.N4IDL.N4ClassDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//@ Override N4ClassDeclaration <Yield N4IDLClassDeclaration:
		//	=> ({N4IDLClassDeclaration} declaredModifiers+=N4Modifier*
		//	'class' name=BindingIdentifier<Yield> VersionDeclaration) TypeVariables?
		//	ClassExtendsClause<Yield>?
		//	Members<Yield>;
		@Override public ParserRule getRule() { return rule; }
		
		//=> ({N4IDLClassDeclaration} declaredModifiers+=N4Modifier* 'class' name=BindingIdentifier<Yield> VersionDeclaration)
		//TypeVariables? ClassExtendsClause<Yield>? Members<Yield>
		public Group getGroup() { return cGroup; }
	...
	public class N4InterfaceDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.enfore.n4idl.N4IDL.N4InterfaceDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cGroup.eContents().get(0);
		private final Group cGroup_0_0 = (Group)cGroup_0.eContents().get(0);
		...
		//@ Override N4InterfaceDeclaration <Yield N4IDLInterfaceDeclaration:
		//	=> ({N4IDLInterfaceDeclaration} declaredModifiers+=N4Modifier*
		//	'interface' name=BindingIdentifier<Yield> VersionDeclaration) TypeVariables?
		//	InterfaceImplementsList?
		//	Members<Yield>;
		@Override public ParserRule getRule() { return rule; }
		
		//=> ({N4IDLInterfaceDeclaration} declaredModifiers+=N4Modifier* 'interface' name=BindingIdentifier<Yield>
		//VersionDeclaration) TypeVariables? InterfaceImplementsList? Members<Yield>
		public Group getGroup() { return cGroup; }
		...
		//{N4IDLInterfaceDeclaration} declaredModifiers+=N4Modifier* 'interface' name=BindingIdentifier<Yield> VersionDeclaration
		public Group getGroup_0_0() { return cGroup_0_0; }
	...
	public class N4EnumDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.enfore.n4idl.N4IDL.N4EnumDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cGroup.eContents().get(0);
		private final Group cGroup_0_0 = (Group)cGroup_0.eContents().get(0);
		...
		//@ Override N4EnumDeclaration <Yield N4IDLEnumDeclaration:
		//	=> ({N4IDLEnumDeclaration} declaredModifiers+=N4Modifier*
		//	'enum' name=BindingIdentifier<Yield>? VersionDeclaration)
	...
	public class MigrationDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.enfore.n4idl.N4IDL.MigrationDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IdentifierRefElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.enfore.n4idl.N4IDL.IdentifierRef");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//@ Override IdentifierRef <Yield VersionedIdentifierRef:
	...
	public class ParameterizedTypeRefNominalElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.enfore.n4idl.N4IDL.ParameterizedTypeRefNominal");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//@ Override ParameterizedTypeRefNominal VersionedParameterizedTypeRef:
		//	declaredType=[types::Type|TypeReferenceName] VersionRequest? (=> '<' typeArgs+=TypeArgument (','
	...
	public class NamedImportSpecifierElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.enfore.n4idl.N4IDL.NamedImportSpecifier");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		//@ Override NamedImportSpecifier n4js::NamedImportSpecifier:
	...
	public class VersionedImportIdentifierElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.enfore.n4idl.N4IDL.VersionedImportIdentifier");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	@Inject
	public N4IDLGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("com.enfore.n4idl.N4IDL".equals(grammar.getName())) {
				return grammar;
			}
	...
	//	scriptElements+=super::ScriptElement*;
	...
	//ExportSpecifier:
	//	element=super::IdentifierRef<Yield=false> ('as' alias=IdentifierName)?;
	...
	//ExportableElement:
	//	AnnotatedExportableElement<Yield=false> | super::N4ClassDeclaration<Yield=false> |
	//	super::N4InterfaceDeclaration<Yield=false> | super::N4EnumDeclaration<Yield=false> | FunctionDeclaration<Yield=false>
	...
	//	| '{' (importSpecifiers+=super::NamedImportSpecifier (',' importSpecifiers+=super::NamedImportSpecifier)* ','?)? '}';
	...
	//	ThisLiteral
	//	| SuperLiteral
	//	| super::IdentifierRef<Yield> | ParameterizedCallExpression<Yield> | Literal
	...
	//	identifierRef=super::IdentifierRef<Yield> ('=' expression=AssignmentExpression<In=true,Yield>)?);
	...
	//	target=super::IdentifierRef<Yield> ArgumentsWithParentheses<Yield>;
	...
	//	'extends' (=> superClassRef=super::ParameterizedTypeRefNominal (('implements' | 'extends') ClassImplementsList)?
	...
	//	implementedInterfaceRefs+=super::ParameterizedTypeRefNominal ((',' | 'implements' | 'extends')
	//	implementedInterfaceRefs+=super::ParameterizedTypeRefNominal)*;
	...
	//	('extends' | 'implements') superInterfaceRefs+=super::ParameterizedTypeRefNominal ((',' | 'implements' | 'extends')
	//	superInterfaceRefs+=super::ParameterizedTypeRefNominal)*;
	...
	//	super::ParameterizedTypeRefNominal
	//	| ThisTypeRefNominal
	//	| Wildcard;
	...
	//ParameterizedTypeRef:
	//	super::ParameterizedTypeRefNominal | ParameterizedTypeRefStructural;
