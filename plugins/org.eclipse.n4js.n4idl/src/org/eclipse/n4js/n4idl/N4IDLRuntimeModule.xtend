...
import org.eclipse.n4js.n4idl.validation.N4IDLIssueSeveritiesProvider
...
//	}
	...
	/**
	 * Bind the mechanism to build a version aware helper for locally known types.
	 */
	def Class<? extends LocallyKnownTypesScopingHelper> bindLocallyKnownTypesScopingHelper() {
		return org.eclipse.n4js.n4idl.scoping.utils.MultiMapBasedLocallyKnownTypesScopingHelper;
	}
