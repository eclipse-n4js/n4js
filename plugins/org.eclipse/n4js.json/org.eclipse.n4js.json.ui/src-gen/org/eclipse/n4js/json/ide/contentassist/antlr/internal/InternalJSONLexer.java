...
public class InternalJSONLexer extends Lexer {
    ...
    public final void mRULE_DOUBLE() throws RecognitionException {
        try {
            // InternalJSON.g:1282:22: ( ( '-' )? RULE_DECIMAL_INTEGER_LITERAL_FRAGMENT '.' ( RULE_DECIMAL_DIGIT_FRAGMENT )* ( RULE_EXPONENT_PART )? )
            // InternalJSON.g:1282:24: ( '-' )? RULE_DECIMAL_INTEGER_LITERAL_FRAGMENT '.' ( RULE_DECIMAL_DIGIT_FRAGMENT )* ( RULE_EXPONENT_PART )?
            {
            ...
            match('.'); 
            // InternalJSON.g:1282:71: ( RULE_DECIMAL_DIGIT_FRAGMENT )*
            loop6:
            do {
                int alt6=2;
            ...
            // InternalJSON.g:1282:100: ( RULE_EXPONENT_PART )?
            int alt7=2;
