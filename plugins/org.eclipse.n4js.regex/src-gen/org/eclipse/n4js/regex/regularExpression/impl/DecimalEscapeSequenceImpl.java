 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.n4js.regex.regularExpression.impl.DecimalEscapeSequenceImpl#getCharacters <em>Characters</em>}</li>
 *   <li>{@link org.eclipse.n4js.regex.regularExpression.impl.DecimalEscapeSequenceImpl#getSequence <em>Sequence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DecimalEscapeSequenceImpl extends AtomEscapeImpl implements DecimalEscapeSequence
{
  ...
  public void setCharacters(String newCharacters)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RegularExpressionPackage.DECIMAL_ESCAPE_SEQUENCE__CHARACTERS, oldCharacters, characters));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RegularExpressionPackage.DECIMAL_ESCAPE_SEQUENCE__CHARACTERS:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == CharacterClassAtom.class)
    {
      switch (derivedFeatureID)
      {
        case RegularExpressionPackage.DECIMAL_ESCAPE_SEQUENCE__CHARACTERS: return RegularExpressionPackage.CHARACTER_CLASS_ATOM__CHARACTERS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == CharacterClassAtom.class)
    {
      switch (baseFeatureID)
      {
        case RegularExpressionPackage.CHARACTER_CLASS_ATOM__CHARACTERS: return RegularExpressionPackage.DECIMAL_ESCAPE_SEQUENCE__CHARACTERS;
        default: return -1;
      }
    }
    if (baseClass == EscapedCharacterClassAtom.class)
