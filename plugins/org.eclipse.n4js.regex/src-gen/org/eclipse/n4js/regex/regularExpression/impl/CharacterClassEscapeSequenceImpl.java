 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.n4js.regex.regularExpression.impl.CharacterClassEscapeSequenceImpl#getCharacters <em>Characters</em>}</li>
 *   <li>{@link org.eclipse.n4js.regex.regularExpression.impl.CharacterClassEscapeSequenceImpl#getSequence <em>Sequence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharacterClassEscapeSequenceImpl extends AtomEscapeImpl implements CharacterClassEscapeSequence
{
  ...
  public void setCharacters(String newCharacters)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RegularExpressionPackage.CHARACTER_CLASS_ESCAPE_SEQUENCE__CHARACTERS, oldCharacters, characters));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RegularExpressionPackage.CHARACTER_CLASS_ESCAPE_SEQUENCE__CHARACTERS:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == CharacterClassAtom.class)
    {
      switch (derivedFeatureID)
      {
        case RegularExpressionPackage.CHARACTER_CLASS_ESCAPE_SEQUENCE__CHARACTERS: return RegularExpressionPackage.CHARACTER_CLASS_ATOM__CHARACTERS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == CharacterClassAtom.class)
    {
      switch (baseFeatureID)
      {
        case RegularExpressionPackage.CHARACTER_CLASS_ATOM__CHARACTERS: return RegularExpressionPackage.CHARACTER_CLASS_ESCAPE_SEQUENCE__CHARACTERS;
        default: return -1;
      }
    }
    if (baseClass == EscapedCharacterClassAtom.class)
