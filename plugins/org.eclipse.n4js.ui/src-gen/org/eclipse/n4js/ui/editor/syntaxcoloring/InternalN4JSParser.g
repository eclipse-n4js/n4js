...
(
	...
	(
		...
		(
			(
				(
					...
					(
						TypeParametersParserRuleCall_1_3_0_0_6=ruleTypeParameters{ announce($TypeParametersParserRuleCall_1_3_0_0_6.start, $TypeParametersParserRuleCall_1_3_0_0_6.stop, grammarAccess.getAnnotatedScriptElementAccess().getTypeParametersParserRuleCall_1_3_0_0_6()); }
					)?
					(
				...
				(
					...
					(
						TypeParametersParserRuleCall_1_3_0_1_6=ruleTypeParameters{ announce($TypeParametersParserRuleCall_1_3_0_1_6.start, $TypeParametersParserRuleCall_1_3_0_1_6.stop, grammarAccess.getAnnotatedScriptElementAccess().getTypeParametersParserRuleCall_1_3_0_1_6()); }
					)?
					(
		...
		(
			...
			(
				TypeParametersParserRuleCall_1_5_4=ruleTypeParameters{ announce($TypeParametersParserRuleCall_1_5_4.start, $TypeParametersParserRuleCall_1_5_4.stop, grammarAccess.getAnnotatedScriptElementAccess().getTypeParametersParserRuleCall_1_5_4()); }
			)?
			...
			(
				(
					DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_5_6_0=ruleTypeReferenceNode{
						announce($DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_5_6_0.start, $DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_5_6_0.stop, grammarAccess.getAnnotatedScriptElementAccess().getDeclaredTypeRefNodeAssignment_1_5_6());
					}
				)
			)
		)
...
(
	...
	(
		...
		(
			(
				(
					...
					(
						TypeParametersParserRuleCall_1_2_0_0_5=ruleTypeParameters{ announce($TypeParametersParserRuleCall_1_2_0_0_5.start, $TypeParametersParserRuleCall_1_2_0_0_5.stop, grammarAccess.getAnnotatedExportableElementAccess().getTypeParametersParserRuleCall_1_2_0_0_5()); }
					)?
					(
				...
				(
					...
					(
						TypeParametersParserRuleCall_1_2_0_1_5=ruleTypeParameters{ announce($TypeParametersParserRuleCall_1_2_0_1_5.start, $TypeParametersParserRuleCall_1_2_0_1_5.stop, grammarAccess.getAnnotatedExportableElementAccess().getTypeParametersParserRuleCall_1_2_0_1_5()); }
					)?
					(
		...
		(
			...
			(
				TypeParametersParserRuleCall_1_4_4=ruleTypeParameters{ announce($TypeParametersParserRuleCall_1_4_4.start, $TypeParametersParserRuleCall_1_4_4.stop, grammarAccess.getAnnotatedExportableElementAccess().getTypeParametersParserRuleCall_1_4_4()); }
			)?
			...
			(
				(
					DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_4_6_0=ruleTypeReferenceNode{
						announce($DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_4_6_0.start, $DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_4_6_0.stop, grammarAccess.getAnnotatedExportableElementAccess().getDeclaredTypeRefNodeAssignment_1_4_6());
					}
				)
			)
		)
...
(
	(
		TypeParametersParserRuleCall_0=ruleTypeParameters{ announce($TypeParametersParserRuleCall_0.start, $TypeParametersParserRuleCall_0.stop, grammarAccess.getFunctionHeaderAccess().getTypeParametersParserRuleCall_0()); }
	)?
	(
		(
...
// Entry rule entryRuleN4TypeVariable
entryRuleN4TypeVariable
	:
	ruleN4TypeVariable
	EOF;
		...
		(
			(
				DeclaredCovariantOutKeyword_0_0_0=Out
				 {
					announce($DeclaredCovariantOutKeyword_0_0_0, grammarAccess.getN4TypeVariableAccess().getDeclaredCovariantOutKeyword_0_0_0());
				}
			)
		)
		    |
		(
			(
				DeclaredContravariantInKeyword_0_1_0=In
				 {
					announce($DeclaredContravariantInKeyword_0_1_0, grammarAccess.getN4TypeVariableAccess().getDeclaredContravariantInKeyword_0_1_0());
				}
			)
		)
	)?
	(
		(
			NameIdentifierOrThisParserRuleCall_1_0=ruleIdentifierOrThis{
				announce($NameIdentifierOrThisParserRuleCall_1_0.start, $NameIdentifierOrThisParserRuleCall_1_0.stop, grammarAccess.getN4TypeVariableAccess().getNameAssignment_1());
			}
		)
	)
	(
		ExtendsKeyword_2_0=Extends
		 {
			announce($ExtendsKeyword_2_0, grammarAccess.getN4TypeVariableAccess().getExtendsKeyword_2_0());
		}
		(
			(
				DeclaredUpperBoundNodeTypeReferenceNodeParserRuleCall_2_1_0=ruleTypeReferenceNode{
					announce($DeclaredUpperBoundNodeTypeReferenceNodeParserRuleCall_2_1_0.start, $DeclaredUpperBoundNodeTypeReferenceNodeParserRuleCall_2_1_0.stop, grammarAccess.getN4TypeVariableAccess().getDeclaredUpperBoundNodeAssignment_2_1());
				}
			)
		)
	)?
...
(
	(
		...
		(
			...
			(
				(
					VariadicFullStopFullStopFullStopKeyword_0_1_1_0=FullStopFullStopFullStop
					 {
			...
			(
				(
					NameBindingIdentifierParserRuleCall_0_1_2_0=ruleBindingIdentifier{
						announce($NameBindingIdentifierParserRuleCall_0_1_2_0.start, $NameBindingIdentifierParserRuleCall_0_1_2_0.stop, grammarAccess.getBindingElementFragmentAccess().getNameAssignment_0_1_2());
					}
				)
			)
			(
				ColonSepDeclaredTypeRefParserRuleCall_0_1_3=ruleColonSepDeclaredTypeRef{ announce($ColonSepDeclaredTypeRefParserRuleCall_0_1_3.start, $ColonSepDeclaredTypeRefParserRuleCall_0_1_3.stop, grammarAccess.getBindingElementFragmentAccess().getColonSepDeclaredTypeRefParserRuleCall_0_1_3()); }
			)?
		)
	)
	(
				...
				(
					(
						InitExprLetIdentifierRefParserRuleCall_4_0_0_0_0=ruleLetIdentifierRef{
							announce($InitExprLetIdentifierRefParserRuleCall_4_0_0_0_0.start, $InitExprLetIdentifierRefParserRuleCall_4_0_0_0_0.stop, grammarAccess.getForStatementAccess().getInitExprAssignment_4_0_0_0());
						}
					)
				)
				(
					(
						ForInInKeyword_4_0_0_1_0=In
						 {
				...
				(
					(
						ExpressionExpressionParserRuleCall_4_0_0_2_0=norm1_Expression{
							announce($ExpressionExpressionParserRuleCall_4_0_0_2_0.start, $ExpressionExpressionParserRuleCall_4_0_0_2_0.stop, grammarAccess.getForStatementAccess().getExpressionAssignment_4_0_0_2());
						}
					)
				)
				RightParenthesisKeyword_4_0_0_3=RightParenthesis
				 {
		...
		(
			(
								...
								(
									(
										VarDeclsOrBindingsBindingIdentifierAsVariableDeclarationParserRuleCall_4_1_0_0_1_0_0_0_0=ruleBindingIdentifierAsVariableDeclaration{
											announce($VarDeclsOrBindingsBindingIdentifierAsVariableDeclarationParserRuleCall_4_1_0_0_1_0_0_0_0.start, $VarDeclsOrBindingsBindingIdentifierAsVariableDeclarationParserRuleCall_4_1_0_0_1_0_0_0_0.stop, grammarAccess.getForStatementAccess().getVarDeclsOrBindingsAssignment_4_1_0_0_1_0_0_0());
										}
									)
								)
								(
									(
										(
											ForInInKeyword_4_1_0_0_1_0_0_1_0_0=In
											 {
									...
									(
										(
											ForOfOfKeyword_4_1_0_0_1_0_0_1_1_0=Of
											 {
								...
								(
									...
									(
										ExpressionAssignmentExpressionParserRuleCall_4_1_0_0_1_0_0_2_0=norm1_AssignmentExpression{
											announce($ExpressionAssignmentExpressionParserRuleCall_4_1_0_0_1_0_0_2_0.start, $ExpressionAssignmentExpressionParserRuleCall_4_1_0_0_1_0_0_2_0.stop, grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_0_1_0_0_2());
										}
									)
								)?
							)
							...
							(
								(
									VarDeclsOrBindingsVariableDeclarationOrBindingParserRuleCall_4_1_0_0_1_1_0_0=norm4_VariableDeclarationOrBinding{
										announce($VarDeclsOrBindingsVariableDeclarationOrBindingParserRuleCall_4_1_0_0_1_1_0_0.start, $VarDeclsOrBindingsVariableDeclarationOrBindingParserRuleCall_4_1_0_0_1_1_0_0.stop, grammarAccess.getForStatementAccess().getVarDeclsOrBindingsAssignment_4_1_0_0_1_1_0());
									}
								)
							)
							(
								(
									(
										CommaKeyword_4_1_0_0_1_1_1_0_0_0=Comma
										 {
										...
										(
											(
												VarDeclsOrBindingsVariableDeclarationOrBindingParserRuleCall_4_1_0_0_1_1_1_0_0_1_0=ruleVariableDeclarationOrBinding{
													announce($VarDeclsOrBindingsVariableDeclarationOrBindingParserRuleCall_4_1_0_0_1_1_1_0_0_1_0.start, $VarDeclsOrBindingsVariableDeclarationOrBindingParserRuleCall_4_1_0_0_1_1_1_0_0_1_0.stop, grammarAccess.getForStatementAccess().getVarDeclsOrBindingsAssignment_4_1_0_0_1_1_1_0_0_1());
												}
											)
										)
									)*
									SemicolonKeyword_4_1_0_0_1_1_1_0_1=Semicolon
									 {
									...
									(
										(
											ExpressionExpressionParserRuleCall_4_1_0_0_1_1_1_0_2_0=norm1_Expression{
												announce($ExpressionExpressionParserRuleCall_4_1_0_0_1_1_1_0_2_0.start, $ExpressionExpressionParserRuleCall_4_1_0_0_1_1_1_0_2_0.stop, grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_0_1_1_1_0_2());
											}
										)
									)?
									SemicolonKeyword_4_1_0_0_1_1_1_0_3=Semicolon
									 {
									...
									(
										(
											UpdateExprExpressionParserRuleCall_4_1_0_0_1_1_1_0_4_0=norm1_Expression{
												announce($UpdateExprExpressionParserRuleCall_4_1_0_0_1_1_1_0_4_0.start, $UpdateExprExpressionParserRuleCall_4_1_0_0_1_1_1_0_4_0.stop, grammarAccess.getForStatementAccess().getUpdateExprAssignment_4_1_0_0_1_1_1_0_4());
											}
										)
									)?
								)
								...
								(
									(
										(
											ForInInKeyword_4_1_0_0_1_1_1_1_0_0=In
											 {
									...
									(
										(
											ExpressionExpressionParserRuleCall_4_1_0_0_1_1_1_1_1_0=norm1_Expression{
												announce($ExpressionExpressionParserRuleCall_4_1_0_0_1_1_1_1_1_0.start, $ExpressionExpressionParserRuleCall_4_1_0_0_1_1_1_1_1_0.stop, grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_0_1_1_1_1_1());
											}
										)
									)?
								)
								...
								(
									(
										(
											ForOfOfKeyword_4_1_0_0_1_1_1_2_0_0=Of
											 {
									...
									(
										(
											ExpressionAssignmentExpressionParserRuleCall_4_1_0_0_1_1_1_2_1_0=norm1_AssignmentExpression{
												announce($ExpressionAssignmentExpressionParserRuleCall_4_1_0_0_1_1_1_2_1_0.start, $ExpressionAssignmentExpressionParserRuleCall_4_1_0_0_1_1_1_2_1_0.stop, grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_0_1_1_1_2_1());
											}
										)
									)?
								)
				...
				(
					(
						(
							InitExprExpressionParserRuleCall_4_1_0_1_0_0=ruleExpression{
								announce($InitExprExpressionParserRuleCall_4_1_0_1_0_0.start, $InitExprExpressionParserRuleCall_4_1_0_1_0_0.stop, grammarAccess.getForStatementAccess().getInitExprAssignment_4_1_0_1_0());
							}
						)
					)
					(
						(
							SemicolonKeyword_4_1_0_1_1_0_0=Semicolon
							 {
							...
							(
								(
									ExpressionExpressionParserRuleCall_4_1_0_1_1_0_1_0=norm1_Expression{
										announce($ExpressionExpressionParserRuleCall_4_1_0_1_1_0_1_0.start, $ExpressionExpressionParserRuleCall_4_1_0_1_1_0_1_0.stop, grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_1_1_0_1());
									}
								)
							)?
							SemicolonKeyword_4_1_0_1_1_0_2=Semicolon
							 {
							...
							(
								(
									UpdateExprExpressionParserRuleCall_4_1_0_1_1_0_3_0=norm1_Expression{
										announce($UpdateExprExpressionParserRuleCall_4_1_0_1_1_0_3_0.start, $UpdateExprExpressionParserRuleCall_4_1_0_1_1_0_3_0.stop, grammarAccess.getForStatementAccess().getUpdateExprAssignment_4_1_0_1_1_0_3());
									}
								)
							)?
						)
						...
						(
							(
								(
									ForInInKeyword_4_1_0_1_1_1_0_0=In
									 {
							...
							(
								(
									ExpressionExpressionParserRuleCall_4_1_0_1_1_1_1_0=norm1_Expression{
										announce($ExpressionExpressionParserRuleCall_4_1_0_1_1_1_1_0.start, $ExpressionExpressionParserRuleCall_4_1_0_1_1_1_1_0.stop, grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_1_1_1_1());
									}
								)
							)?
						)
						...
						(
							(
								(
									ForOfOfKeyword_4_1_0_1_1_2_0_0=Of
									 {
							...
							(
								(
									ExpressionAssignmentExpressionParserRuleCall_4_1_0_1_1_2_1_0=norm1_AssignmentExpression{
										announce($ExpressionAssignmentExpressionParserRuleCall_4_1_0_1_1_2_1_0.start, $ExpressionAssignmentExpressionParserRuleCall_4_1_0_1_1_2_1_0.stop, grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_1_1_2_1());
									}
								)
							)?
						)
				    ...
				    |
				(
					SemicolonKeyword_4_1_0_2_0=Semicolon
					 {
					...
					(
						(
							ExpressionExpressionParserRuleCall_4_1_0_2_1_0=norm1_Expression{
								announce($ExpressionExpressionParserRuleCall_4_1_0_2_1_0.start, $ExpressionExpressionParserRuleCall_4_1_0_2_1_0.stop, grammarAccess.getForStatementAccess().getExpressionAssignment_4_1_0_2_1());
							}
						)
					)?
					SemicolonKeyword_4_1_0_2_2=Semicolon
					 {
					...
					(
						(
							UpdateExprExpressionParserRuleCall_4_1_0_2_3_0=norm1_Expression{
								announce($UpdateExprExpressionParserRuleCall_4_1_0_2_3_0.start, $UpdateExprExpressionParserRuleCall_4_1_0_2_3_0.stop, grammarAccess.getForStatementAccess().getUpdateExprAssignment_4_1_0_2_3());
							}
						)
					)?
				)
			)
			RightParenthesisKeyword_4_1_1=RightParenthesis
			 {
	...
	(
		(
			StatementStatementParserRuleCall_5_0=ruleStatement{
				announce($StatementStatementParserRuleCall_5_0.start, $StatementStatementParserRuleCall_5_0.stop, grammarAccess.getForStatementAccess().getStatementAssignment_5());
			}
		)
	)
)
	...
	(
		(
			NameBindingIdentifierParserRuleCall_2_0=ruleBindingIdentifier{
				announce($NameBindingIdentifierParserRuleCall_2_0.start, $NameBindingIdentifierParserRuleCall_2_0.stop, grammarAccess.getCatchVariableAccess().getNameAssignment_2());
			}
		)
	)
)
	...
	(
		(
			(
				...
				(
					(
						(
							DeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_0_0_0_1_0=ruleTypeReferenceWithModifiersNode{
								announce($DeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_0_0_0_1_0.start, $DeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_0_0_0_1_0.stop, grammarAccess.getAnnotatedPropertyAssignmentAccess().getDeclaredTypeRefNodeAssignment_1_0_0_0_1());
							}
						)
					)?
					(
		...
		(
			(
				...
				(
					(
						TypeParametersParserRuleCall_1_3_0_0_1=ruleTypeParameters{ announce($TypeParametersParserRuleCall_1_3_0_0_1.start, $TypeParametersParserRuleCall_1_3_0_0_1.stop, grammarAccess.getAnnotatedPropertyAssignmentAccess().getTypeParametersParserRuleCall_1_3_0_0_1()); }
					)?
					(
						(
							DeclaredReturnTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_3_0_0_2_0=ruleTypeReferenceWithModifiersNode{
								announce($DeclaredReturnTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_3_0_0_2_0.start, $DeclaredReturnTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_3_0_0_2_0.stop, grammarAccess.getAnnotatedPropertyAssignmentAccess().getDeclaredReturnTypeRefNodeAssignment_1_3_0_0_2());
							}
						)
					)?
					(
		...
		(
			(
				(
					DeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_4_1_0=ruleTypeReferenceWithModifiersNode{
						announce($DeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_4_1_0.start, $DeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_1_4_1_0.stop, grammarAccess.getAnnotatedPropertyAssignmentAccess().getDeclaredTypeRefNodeAssignment_1_4_1());
					}
				)
			)?
			(
...
(
	(
		...
		(
			(
				TypeParametersParserRuleCall_0_0_1=ruleTypeParameters{ announce($TypeParametersParserRuleCall_0_0_1.start, $TypeParametersParserRuleCall_0_0_1.stop, grammarAccess.getPropertyMethodDeclarationAccess().getTypeParametersParserRuleCall_0_0_1()); }
			)?
			(
				(
					DeclaredReturnTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_0_0_2_0=ruleTypeReferenceWithModifiersNode{
						announce($DeclaredReturnTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_0_0_2_0.start, $DeclaredReturnTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_0_0_2_0.stop, grammarAccess.getPropertyMethodDeclarationAccess().getDeclaredReturnTypeRefNodeAssignment_0_0_2());
					}
				)
			)?
			AsyncNoTrailingLineBreakParserRuleCall_0_0_3=ruleAsyncNoTrailingLineBreak{ announce($AsyncNoTrailingLineBreakParserRuleCall_0_0_3.start, $AsyncNoTrailingLineBreakParserRuleCall_0_0_3.stop, grammarAccess.getPropertyMethodDeclarationAccess().getAsyncNoTrailingLineBreakParserRuleCall_0_0_3()); }
			(
				(
					(
						(
					...
					(
						(
							DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_0_0_4_0_1_0=ruleLiteralOrComputedPropertyName{
								announce($DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_0_0_4_0_1_0.start, $DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_0_0_4_0_1_0.stop, grammarAccess.getPropertyMethodDeclarationAccess().getDeclaredNameAssignment_0_0_4_0_1());
							}
						)
					)
					(
						...
						MethodParamsAndBodyParserRuleCall_0_0_4_0_2=norm1_MethodParamsAndBody{ announce($MethodParamsAndBodyParserRuleCall_0_0_4_0_2.start, $MethodParamsAndBodyParserRuleCall_0_0_4_0_2.stop, grammarAccess.getPropertyMethodDeclarationAccess().getMethodParamsAndBodyParserRuleCall_0_0_4_0_2()); }
					)
				)
				    |
				(
					(
						(
							DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_0_0_4_1_0_0=ruleLiteralOrComputedPropertyName{
								announce($DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_0_0_4_1_0_0.start, $DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_0_0_4_1_0_0.stop, grammarAccess.getPropertyMethodDeclarationAccess().getDeclaredNameAssignment_0_0_4_1_0());
							}
						)
					)
					(
						...
						MethodParamsAndBodyParserRuleCall_0_0_4_1_1=ruleMethodParamsAndBody{ announce($MethodParamsAndBodyParserRuleCall_0_0_4_1_1.start, $MethodParamsAndBodyParserRuleCall_0_0_4_1_1.stop, grammarAccess.getPropertyMethodDeclarationAccess().getMethodParamsAndBodyParserRuleCall_0_0_4_1_1()); }
					)
				)
			)
		)
...
(
	(
		...
		(
			(
				(
					DeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_0_0_1_0=ruleTypeReferenceWithModifiersNode{
						announce($DeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_0_0_1_0.start, $DeclaredTypeRefNodeTypeReferenceWithModifiersNodeParserRuleCall_0_0_1_0.stop, grammarAccess.getPropertyNameValuePairAccess().getDeclaredTypeRefNodeAssignment_0_0_1());
					}
				)
			)?
			(
...
(
	(
		(
			DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_0_0=ruleTypeReferenceNode{
				announce($DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_0_0.start, $DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_0_0.stop, grammarAccess.getPropertyNameValuePairSingleNameAccess().getDeclaredTypeRefNodeAssignment_0());
			}
		)
	)?
	(
...
(
	...
	(
		(
			OptionalChainingQuestionMarkFullStopKeyword_2_0=QuestionMarkFullStop
			 {
	...
	ArgumentsWithParenthesesParserRuleCall_3=ruleArgumentsWithParentheses{ announce($ArgumentsWithParenthesesParserRuleCall_3.start, $ArgumentsWithParenthesesParserRuleCall_3.stop, grammarAccess.getParameterizedCallExpressionAccess().getArgumentsWithParenthesesParserRuleCall_3()); }
)
;
...
(
	...
	ArgumentsWithParenthesesParserRuleCall_3=norm1_ArgumentsWithParentheses{ announce($ArgumentsWithParenthesesParserRuleCall_3.start, $ArgumentsWithParenthesesParserRuleCall_3.stop, grammarAccess.getParameterizedCallExpressionAccess().getArgumentsWithParenthesesParserRuleCall_3()); }
)
;
...
(
	...
	(
		(
			TypeArgsTypeReferenceNodeParserRuleCall_1_0=ruleTypeReferenceNode{
				announce($TypeArgsTypeReferenceNodeParserRuleCall_1_0.start, $TypeArgsTypeReferenceNodeParserRuleCall_1_0.stop, grammarAccess.getConcreteTypeArgumentsAccess().getTypeArgsAssignment_1());
			}
		)
	)
	(
		...
		(
			(
				TypeArgsTypeReferenceNodeParserRuleCall_2_1_0=ruleTypeReferenceNode{
					announce($TypeArgsTypeReferenceNodeParserRuleCall_2_1_0.start, $TypeArgsTypeReferenceNodeParserRuleCall_2_1_0.stop, grammarAccess.getConcreteTypeArgumentsAccess().getTypeArgsAssignment_2_1());
				}
			)
		)
	)*
...
(
	...
	(
		(
			DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_0=ruleTypeReferenceNode{
				announce($DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_0.start, $DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_1_0.stop, grammarAccess.getColonSepDeclaredTypeRefAccess().getDeclaredTypeRefNodeAssignment_1());
			}
		)
	)
)
...
(
	...
	(
		(
			DeclaredReturnTypeRefNodeTypeReferenceNodeParserRuleCall_1_0=ruleTypeReferenceNode{
				announce($DeclaredReturnTypeRefNodeTypeReferenceNodeParserRuleCall_1_0.start, $DeclaredReturnTypeRefNodeTypeReferenceNodeParserRuleCall_1_0.stop, grammarAccess.getColonSepDeclaredReturnTypeRefAccess().getDeclaredReturnTypeRefNodeAssignment_1());
			}
		)
	)
)
...
// Entry rule entryRuleTypeReferenceNode
entryRuleTypeReferenceNode
	:
...
(
	(
		TypeRefInASTTypeRefParserRuleCall_0=ruleTypeRef{
			announce($TypeRefInASTTypeRefParserRuleCall_0.start, $TypeRefInASTTypeRefParserRuleCall_0.stop, grammarAccess.getTypeReferenceNodeAccess().getTypeRefInASTAssignment());
		}
	)
)
;

// Entry rule entryRuleTypeReferenceWithModifiersNode
entryRuleTypeReferenceWithModifiersNode
	:
	ruleTypeReferenceWithModifiersNode
	EOF;
...
(
	(
		TypeRefInASTTypeRefWithModifiersParserRuleCall_0=ruleTypeRefWithModifiers{
			announce($TypeRefInASTTypeRefWithModifiersParserRuleCall_0.start, $TypeRefInASTTypeRefWithModifiersParserRuleCall_0.stop, grammarAccess.getTypeReferenceWithModifiersNodeAccess().getTypeRefInASTAssignment());
		}
	)
)
;

// Entry rule entryRuleParameterizedTypeRefNominalNode
entryRuleParameterizedTypeRefNominalNode
	:
...
(
	(
		TypeRefInASTParameterizedTypeRefNominalParserRuleCall_0=ruleParameterizedTypeRefNominal{
			announce($TypeRefInASTParameterizedTypeRefNominalParserRuleCall_0.start, $TypeRefInASTParameterizedTypeRefNominalParserRuleCall_0.stop, grammarAccess.getParameterizedTypeRefNominalNodeAccess().getTypeRefInASTAssignment());
		}
	)
)
;

// Entry rule entryRuleArrayTypeExpressionNode
entryRuleArrayTypeExpressionNode
	:
...
(
	(
		TypeRefInASTArrayTypeExpressionParserRuleCall_0=ruleArrayTypeExpression{
			announce($TypeRefInASTArrayTypeExpressionParserRuleCall_0.start, $TypeRefInASTArrayTypeExpressionParserRuleCall_0.stop, grammarAccess.getArrayTypeExpressionNodeAccess().getTypeRefInASTAssignment());
		}
	)
)
;
...
(
	...
	(
		(
			(
				OptionalChainingQuestionMarkFullStopKeyword_1_1_0=QuestionMarkFullStop
				 {
		...
		ArgumentsWithParenthesesParserRuleCall_1_2=ruleArgumentsWithParentheses{ announce($ArgumentsWithParenthesesParserRuleCall_1_2.start, $ArgumentsWithParenthesesParserRuleCall_1_2.stop, grammarAccess.getLeftHandSideExpressionAccess().getArgumentsWithParenthesesParserRuleCall_1_2()); }
		(
			(
				(
					(
						OptionalChainingQuestionMarkFullStopKeyword_1_3_0_1_0=QuestionMarkFullStop
						 {
				...
				ArgumentsWithParenthesesParserRuleCall_1_3_0_2=ruleArgumentsWithParentheses{ announce($ArgumentsWithParenthesesParserRuleCall_1_3_0_2.start, $ArgumentsWithParenthesesParserRuleCall_1_3_0_2.stop, grammarAccess.getLeftHandSideExpressionAccess().getArgumentsWithParenthesesParserRuleCall_1_3_0_2()); }
			)
			    |
			(
				IndexedAccessExpressionTailParserRuleCall_1_3_1_1=ruleIndexedAccessExpressionTail{ announce($IndexedAccessExpressionTailParserRuleCall_1_3_1_1.start, $IndexedAccessExpressionTailParserRuleCall_1_3_1_1.stop, grammarAccess.getLeftHandSideExpressionAccess().getIndexedAccessExpressionTailParserRuleCall_1_3_1_1()); }
			)
			    |
			(
				ParameterizedPropertyAccessExpressionTailParserRuleCall_1_3_2_1=ruleParameterizedPropertyAccessExpressionTail{ announce($ParameterizedPropertyAccessExpressionTailParserRuleCall_1_3_2_1.start, $ParameterizedPropertyAccessExpressionTailParserRuleCall_1_3_2_1.stop, grammarAccess.getLeftHandSideExpressionAccess().getParameterizedPropertyAccessExpressionTailParserRuleCall_1_3_2_1()); }
			)
			    |
			(
				...
				(
					(
						(
							OptionalChainingQuestionMarkFullStopKeyword_1_3_3_0_1_0=QuestionMarkFullStop
							 {
					...
					(
						(
							TemplateTemplateLiteralParserRuleCall_1_3_3_0_2_0=ruleTemplateLiteral{
								announce($TemplateTemplateLiteralParserRuleCall_1_3_3_0_2_0.start, $TemplateTemplateLiteralParserRuleCall_1_3_3_0_2_0.stop, grammarAccess.getLeftHandSideExpressionAccess().getTemplateAssignment_1_3_3_0_2());
							}
						)
					)
				)
...
(
	...
	(
		...
		ArgumentsWithParenthesesParserRuleCall_1_2=norm1_ArgumentsWithParentheses{ announce($ArgumentsWithParenthesesParserRuleCall_1_2.start, $ArgumentsWithParenthesesParserRuleCall_1_2.stop, grammarAccess.getLeftHandSideExpressionAccess().getArgumentsWithParenthesesParserRuleCall_1_2()); }
		(
			(
				(
					(
				...
				ArgumentsWithParenthesesParserRuleCall_1_3_0_2=norm1_ArgumentsWithParentheses{ announce($ArgumentsWithParenthesesParserRuleCall_1_3_0_2.start, $ArgumentsWithParenthesesParserRuleCall_1_3_0_2.stop, grammarAccess.getLeftHandSideExpressionAccess().getArgumentsWithParenthesesParserRuleCall_1_3_0_2()); }
			)
			    |
			(
				IndexedAccessExpressionTailParserRuleCall_1_3_1_1=norm1_IndexedAccessExpressionTail{ announce($IndexedAccessExpressionTailParserRuleCall_1_3_1_1.start, $IndexedAccessExpressionTailParserRuleCall_1_3_1_1.stop, grammarAccess.getLeftHandSideExpressionAccess().getIndexedAccessExpressionTailParserRuleCall_1_3_1_1()); }
			)
			    |
			(
				ParameterizedPropertyAccessExpressionTailParserRuleCall_1_3_2_1=norm1_ParameterizedPropertyAccessExpressionTail{ announce($ParameterizedPropertyAccessExpressionTailParserRuleCall_1_3_2_1.start, $ParameterizedPropertyAccessExpressionTailParserRuleCall_1_3_2_1.stop, grammarAccess.getLeftHandSideExpressionAccess().getParameterizedPropertyAccessExpressionTailParserRuleCall_1_3_2_1()); }
			)
			    |
			(
				(QuestionMarkFullStop | 
		...
		(
			...
			(
				...
				(
					(
						(
							OptionalChainingQuestionMarkFullStopKeyword_1_3_3_2_1_0=QuestionMarkFullStop
							 {
					...
					(
						(
							TemplateTemplateLiteralParserRuleCall_1_3_3_2_2_0=ruleTemplateLiteral{
								announce($TemplateTemplateLiteralParserRuleCall_1_3_3_2_2_0.start, $TemplateTemplateLiteralParserRuleCall_1_3_3_2_2_0.stop, grammarAccess.getMemberExpressionAccess().getTemplateAssignment_1_3_3_2_2());
							}
						)
					)
				)
	...
	(
		...
		(
			...
			(
				(
					(
						OptionalChainingQuestionMarkFullStopKeyword_2_1_2_1_0=QuestionMarkFullStop
						 {
				...
				(
					(
						TemplateTemplateLiteralParserRuleCall_2_1_2_2_0=ruleTemplateLiteral{
							announce($TemplateTemplateLiteralParserRuleCall_2_1_2_2_0.start, $TemplateTemplateLiteralParserRuleCall_2_1_2_2_0.stop, grammarAccess.getMemberExpressionAccess().getTemplateAssignment_2_1_2_2());
						}
					)
				)
			)
...
(
	(
		(
			OptionalChainingQuestionMarkFullStopKeyword_0_0=QuestionMarkFullStop
			 {
	...
	(
		(
			IndexExpressionParserRuleCall_2_0=norm1_Expression{
				announce($IndexExpressionParserRuleCall_2_0.start, $IndexExpressionParserRuleCall_2_0.stop, grammarAccess.getIndexedAccessExpressionTailAccess().getIndexAssignment_2());
			}
		)
	)
	RightSquareBracketKeyword_3=RightSquareBracket
	 {
...
(
	(
		...
		(
			(
				OptionalChainingQuestionMarkFullStopKeyword_0_1_0=QuestionMarkFullStop
				 {
...
(
	...
	(
		...
		(
			(
				TargetTypeRefNodeArrayTypeExpressionNodeParserRuleCall_1_1_0=ruleArrayTypeExpressionNode{
					announce($TargetTypeRefNodeArrayTypeExpressionNodeParserRuleCall_1_1_0.start, $TargetTypeRefNodeArrayTypeExpressionNodeParserRuleCall_1_1_0.stop, grammarAccess.getCastExpressionAccess().getTargetTypeRefNodeAssignment_1_1());
				}
			)
		)
	)?
...
(
	LogicalORExpressionParserRuleCall_0=ruleLogicalORExpression{ announce($LogicalORExpressionParserRuleCall_0.start, $LogicalORExpressionParserRuleCall_0.stop, grammarAccess.getCoalesceExpressionAccess().getLogicalORExpressionParserRuleCall_0()); }
	(
		(
			((
			...
			(
				QuestionMarkQuestionMarkKeyword_1_0_0_1=QuestionMarkQuestionMark
				 {
		...
		(
			(
				DefaultExpressionLogicalORExpressionParserRuleCall_1_1_0=ruleLogicalORExpression{
					announce($DefaultExpressionLogicalORExpressionParserRuleCall_1_1_0.start, $DefaultExpressionLogicalORExpressionParserRuleCall_1_1_0.stop, grammarAccess.getCoalesceExpressionAccess().getDefaultExpressionAssignment_1_1());
				}
			)
		)
	)*
...
(
	LogicalORExpressionParserRuleCall_0=norm1_LogicalORExpression{ announce($LogicalORExpressionParserRuleCall_0.start, $LogicalORExpressionParserRuleCall_0.stop, grammarAccess.getCoalesceExpressionAccess().getLogicalORExpressionParserRuleCall_0()); }
	(
		(
			((
				QuestionMarkQuestionMark
...
(
	LogicalORExpressionParserRuleCall_0=norm2_LogicalORExpression{ announce($LogicalORExpressionParserRuleCall_0.start, $LogicalORExpressionParserRuleCall_0.stop, grammarAccess.getCoalesceExpressionAccess().getLogicalORExpressionParserRuleCall_0()); }
	(
		(
			((
				QuestionMarkQuestionMark
...
(
	LogicalORExpressionParserRuleCall_0=norm3_LogicalORExpression{ announce($LogicalORExpressionParserRuleCall_0.start, $LogicalORExpressionParserRuleCall_0.stop, grammarAccess.getCoalesceExpressionAccess().getLogicalORExpressionParserRuleCall_0()); }
	(
		(
			((
				QuestionMarkQuestionMark
...
(
	CoalesceExpressionParserRuleCall_0=ruleCoalesceExpression{ announce($CoalesceExpressionParserRuleCall_0.start, $CoalesceExpressionParserRuleCall_0.stop, grammarAccess.getConditionalExpressionAccess().getCoalesceExpressionParserRuleCall_0()); }
	(
		(
			((
				QuestionMark
...
(
	CoalesceExpressionParserRuleCall_0=norm1_CoalesceExpression{ announce($CoalesceExpressionParserRuleCall_0.start, $CoalesceExpressionParserRuleCall_0.stop, grammarAccess.getConditionalExpressionAccess().getCoalesceExpressionParserRuleCall_0()); }
	(
		(
			((
				QuestionMark
...
(
	CoalesceExpressionParserRuleCall_0=norm2_CoalesceExpression{ announce($CoalesceExpressionParserRuleCall_0.start, $CoalesceExpressionParserRuleCall_0.stop, grammarAccess.getConditionalExpressionAccess().getCoalesceExpressionParserRuleCall_0()); }
	(
		(
			((
				QuestionMark
...
(
	CoalesceExpressionParserRuleCall_0=norm3_CoalesceExpression{ announce($CoalesceExpressionParserRuleCall_0.start, $CoalesceExpressionParserRuleCall_0.stop, grammarAccess.getConditionalExpressionAccess().getCoalesceExpressionParserRuleCall_0()); }
	(
		(
			((
				QuestionMark
...
(
	(
		TypeRefNodeTypeReferenceNodeParserRuleCall_0=ruleTypeReferenceNode{
			announce($TypeRefNodeTypeReferenceNodeParserRuleCall_0.start, $TypeRefNodeTypeReferenceNodeParserRuleCall_0.stop, grammarAccess.getTypeRefAnnotationArgumentAccess().getTypeRefNodeAssignment());
		}
	)
)
;
...
(
	...
	(
		TypeParametersParserRuleCall_1=ruleTypeParameters{ announce($TypeParametersParserRuleCall_1.start, $TypeParametersParserRuleCall_1.stop, grammarAccess.getN4ClassDeclarationAccess().getTypeParametersParserRuleCall_1()); }
	)?
	(
...
(
	LessThanSignKeyword_0=LessThanSign
	 {
		announce($LessThanSignKeyword_0, grammarAccess.getTypeParametersAccess().getLessThanSignKeyword_0());
	}
	(
		(
			TypeVarsN4TypeVariableParserRuleCall_1_0=ruleN4TypeVariable{
				announce($TypeVarsN4TypeVariableParserRuleCall_1_0.start, $TypeVarsN4TypeVariableParserRuleCall_1_0.stop, grammarAccess.getTypeParametersAccess().getTypeVarsAssignment_1());
			}
		)
	)
	(
		CommaKeyword_2_0=Comma
		 {
			announce($CommaKeyword_2_0, grammarAccess.getTypeParametersAccess().getCommaKeyword_2_0());
		}
		(
			(
				TypeVarsN4TypeVariableParserRuleCall_2_1_0=ruleN4TypeVariable{
					announce($TypeVarsN4TypeVariableParserRuleCall_2_1_0.start, $TypeVarsN4TypeVariableParserRuleCall_2_1_0.stop, grammarAccess.getTypeParametersAccess().getTypeVarsAssignment_2_1());
				}
			)
		)
	)*
	GreaterThanSignKeyword_3=GreaterThanSign
	 {
		announce($GreaterThanSignKeyword_3, grammarAccess.getTypeParametersAccess().getGreaterThanSignKeyword_3());
	}
)
;
...
(
	...
	(
		(
			...
			(
				SuperClassRefParameterizedTypeRefNominalNodeParserRuleCall_1_0_0=ruleParameterizedTypeRefNominalNode{
					announce($SuperClassRefParameterizedTypeRefNominalNodeParserRuleCall_1_0_0.start, $SuperClassRefParameterizedTypeRefNominalNodeParserRuleCall_1_0_0.stop, grammarAccess.getClassExtendsClauseAccess().getSuperClassRefAssignment_1_0());
				}
			)
		)
		    |
...
(
	...
	(
		(
			ImplementedInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_1_0=ruleParameterizedTypeRefNominalNode{
				announce($ImplementedInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_1_0.start, $ImplementedInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_1_0.stop, grammarAccess.getClassImplementsListAccess().getImplementedInterfaceRefsAssignment_1());
			}
		)
	)
	(
		...
		(
			(
				ImplementedInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_2_1_0=ruleParameterizedTypeRefNominalNode{
					announce($ImplementedInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_2_1_0.start, $ImplementedInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_2_1_0.stop, grammarAccess.getClassImplementsListAccess().getImplementedInterfaceRefsAssignment_2_1());
				}
			)
		)
	)*
...
(
	...
	(
		TypeParametersParserRuleCall_1=ruleTypeParameters{ announce($TypeParametersParserRuleCall_1.start, $TypeParametersParserRuleCall_1.stop, grammarAccess.getN4InterfaceDeclarationAccess().getTypeParametersParserRuleCall_1()); }
	)?
	(
...
(
	...
	(
		(
			SuperInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_1_0=ruleParameterizedTypeRefNominalNode{
				announce($SuperInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_1_0.start, $SuperInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_1_0.stop, grammarAccess.getInterfaceExtendsListAccess().getSuperInterfaceRefsAssignment_1());
			}
		)
	)
	(
		...
		(
			(
				SuperInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_2_1_0=ruleParameterizedTypeRefNominalNode{
					announce($SuperInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_2_1_0.start, $SuperInterfaceRefsParameterizedTypeRefNominalNodeParserRuleCall_2_1_0.stop, grammarAccess.getInterfaceExtendsListAccess().getSuperInterfaceRefsAssignment_2_1());
				}
			)
		)
	)*
...
(
	...
	(
		TypeParametersParserRuleCall_1=ruleTypeParameters{ announce($TypeParametersParserRuleCall_1.start, $TypeParametersParserRuleCall_1.stop, grammarAccess.getN4TypeAliasDeclarationAccess().getTypeParametersParserRuleCall_1()); }
	)?
	...
	(
		(
			DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_3_0=ruleTypeReferenceNode{
				announce($DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_3_0.start, $DeclaredTypeRefNodeTypeReferenceNodeParserRuleCall_3_0.stop, grammarAccess.getN4TypeAliasDeclarationAccess().getDeclaredTypeRefNodeAssignment_3());
			}
		)
	)
)
		...
		(
			(
				...
				(
					...
					(
						TypeParametersParserRuleCall_1_2_0_0_2=ruleTypeParameters{ announce($TypeParametersParserRuleCall_1_2_0_0_2.start, $TypeParametersParserRuleCall_1_2_0_0_2.stop, grammarAccess.getAnnotatedN4MemberDeclarationAccess().getTypeParametersParserRuleCall_1_2_0_0_2()); }
					)?
					(
						(
							(
								(
									GeneratorAsteriskKeyword_1_2_0_0_3_0_0_0=Asterisk
									 {
							...
							(
								(
									DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_2_0_0_3_0_1_0=ruleLiteralOrComputedPropertyName{
										announce($DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_2_0_0_3_0_1_0.start, $DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_2_0_0_3_0_1_0.stop, grammarAccess.getAnnotatedN4MemberDeclarationAccess().getDeclaredNameAssignment_1_2_0_0_3_0_1());
									}
								)
							)
							(
							...
							(
								(
									DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_2_0_0_3_1_1_0=ruleLiteralOrComputedPropertyName{
										announce($DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_2_0_0_3_1_1_0.start, $DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_2_0_0_3_1_1_0.stop, grammarAccess.getAnnotatedN4MemberDeclarationAccess().getDeclaredNameAssignment_1_2_0_0_3_1_1());
									}
								)
							)
							(
...
(
	...
	(
		(
			DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_0=ruleLiteralOrComputedPropertyName{
				announce($DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_0.start, $DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_0.stop, grammarAccess.getFieldDeclarationImplAccess().getDeclaredNameAssignment_1());
			}
		)
	)
	(
		(
			DeclaredOptionalQuestionMarkKeyword_2_0=QuestionMark
			 {
	...
	(
		ColonSepDeclaredTypeRefParserRuleCall_3=ruleColonSepDeclaredTypeRef{ announce($ColonSepDeclaredTypeRefParserRuleCall_3.start, $ColonSepDeclaredTypeRefParserRuleCall_3.stop, grammarAccess.getFieldDeclarationImplAccess().getColonSepDeclaredTypeRefParserRuleCall_3()); }
	)?
	(
...
(
	(
		...
		(
			...
			(
				TypeParametersParserRuleCall_0_0_2=ruleTypeParameters{ announce($TypeParametersParserRuleCall_0_0_2.start, $TypeParametersParserRuleCall_0_0_2.stop, grammarAccess.getN4MethodDeclarationAccess().getTypeParametersParserRuleCall_0_0_2()); }
			)?
			AsyncNoTrailingLineBreakParserRuleCall_0_0_3=ruleAsyncNoTrailingLineBreak{ announce($AsyncNoTrailingLineBreakParserRuleCall_0_0_3.start, $AsyncNoTrailingLineBreakParserRuleCall_0_0_3.stop, grammarAccess.getN4MethodDeclarationAccess().getAsyncNoTrailingLineBreakParserRuleCall_0_0_3()); }
			(
				(
					(
						(
				...
				(
					(
						(
							DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_0_0_4_1_0_0=ruleLiteralOrComputedPropertyName{
								announce($DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_0_0_4_1_0_0.start, $DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_0_0_4_1_0_0.stop, grammarAccess.getN4MethodDeclarationAccess().getDeclaredNameAssignment_0_0_4_1_0());
							}
						)
					)
					(
						...
						MethodParamsReturnAndBodyParserRuleCall_0_0_4_1_1=ruleMethodParamsReturnAndBody{ announce($MethodParamsReturnAndBodyParserRuleCall_0_0_4_1_1.start, $MethodParamsReturnAndBodyParserRuleCall_0_0_4_1_1.stop, grammarAccess.getN4MethodDeclarationAccess().getMethodParamsReturnAndBodyParserRuleCall_0_0_4_1_1()); }
					)
				)
			)
		)
...
(
	...
	(
		...
		(
			DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_0=ruleLiteralOrComputedPropertyName{
				announce($DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_0.start, $DeclaredNameLiteralOrComputedPropertyNameParserRuleCall_1_0.stop, grammarAccess.getGetterHeaderAccess().getDeclaredNameAssignment_1());
			}
		)
	)
	(
	...
	(
		ColonSepDeclaredTypeRefParserRuleCall_5=ruleColonSepDeclaredTypeRef{ announce($ColonSepDeclaredTypeRefParserRuleCall_5.start, $ColonSepDeclaredTypeRefParserRuleCall_5.stop, grammarAccess.getGetterHeaderAccess().getColonSepDeclaredTypeRefParserRuleCall_5()); }
	)?
)
;
