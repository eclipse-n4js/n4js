...
public class N4JSParser extends AbstractContentAssistParser {
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			...
			nameMappingsBuilder.put(grammarAccess.getStructuralTypeAndTypeArgumentsAccess().getDeclaredTypeAssignment_1(), "rule__StructuralTypeAndTypeArguments__DeclaredTypeAssignment_1");
