...
public class N4JSParser extends AbstractContentAssistParser {
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			...
			nameMappingsBuilder.put(grammarAccess.getParameterizedTypeRefStructuralAccess().getDeclaredTypeAssignment_0_0_1(), "rule__ParameterizedTypeRefStructural__DeclaredTypeAssignment_0_0_1");
