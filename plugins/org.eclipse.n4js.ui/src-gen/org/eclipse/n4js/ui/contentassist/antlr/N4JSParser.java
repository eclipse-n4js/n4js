...
public class N4JSParser extends AbstractContentAssistParser {
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			...
			nameMappingsBuilder.put(grammarAccess.getIdentifierRefAccess().getGroup(), "rule__IdentifierRef__Group__0");
			...
			nameMappingsBuilder.put(grammarAccess.getN4IDLClassDeclarationAccess().getGroup(), "rule__N4IDLClassDeclaration__Group__0");
			nameMappingsBuilder.put(grammarAccess.getN4IDLClassDeclarationAccess().getGroup_0(), "rule__N4IDLClassDeclaration__Group_0__0");
			nameMappingsBuilder.put(grammarAccess.getN4IDLClassDeclarationAccess().getGroup_0_0(), "rule__N4IDLClassDeclaration__Group_0_0__0");
			...
			nameMappingsBuilder.put(grammarAccess.getN4IDLInterfaceDeclarationAccess().getGroup(), "rule__N4IDLInterfaceDeclaration__Group__0");
			nameMappingsBuilder.put(grammarAccess.getN4IDLInterfaceDeclarationAccess().getGroup_0(), "rule__N4IDLInterfaceDeclaration__Group_0__0");
			nameMappingsBuilder.put(grammarAccess.getN4IDLInterfaceDeclarationAccess().getGroup_0_0(), "rule__N4IDLInterfaceDeclaration__Group_0_0__0");
			...
			nameMappingsBuilder.put(grammarAccess.getN4IDLEnumDeclarationAccess().getGroup(), "rule__N4IDLEnumDeclaration__Group__0");
			nameMappingsBuilder.put(grammarAccess.getN4IDLEnumDeclarationAccess().getGroup_0(), "rule__N4IDLEnumDeclaration__Group_0__0");
			nameMappingsBuilder.put(grammarAccess.getN4IDLEnumDeclarationAccess().getGroup_0_0(), "rule__N4IDLEnumDeclaration__Group_0_0__0");
			nameMappingsBuilder.put(grammarAccess.getN4IDLEnumDeclarationAccess().getGroup_2(), "rule__N4IDLEnumDeclaration__Group_2__0");
			nameMappingsBuilder.put(grammarAccess.getN4IDLEnumDeclarationAccess().getGroup_2_1(), "rule__N4IDLEnumDeclaration__Group_2_1__0");
			...
			nameMappingsBuilder.put(grammarAccess.getParameterizedTypeRefStructuralAccess().getGroup_1(), "rule__ParameterizedTypeRefStructural__Group_1__0");
			nameMappingsBuilder.put(grammarAccess.getTypeAndTypeArgumentsAccess().getGroup(), "rule__TypeAndTypeArguments__Group__0");
			nameMappingsBuilder.put(grammarAccess.getStructuralTypeAndTypeArgumentsAccess().getGroup(), "rule__StructuralTypeAndTypeArguments__Group__0");
			...
			nameMappingsBuilder.put(grammarAccess.getN4IDLClassDeclarationAccess().getDeclaredModifiersAssignment_0_0_1(), "rule__N4IDLClassDeclaration__DeclaredModifiersAssignment_0_0_1");
			nameMappingsBuilder.put(grammarAccess.getN4IDLClassDeclarationAccess().getTypingStrategyAssignment_0_0_3(), "rule__N4IDLClassDeclaration__TypingStrategyAssignment_0_0_3");
			nameMappingsBuilder.put(grammarAccess.getN4IDLClassDeclarationAccess().getNameAssignment_0_0_4(), "rule__N4IDLClassDeclaration__NameAssignment_0_0_4");
			...
			nameMappingsBuilder.put(grammarAccess.getN4IDLInterfaceDeclarationAccess().getDeclaredModifiersAssignment_0_0_1(), "rule__N4IDLInterfaceDeclaration__DeclaredModifiersAssignment_0_0_1");
			nameMappingsBuilder.put(grammarAccess.getN4IDLInterfaceDeclarationAccess().getTypingStrategyAssignment_0_0_3(), "rule__N4IDLInterfaceDeclaration__TypingStrategyAssignment_0_0_3");
			nameMappingsBuilder.put(grammarAccess.getN4IDLInterfaceDeclarationAccess().getNameAssignment_0_0_4(), "rule__N4IDLInterfaceDeclaration__NameAssignment_0_0_4");
			...
			nameMappingsBuilder.put(grammarAccess.getN4IDLEnumDeclarationAccess().getDeclaredModifiersAssignment_0_0_1(), "rule__N4IDLEnumDeclaration__DeclaredModifiersAssignment_0_0_1");
			nameMappingsBuilder.put(grammarAccess.getN4IDLEnumDeclarationAccess().getNameAssignment_0_0_3(), "rule__N4IDLEnumDeclaration__NameAssignment_0_0_3");
			nameMappingsBuilder.put(grammarAccess.getN4IDLEnumDeclarationAccess().getLiteralsAssignment_2_0(), "rule__N4IDLEnumDeclaration__LiteralsAssignment_2_0");
			nameMappingsBuilder.put(grammarAccess.getN4IDLEnumDeclarationAccess().getLiteralsAssignment_2_1_1(), "rule__N4IDLEnumDeclaration__LiteralsAssignment_2_1_1");
			...
			nameMappingsBuilder.put(grammarAccess.getStructuralTypeAndTypeArgumentsAccess().getDefinedTypingStrategyAssignment_0(), "rule__StructuralTypeAndTypeArguments__DefinedTypingStrategyAssignment_0");
			nameMappingsBuilder.put(grammarAccess.getDeclaredTypeAccess().getDeclaredTypeAssignment(), "rule__DeclaredType__DeclaredTypeAssignment");
