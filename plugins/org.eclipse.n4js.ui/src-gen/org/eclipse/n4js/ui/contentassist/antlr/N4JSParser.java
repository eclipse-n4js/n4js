...
public class N4JSParser extends AbstractContentAssistParser {
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			...
			nameMappingsBuilder.put(grammarAccess.getTypeAndTypeArgumentsAccess().getAlternatives_0(), "rule__TypeAndTypeArguments__Alternatives_0");
			nameMappingsBuilder.put(grammarAccess.getStructuralTypeAndTypeArgumentsAccess().getAlternatives_0(), "rule__StructuralTypeAndTypeArguments__Alternatives_0");
			...
			nameMappingsBuilder.put(grammarAccess.getStructuralTypeAndTypeArgumentsAccess().getGroup_0_0(), "rule__StructuralTypeAndTypeArguments__Group_0_0__0");
			nameMappingsBuilder.put(grammarAccess.getStructuralTypeAndTypeArgumentsAccess().getGroup_0_1(), "rule__StructuralTypeAndTypeArguments__Group_0_1__0");
			...
			nameMappingsBuilder.put(grammarAccess.getStructuralTypeAndTypeArgumentsAccess().getDefinedTypingStrategyAssignment_0_0_0(), "rule__StructuralTypeAndTypeArguments__DefinedTypingStrategyAssignment_0_0_0");
			nameMappingsBuilder.put(grammarAccess.getStructuralTypeAndTypeArgumentsAccess().getDeclaredTypeAssignment_0_0_1(), "rule__StructuralTypeAndTypeArguments__DeclaredTypeAssignment_0_0_1");
			nameMappingsBuilder.put(grammarAccess.getStructuralTypeAndTypeArgumentsAccess().getDefinedTypingStrategyAssignment_0_1_1(), "rule__StructuralTypeAndTypeArguments__DefinedTypingStrategyAssignment_0_1_1");
			nameMappingsBuilder.put(grammarAccess.getStructuralTypeAndTypeArgumentsAccess().getDeclaredTypeAssignment_0_1_2(), "rule__StructuralTypeAndTypeArguments__DeclaredTypeAssignment_0_1_2");
