		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTAGAccess().getAlternatives_0(), "rule__TAG__Alternatives_0");
					...
					put(grammarAccess.getSimpleVersionAccess().getWithLetterVAssignment_2(), "rule__SimpleVersion__WithLetterVAssignment_2");
