...
public class N4NamespaceDeclarationImpl extends N4TypeDefinitionImpl implements N4NamespaceDeclaration {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == ExportableElement.class) {
			switch (baseOperationID) {
				case N4JSPackage.EXPORTABLE_ELEMENT___IS_DIRECTLY_EXPORTED: return N4JSPackage.N4_NAMESPACE_DECLARATION___IS_DIRECTLY_EXPORTED;
				...
				case N4JSPackage.EXPORTABLE_ELEMENT___GET_DIRECTLY_EXPORTED_NAME: return N4JSPackage.N4_NAMESPACE_DECLARATION___GET_DIRECTLY_EXPORTED_NAME;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case N4JSPackage.N4_NAMESPACE_DECLARATION___IS_DIRECTLY_EXPORTED:
			...
			case N4JSPackage.N4_NAMESPACE_DECLARATION___GET_DIRECTLY_EXPORTED_NAME:
