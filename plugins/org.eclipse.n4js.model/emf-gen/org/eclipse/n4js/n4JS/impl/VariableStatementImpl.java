...
public class VariableStatementImpl extends StatementImpl implements VariableStatement {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == ExportableElement.class) {
			switch (baseOperationID) {
				case N4JSPackage.EXPORTABLE_ELEMENT___IS_DIRECTLY_EXPORTED: return N4JSPackage.VARIABLE_STATEMENT___IS_DIRECTLY_EXPORTED;
				...
				case N4JSPackage.EXPORTABLE_ELEMENT___GET_DIRECTLY_EXPORTED_NAME: return N4JSPackage.VARIABLE_STATEMENT___GET_DIRECTLY_EXPORTED_NAME;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case N4JSPackage.VARIABLE_STATEMENT___IS_DIRECTLY_EXPORTED:
			...
			case N4JSPackage.VARIABLE_STATEMENT___GET_DIRECTLY_EXPORTED_NAME:
