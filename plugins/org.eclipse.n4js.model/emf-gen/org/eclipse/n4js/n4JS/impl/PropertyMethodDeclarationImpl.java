...
public class PropertyMethodDeclarationImpl extends AnnotablePropertyAssignmentImpl implements PropertyMethodDeclaration {
	...
	public TVariable getImplicitArgumentsVariable() {
		if (implicitArgumentsVariable != null && implicitArgumentsVariable.eIsProxy()) {
			...
			if (implicitArgumentsVariable != oldImplicitArgumentsVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, N4JSPackage.PROPERTY_METHOD_DECLARATION__IMPLICIT_ARGUMENTS_VARIABLE, oldImplicitArgumentsVariable, implicitArgumentsVariable));
			}
		}
	...
	public void setImplicitArgumentsVariable(TVariable newImplicitArgumentsVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, N4JSPackage.PROPERTY_METHOD_DECLARATION__IMPLICIT_ARGUMENTS_VARIABLE, oldImplicitArgumentsVariable, implicitArgumentsVariable));
	}
	...
	public NotificationChain basicSetDeclaredReturnTypeRefNode(TypeReferenceNode<TypeRef> newDeclaredReturnTypeRefNode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, N4JSPackage.PROPERTY_METHOD_DECLARATION__DECLARED_RETURN_TYPE_REF_NODE, oldDeclaredReturnTypeRefNode, newDeclaredReturnTypeRefNode);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDeclaredReturnTypeRefNode(TypeReferenceNode<TypeRef> newDeclaredReturnTypeRefNode) {
		if (newDeclaredReturnTypeRefNode != declaredReturnTypeRefNode) {
			...
			if (declaredReturnTypeRefNode != null)
				msgs = ((InternalEObject)declaredReturnTypeRefNode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - N4JSPackage.PROPERTY_METHOD_DECLARATION__DECLARED_RETURN_TYPE_REF_NODE, null, msgs);
			if (newDeclaredReturnTypeRefNode != null)
				msgs = ((InternalEObject)newDeclaredReturnTypeRefNode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - N4JSPackage.PROPERTY_METHOD_DECLARATION__DECLARED_RETURN_TYPE_REF_NODE, null, msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == FunctionOrFieldAccessor.class) {
			switch (derivedFeatureID) {
				...
				case N4JSPackage.PROPERTY_METHOD_DECLARATION__IMPLICIT_ARGUMENTS_VARIABLE: return N4JSPackage.FUNCTION_OR_FIELD_ACCESSOR__IMPLICIT_ARGUMENTS_VARIABLE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == FunctionOrFieldAccessor.class) {
			switch (baseFeatureID) {
				...
				case N4JSPackage.FUNCTION_OR_FIELD_ACCESSOR__IMPLICIT_ARGUMENTS_VARIABLE: return N4JSPackage.PROPERTY_METHOD_DECLARATION__IMPLICIT_ARGUMENTS_VARIABLE;
				default: return -1;
			}
		}
		if (baseClass == TypeDefiningElement.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case N4JSPackage.PROPERTY_METHOD_DECLARATION___GET_DECLARED_RETURN_TYPE_REF:
				return getDeclaredReturnTypeRef();
			case N4JSPackage.PROPERTY_METHOD_DECLARATION___GET_DECLARED_RETURN_TYPE_REF_IN_AST:
