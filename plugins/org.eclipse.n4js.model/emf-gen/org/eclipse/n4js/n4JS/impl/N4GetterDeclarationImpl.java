...
public class N4GetterDeclarationImpl extends GetterDeclarationImpl implements N4GetterDeclaration {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == ModifiableElement.class) {
			switch (baseOperationID) {
				case N4JSPackage.MODIFIABLE_ELEMENT___IS_EXTERNAL: return N4JSPackage.N4_GETTER_DECLARATION___IS_EXTERNAL;
				case N4JSPackage.MODIFIABLE_ELEMENT___IS_DECLARED_EXTERNAL: return N4JSPackage.N4_GETTER_DECLARATION___IS_DECLARED_EXTERNAL;
				case N4JSPackage.MODIFIABLE_ELEMENT___IS_DEFAULT_EXTERNAL: return N4JSPackage.N4_GETTER_DECLARATION___IS_DEFAULT_EXTERNAL;
				default: return -1;
			}
		}
		if (baseClass == N4MemberDeclaration.class) {
			switch (baseOperationID) {
				...
				case N4JSPackage.N4_MEMBER_DECLARATION___IS_CONSTRUCT_SIGNATURE: return N4JSPackage.N4_GETTER_DECLARATION___IS_CONSTRUCT_SIGNATURE;
				default: return -1;
			}
		}
		if (baseClass == AnnotableN4MemberDeclaration.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case N4JSPackage.N4_GETTER_DECLARATION___IS_CONSTRUCT_SIGNATURE:
				return isConstructSignature();
			case N4JSPackage.N4_GETTER_DECLARATION___IS_EXTERNAL:
				return isExternal();
			case N4JSPackage.N4_GETTER_DECLARATION___IS_DECLARED_EXTERNAL:
				return isDeclaredExternal();
			case N4JSPackage.N4_GETTER_DECLARATION___IS_DEFAULT_EXTERNAL:
