...
public class ProjectDescriptionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProjectDescriptionPackage.PROJECT_DESCRIPTION: {
			...
			case ProjectDescriptionPackage.SOURCE_CONTAINER_DESCRIPTION: {
			...
			case ProjectDescriptionPackage.MODULE_FILTER: {
				ModuleFilter moduleFilter = (ModuleFilter)theEObject;
				T result = caseModuleFilter(moduleFilter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProjectDescriptionPackage.MODULE_FILTER_SPECIFIER: {
			...
			case ProjectDescriptionPackage.BOOTSTRAP_MODULE: {
