 ...
 */
package org.eclipse.n4js.json.services;
...
public class JSONGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class JSONObjectElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cNameValuePairsAssignment_0_1 = (Assignment)cGroup_0.eContents().get(1);
		private final RuleCall cNameValuePairsNameValuePairParserRuleCall_0_1_0 = (RuleCall)cNameValuePairsAssignment_0_1.eContents().get(0);
		private final Group cGroup_0_2 = (Group)cGroup_0.eContents().get(2);
		private final Keyword cCommaKeyword_0_2_0 = (Keyword)cGroup_0_2.eContents().get(0);
		private final Assignment cNameValuePairsAssignment_0_2_1 = (Assignment)cGroup_0_2.eContents().get(1);
		private final RuleCall cNameValuePairsNameValuePairParserRuleCall_0_2_1_0 = (RuleCall)cNameValuePairsAssignment_0_2_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_0_3 = (Keyword)cGroup_0.eContents().get(3);
		private final Group cGroup_1 = (Group)cAlternatives.eContents().get(1);
		private final Action cJSONObjectAction_1_0 = (Action)cGroup_1.eContents().get(0);
		...
		//'{' nameValuePairs+=NameValuePair (',' nameValuePairs+=NameValuePair)* '}' | {JSONObject} '{' '}'
		...
		public Assignment getNameValuePairsAssignment_0_1() { return cNameValuePairsAssignment_0_1; }
		
		//NameValuePair
		public RuleCall getNameValuePairsNameValuePairParserRuleCall_0_1_0() { return cNameValuePairsNameValuePairParserRuleCall_0_1_0; }
		...
		//nameValuePairs+=NameValuePair
		public Assignment getNameValuePairsAssignment_0_2_1() { return cNameValuePairsAssignment_0_2_1; }
		
		//NameValuePair
		public RuleCall getNameValuePairsNameValuePairParserRuleCall_0_2_1_0() { return cNameValuePairsNameValuePairParserRuleCall_0_2_1_0; }
		...
		//{JSONObject}
		public Action getJSONObjectAction_1_0() { return cJSONObjectAction_1_0; }
	...
	public class JSONArrayElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.json.JSON.JSONArray");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
		...
		private final RuleCall cElementsJSONValueParserRuleCall_0_1_0 = (RuleCall)cElementsAssignment_0_1.eContents().get(0);
		private final Group cGroup_0_2 = (Group)cGroup_0.eContents().get(2);
		private final Keyword cCommaKeyword_0_2_0 = (Keyword)cGroup_0_2.eContents().get(0);
		private final Assignment cElementsAssignment_0_2_1 = (Assignment)cGroup_0_2.eContents().get(1);
		private final RuleCall cElementsJSONValueParserRuleCall_0_2_1_0 = (RuleCall)cElementsAssignment_0_2_1.eContents().get(0);
		private final Keyword cRightSquareBracketKeyword_0_3 = (Keyword)cGroup_0.eContents().get(3);
		private final Group cGroup_1 = (Group)cAlternatives.eContents().get(1);
		private final Action cJSONArrayAction_1_0 = (Action)cGroup_1.eContents().get(0);
		...
		//'[' elements+=JSONValue (',' elements+=JSONValue)* ']' | {JSONArray} '[' ']'
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//JSONValue
		public RuleCall getElementsJSONValueParserRuleCall_0_1_0() { return cElementsJSONValueParserRuleCall_0_1_0; }
		...
		//JSONValue
		public RuleCall getElementsJSONValueParserRuleCall_0_2_1_0() { return cElementsJSONValueParserRuleCall_0_2_1_0; }
		...
		//{JSONArray}
		public Action getJSONArrayAction_1_0() { return cJSONArrayAction_1_0; }
	...
	public class JSONValueElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cJSONStringLiteralParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		private final RuleCall cJSONNumericLiteralParserRuleCall_3 = (RuleCall)cAlternatives.eContents().get(3);
		private final RuleCall cJSONNullLiteralParserRuleCall_4 = (RuleCall)cAlternatives.eContents().get(4);
		private final RuleCall cJSONBooleanLiteralParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		...
		//JSONObject | JSONArray | JSONStringLiteral | JSONNumericLiteral | JSONNullLiteral | JSONBooleanLiteral
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//JSONStringLiteral
		public RuleCall getJSONStringLiteralParserRuleCall_2() { return cJSONStringLiteralParserRuleCall_2; }
		
		//JSONNumericLiteral
		public RuleCall getJSONNumericLiteralParserRuleCall_3() { return cJSONNumericLiteralParserRuleCall_3; }
		
		//JSONNullLiteral
		public RuleCall getJSONNullLiteralParserRuleCall_4() { return cJSONNullLiteralParserRuleCall_4; }
		
		//JSONBooleanLiteral
		public RuleCall getJSONBooleanLiteralParserRuleCall_5() { return cJSONBooleanLiteralParserRuleCall_5; }
	}
	public class JSONStringLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.json.JSON.JSONStringLiteral");
	...
	public class JSONNumericLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.json.JSON.JSONNumericLiteral");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class JSONBooleanLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.json.JSON.JSONBooleanLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cJSONBooleanLiteralAction_0 = (Action)cGroup.eContents().get(0);
		...
		//{JSONBooleanLiteral}
		public Action getJSONBooleanLiteralAction_0() { return cJSONBooleanLiteralAction_0; }
	...
	public class JSONNullLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.n4js.json.JSON.JSONNullLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cJSONNullLiteralAction_0 = (Action)cGroup.eContents().get(0);
		...
		//{JSONNullLiteral}
		public Action getJSONNullLiteralAction_0() { return cJSONNullLiteralAction_0; }
	...
	private final JSONStringLiteralElements pJSONStringLiteral;
	private final JSONNumericLiteralElements pJSONNumericLiteral;
	private final JSONBooleanLiteralElements pJSONBooleanLiteral;
	private final JSONNullLiteralElements pJSONNullLiteral;
	...
	public JSONGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pJSONStringLiteral = new JSONStringLiteralElements();
		this.pJSONNumericLiteral = new JSONNumericLiteralElements();
		this.pJSONBooleanLiteral = new JSONBooleanLiteralElements();
		this.pJSONNullLiteral = new JSONNullLiteralElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.eclipse.n4js.json.JSON".equals(grammar.getName())) {
				return grammar;
			}
	...
	//JSONStringLiteral:
	//	value=STRING;
	public JSONStringLiteralElements getJSONStringLiteralAccess() {
		return pJSONStringLiteral;
	}
	
	public ParserRule getJSONStringLiteralRule() {
		return getJSONStringLiteralAccess().getRule();
	}
	
	//JSONNumericLiteral:
	//	value=NUMBER;
	public JSONNumericLiteralElements getJSONNumericLiteralAccess() {
		return pJSONNumericLiteral;
	}
	
	public ParserRule getJSONNumericLiteralRule() {
		return getJSONNumericLiteralAccess().getRule();
	}
	
	//JSONBooleanLiteral:
	//	{JSONBooleanLiteral} (booleanValue?='true' | 'false');
	public JSONBooleanLiteralElements getJSONBooleanLiteralAccess() {
		return pJSONBooleanLiteral;
	}
	
	public ParserRule getJSONBooleanLiteralRule() {
		return getJSONBooleanLiteralAccess().getRule();
	}
	
	//JSONNullLiteral:
	//	{JSONNullLiteral} 'null';
	public JSONNullLiteralElements getJSONNullLiteralAccess() {
		return pJSONNullLiteral;
	}
	
	public ParserRule getJSONNullLiteralRule() {
		return getJSONNullLiteralAccess().getRule();
	}
