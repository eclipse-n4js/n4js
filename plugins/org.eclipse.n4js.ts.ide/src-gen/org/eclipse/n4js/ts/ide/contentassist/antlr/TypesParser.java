...
public class TypesParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TypesGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTClassAccess().getAlternatives_4(), "rule__TClass__Alternatives_4");
			...
			builder.put(grammarAccess.getTClassAccess().getGroup_5(), "rule__TClass__Group_5__0");
			builder.put(grammarAccess.getTClassAccess().getGroup_6(), "rule__TClass__Group_6__0");
			builder.put(grammarAccess.getTClassAccess().getGroup_6_2(), "rule__TClass__Group_6_2__0");
			...
			builder.put(grammarAccess.getTClassAccess().getExternalAssignment_4_0_0(), "rule__TClass__ExternalAssignment_4_0_0");
			builder.put(grammarAccess.getTClassAccess().getNameAssignment_4_0_1(), "rule__TClass__NameAssignment_4_0_1");
			builder.put(grammarAccess.getTClassAccess().getSuperClassRefAssignment_5_1(), "rule__TClass__SuperClassRefAssignment_5_1");
			builder.put(grammarAccess.getTClassAccess().getImplementedInterfaceRefsAssignment_6_1(), "rule__TClass__ImplementedInterfaceRefsAssignment_6_1");
			builder.put(grammarAccess.getTClassAccess().getImplementedInterfaceRefsAssignment_6_2_1(), "rule__TClass__ImplementedInterfaceRefsAssignment_6_2_1");
			builder.put(grammarAccess.getTClassAccess().getDeclaredElementTypeAssignment_7_1(), "rule__TClass__DeclaredElementTypeAssignment_7_1");
			...
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getAstValueAssignment_1_3(), "rule__NumericLiteralTypeRef__AstValueAssignment_1_3");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getAstValueAssignment_1_4(), "rule__NumericLiteralTypeRef__AstValueAssignment_1_4");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getAstValueAssignment_1_5(), "rule__NumericLiteralTypeRef__AstValueAssignment_1_5");
