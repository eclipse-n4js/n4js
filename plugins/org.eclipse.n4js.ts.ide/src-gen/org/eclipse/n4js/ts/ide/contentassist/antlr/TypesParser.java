...
public class TypesParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TypesGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getAlternatives(), "rule__NumericLiteralTypeRef__Alternatives");
			...
			builder.put(grammarAccess.getBooleanLiteralTypeRefAccess().getValueAssignment_1_0(), "rule__BooleanLiteralTypeRef__ValueAssignment_1_0");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_0(), "rule__NumericLiteralTypeRef__ValueAssignment_0");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_1(), "rule__NumericLiteralTypeRef__ValueAssignment_1");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_2(), "rule__NumericLiteralTypeRef__ValueAssignment_2");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_3(), "rule__NumericLiteralTypeRef__ValueAssignment_3");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_4(), "rule__NumericLiteralTypeRef__ValueAssignment_4");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_5(), "rule__NumericLiteralTypeRef__ValueAssignment_5");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_6(), "rule__NumericLiteralTypeRef__ValueAssignment_6");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_7(), "rule__NumericLiteralTypeRef__ValueAssignment_7");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_8(), "rule__NumericLiteralTypeRef__ValueAssignment_8");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_9(), "rule__NumericLiteralTypeRef__ValueAssignment_9");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_10(), "rule__NumericLiteralTypeRef__ValueAssignment_10");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_11(), "rule__NumericLiteralTypeRef__ValueAssignment_11");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_12(), "rule__NumericLiteralTypeRef__ValueAssignment_12");
			builder.put(grammarAccess.getNumericLiteralTypeRefAccess().getValueAssignment_13(), "rule__NumericLiteralTypeRef__ValueAssignment_13");
			builder.put(grammarAccess.getStringLiteralTypeRefAccess().getValueAssignment(), "rule__StringLiteralTypeRef__ValueAssignment");
