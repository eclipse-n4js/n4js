 ...
 * 
 * NOTE: purpose of these tests is not to test the actual behavior of the optional transformations, just to see of
...
class GeneratorOptionTest extends AbstractTranspilerTest {
	...
	@Test
	def void testWithOptionalTransformations() throws Exception {
	...
	@Test
	def void testWithoutOptionalTransformations() throws Exception {
		val script = snippet.parseAndValidateSuccessfully;
