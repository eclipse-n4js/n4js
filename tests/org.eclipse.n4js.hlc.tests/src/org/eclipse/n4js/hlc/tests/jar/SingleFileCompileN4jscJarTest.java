...
/**
 * IMPORTANT: The tests in this class require that n4jsc.jar exist. Before executing this test, execute the script:
 * {@code git/n4js/tools/scripts/mvn-cp-n4jsjar.sh in your console first}.
 * <p>
