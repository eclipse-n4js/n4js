...
@ProcessedBy(value = Generated0SmokeTest.DefaultSmokeTester.class, processInParallel = true)
@Scenarios(Scenario.SkipCharacterInBetween)
public class Generated0SmokeTest {
