...
/**
 * Test setup targeting the bugreports-tests_in-test folder. Note that as defined in
 * org.eclipse.n4js.bugreports.tests/package.json this folder is not an n4js source folder but an n4js test folder.
 */
@XpectSuiteClasses({
...
@XpectTestFiles(baseDir = "bugreports-tests_in-test")
@XpectImport({ N4JSStandaloneTestsModule.class, N4JSSuppressIssuesSetup.class })
public class N4JSBugreportTestInTest {
	//
}
