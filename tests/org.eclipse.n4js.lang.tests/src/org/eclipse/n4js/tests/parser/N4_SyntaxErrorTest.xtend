...
class N4_SyntaxErrorTest extends AbstractParserTest {
	...
	def void testIDEBUG_281_01() {
		val scriptAsText = '''
			...
			var 1a = null;
		'''
		val script = parseHelper.parse(scriptAsText);
	...
	def void testIDEBUG_594_01() {
		...
		assertTrue(param.declaredTypeRefInAST instanceof FunctionTypeExpression)
		val paramType = param.declaredTypeRefInAST as FunctionTypeExpression
