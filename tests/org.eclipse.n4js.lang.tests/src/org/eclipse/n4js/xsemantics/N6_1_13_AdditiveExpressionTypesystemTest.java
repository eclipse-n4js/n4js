...
public class N6_1_13_AdditiveExpressionTypesystemTest extends AbstractOperatorExpressionTypesystemTest {

	/**
	 * see examples in 6_1_13
	 */
	@Test
	public void testType_Add() {
	...
	@Test
	public void testExpectedType_Add() {
	...
	@Test
	public void testExpectedType_Sub() {
		assertBinaryOperatorExpectedType(unrestricted, "any", "any", "n1-n2");
		assertBinaryOperatorExpectedType(strict, "any", "any", "n1-n2");
		assertBinaryOperatorExpectedType(n4js, "any", "any", "n1-n2");
	}
