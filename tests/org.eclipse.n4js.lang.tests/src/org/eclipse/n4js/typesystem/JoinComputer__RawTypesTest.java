...
public class JoinComputer__RawTypesTest extends AbstractTypeSystemHelperTests {
	...
	@Test
	public void testJoinIntersection() {
		setScriptTypeDefinitions("""
				class A{}
				interface B{}
				class C extends A {}
	...
	@Test
	public void testJoinIntersection2() {
		setScriptTypeDefinitions("""
				class A {}
				class B extends A{}
				class C extends B {}
	...
	@Test
	public void testJoinWithBiultin() {
		setScriptTypeDefinitions("""
				class A{}
				class B{}
				""");
