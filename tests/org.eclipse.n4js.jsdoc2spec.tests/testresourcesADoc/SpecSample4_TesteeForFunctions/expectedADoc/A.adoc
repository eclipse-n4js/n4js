...
==== Semantics
. *++Bar basics++* (srclnk:++n4js:tests/org.eclipse.n4js.jsdoc2spec.tests/testresourcesADoc:SpecSample4_TesteeForFunctions:test/ATests:ATest#testBarBasics++[[.small]#Test#])
...
==== Semantics
. *++Func basics++* (srclnk:++n4js:tests/org.eclipse.n4js.jsdoc2spec.tests/testresourcesADoc:SpecSample4_TesteeForFunctions:test/ATests:ATest#testFuncBasics++[[.small]#Test#])
