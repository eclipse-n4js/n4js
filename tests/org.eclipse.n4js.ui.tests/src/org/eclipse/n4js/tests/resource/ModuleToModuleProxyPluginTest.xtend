...
class ModuleToModuleProxyPluginTest extends AbstractBuilderParticipantTest {
	...
	def void prepareIndex() {
		...
		uriA = projectN4JS.safeLocation.appendSegments(#["src", "A.n4js"]).toURI;
		uriB = projectN4JS.safeLocation.appendSegments(#["src", "B.n4js"]).toURI;
		uriB2 = projectN4JS.safeLocation.appendSegments(#["src", "B2.n4js"]).toURI;
