...
public class ModuleAndFolderNamesWithDotsAcrossProjectsIdeTest extends ConvertedIdeTest {

	private static final String PROBANDS = "probands";
	private static final String SUBFOLDER = "ModuleAndFolderNamesWithDotsAcrossProjects";
	private static final N4JSPackageName PROJECT_NAME = new N4JSPackageName("Main");
