...
public class RenameComposedTypeRefsTest extends AbstractRenameTest {

	@Test
	public void testUnion_atRef() {
		testAtCursors("""
				class Cls1 { field; }
				class Cls2 { field; }
	...
	public void testUnion_atDecl() {
		testAtCursors("""
				...
				/* error: Member fieldNew not present in all types of union; missing from: Cls2. */
				"fieldNew", """
						class Cls1 { fieldNew; }
						class Cls2 { field; }
	...
	@Test
	public void testIntersection_atRef() {
		testAtCursors("""
	...
	/** Not perfectly supported yet. Probably rename should be rejected in this case. */
	@Test
	public void testIntersection_atDecl() {
		testAtCursors("""
				...
				/* no error, but code behavior changes! */
				"fieldNew", """
						interface Cls1 { fieldNew; }
						interface Cls2 { field; }
