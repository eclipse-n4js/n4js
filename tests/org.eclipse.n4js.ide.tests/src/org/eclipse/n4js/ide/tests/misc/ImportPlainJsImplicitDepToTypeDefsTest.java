 ...
 * <p>
 * This test class covers implicit dependencies to the N4JSD definition project (see
 * {@link #testPlainJS_withImplicitDependencyToTypeDefs_baseCase()}).
 */
public class ImportPlainJsImplicitDepToTypeDefsTest extends AbstractIdeTest {

	/**
	 * This tests the case of an implicit dependency from an N4JS project to an N4JSD definition project, derived from a
	 * dependency from the N4JS project to a TypeScript definition project.
	 * <p>
	 * This is a use case common when working with N4JSD definition projects generated from TypeScript definitions.
	 */
	@Test
	public void testPlainJS_withImplicitDependencyToTypeDefs_baseCase() {
		testWorkspaceManager.createTestOnDisk(Map.of(
				CFG_NODE_MODULES + "npm_package", Map.of(
						...
						PACKAGE_JSON, """
								...
								"""),
				CFG_NODE_MODULES + "@types/npm_package", Map.of(
						"someModule.d.ts", """
								// content does not matter
								""",
						CFG_SOURCE_FOLDER, ".",
						PACKAGE_JSON, """
								...
								"""),
				// this is the project generated by the 'n4jsd-generator' tool from the above TypeScript definition
				// project:
				"@n4jsd/npm_package", Map.of(
						"someModule.n4jsd", """
	 ...
	 */
	@Test
	public void testPlainJS_withImplicitDependencyToTypeDefs_withMainModuleAndDefaultImportExport() {
		testWorkspaceManager.createTestOnDisk(Map.of(
				CFG_NODE_MODULES + "npm_package", Map.of(
						"someModule.js", """
								// content does not matter
