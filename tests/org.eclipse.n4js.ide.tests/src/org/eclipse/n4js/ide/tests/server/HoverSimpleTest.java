...
public class HoverSimpleTest extends AbstractHoverTest {
	...
	public void testConstNoDoc() throws Exception {
		testAtCursor(
				...
				"[0:22 - 0:26] [[n4js] const cnst: \"value\"]");
	}
	...
	public void testGetterWithDoc() throws Exception {
		testAtCursor(
				...
				"[0:80 - 0:83] [[n4js] getter gtr: int, [markdown] JSDoc for gtr]");
	}
	...
	public void testGetterWithDocOnDeclaration() throws Exception {
		testAtCursor(
				...
				"[0:34 - 0:37] [[n4js] getter gtr: int, [markdown] JSDoc for gtr]");
	}
	...
	public void testSetterWithDoc() throws Exception {
		testAtCursor(
				...
				"[0:71 - 0:74] [[n4js] setter str: int, [markdown] JSDoc for gtr]");
	}
	...
	public void testSetterWithDocOnDeclaration() throws Exception {
		testAtCursor(
				...
				"[0:34 - 0:37] [[n4js] setter str: int, [markdown] JSDoc for gtr]");
	}
	...
	public void testGenericClass() throws Exception {
		testAtCursor(
				"class C<|>C<T> { public ff: T; }",
				"[0:6 - 0:8] [[n4js] class CC<T>]");
	}

	/** generic */
	@Test
	public void testGenericClassInstance() throws Exception {
		testAtCursor(
				"class C<T> { public ff: T; } let c<|>c = new C<string>()",
				"[0:33 - 0:35] [[n4js] var cc: C<string>]");
	}

	/** generic */
	@Test
	public void testGenericClassField() throws Exception {
		testAtCursor(
				"class C<T> { public ff: T; } new C<string>().f<|>f;",
				"[0:45 - 0:47] [[n4js] field ff: string]");
	}
	...
	public void testGenericClassMethod() throws Exception {
		testAtCursor(
				"class C<T> { public m<|>m(p:T): T { return null; } } new C<string>().mm(\"s\");",
				"[0:20 - 0:22] [[n4js] method mm(p: T): T]");
	}

	/** generic */
	@Test
	public void testGenericClassMethodCall() throws Exception {
		testAtCursor(
				"class C<T> { public mm(p:T): T { return null; } } new C<string>().m<|>m(\"s\");",
				"[0:66 - 0:68] [[n4js] method mm(p: string): string]");
	}

	/** generic */
	@Test
	public void testGenericClassGenericMethod() throws Exception {
		testAtCursor(
				"class C<T> { public <A>m<|>m(aa:A): T { return null; } } new C<string>().mm(23);",
				"[0:23 - 0:25] [[n4js] method <A> mm(aa: A): T]");
	}

	/** generic */
	@Test
	public void testGenericClassGenericMethodCall() throws Exception {
		testAtCursor(
				"class C<T> { public <A>mm(aa:A): T { return null; } } new C<string>().m<|>m(23);",
				"[0:70 - 0:72] [[n4js] method mm(aa: int): string]");
	}

	/** generic */
	@Test
	public void testGenericFuncion() throws Exception {
		testAtCursor(
				"function <A>f<|>f(aa:A): void { }; ff(23);",
				"[0:12 - 0:14] [[n4js] <A> function ff(aa: A): void]");
	}

	/** generic */
	@Test
	public void testGenericFuncionCall() throws Exception {
		testAtCursor(
				"function <A>ff(aa:A): void { }; f<|>f(23);",
				"[0:32 - 0:34] [[n4js] function ff(aa: int): void]");
	}
