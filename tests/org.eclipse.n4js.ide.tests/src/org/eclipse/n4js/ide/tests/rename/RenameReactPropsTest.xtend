 ...
 */
class RenameReactPropsTest extends AbstractRenameTest {
	...
	@Test def void testParameterizedTypeRef_atMember() {
		testAtCursors(#[
			"MyReactModule.n4jsx" -> '''
	...
	@Test def void testParameterizedTypeRef_atReactProp() {
		testAtCursors(#[
			"MyReactModule.n4jsx" -> '''
					import * as React from "react";
