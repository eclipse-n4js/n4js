...
public class LinkingMethods extends AbstractXtParentRunnerTest {
	...
	public void test() throws Exception {
		...
		assertTestStructure("org.eclipse.n4js.ide.tests.helper.server.xt.tests.XtTestSetupTestMockup\n"
				...
				+ " ++ linkedFragment~2: LF-3 〔probands/LinkingMethods/LinkedFragment.n4ts.xt〕(LF-3)\n"
				+ " ++ linkedFragment~3: LF-4 〔probands/LinkingMethods/LinkedFragment.n4ts.xt〕(LF-4)\n"
				+ " + LinkedName.n4ts.xt: probands/LinkingMethods\n"
				+ " ++ linkedName~0: LN-1 〔probands/LinkingMethods/LinkedName.n4ts.xt〕(LN-1)\n"
				+ " ++ linkedName~1: LN-2 〔probands/LinkingMethods/LinkedName.n4ts.xt〕(LN-2)\n"
		...
		assertResult("(LF-1)", "Passed: linkedFragment~0: LF-1 〔probands/LinkingMethods/LinkedFragment.n4ts.xt〕");
		assertResult("(LF-2)", "Passed: linkedFragment~1: LF-2 〔probands/LinkingMethods/LinkedFragment.n4ts.xt〕");
		assertResult("(LF-3)",
				"Failed: linkedFragment~2: LF-3 〔probands/LinkingMethods/LinkedFragment.n4ts.xt〕. expected:<[Wrong Expectation]> but was:<[//@types.0]>");
		assertResult("(LF-4)", "Passed: linkedFragment~3: LF-4 〔probands/LinkingMethods/LinkedFragment.n4ts.xt〕");
		assertResult("(LN-1)", "Passed: linkedName~0: LN-1 〔probands/LinkingMethods/LinkedName.n4ts.xt〕");
		assertResult("(LN-2)",
				"Failed: linkedName~1: LN-2 〔probands/LinkingMethods/LinkedName.n4ts.xt〕. expected:<[Wrong Expectation]> but was:<[Comparable]>");
